...
/*HERE*/
    ...
    ASSET_B3E_DIALOG_CONGA_MEET_AS_TERMITE  = VER_SELECT(0xb3e, 0x95c, 0x95c, 0x95c), // [port] v1.1 fixes "Congo" typo to "Conga"
    ...
    ASSET_DB3_DIALOG_SNS_EGG_1_TEXT = VER_SELECT(0xdb3, 0xa31, 0xa31, 0xa31), // [port] JP uses Mumbo as speaker instead of SNS narrator
    ...
    ASSET_E57_DIALOG_FIRST_JIGGY = VER_SELECT(0xF57, 0xabd, 0xabd, 0xabd), // [port] JP uses Gruntilda as speaker instead of Jiggy
