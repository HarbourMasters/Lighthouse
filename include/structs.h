...
typedef struct particle_emitter {
  ...
  u32 draw_mode;
  BKSprite_s *sprite_1C;       // sprite_ptr
  ...
  f32 unk78;
  s32 unk7C;
  void (*particleCallback_80)(struct particle_emitter *,
                              f32[3]); // particleCallback
...
typedef void (*Struct68DrawMethod)(void *, struct struct_68_s *, f32[3], f32[3],
                                   f32, BKModelBin *, Gfx **, Mtx **, Vtx **);
...
typedef struct {
  ...
  BKCollisionTri *(*unk4)(struct actorMarker_s *, f32[3], f32[3], f32, f32[3],
                          s32, u32);
