...
#define FUNC_8030E624(sfx_e, vol, sample_rate)                                 \
  func_8030E624(_SHIFTL((vol * 1023), 21, 11) +                                \
                _SHIFTL(sample_rate >> 5, 11, 10) + _SHIFTL(sfx_e, 0, 11))

#define FUNC_8030E8B4(sfx_e, vol, sample_rate, position, e, f)                 \
  func_8030E8B4(_SHIFTL((vol * 1023), 21, 11) +                                \
                    _SHIFTL(sample_rate >> 5, 11, 10) + _SHIFTL(sfx_e, 0, 11), \
                position, _SHIFTL(e, 0, 16) + _SHIFTL(f, 16, 16))
...
s32 vector_getIndex(VLA *vthis, void *element);
...
void fxcommon1score_draw(enum item_e arg0, struct8s *arg1, Gfx **arg2,
                         Mtx **arg3, Vtx **arg4);
...
void fxhealthscore_draw(enum item_e item_id, struct8s *arg1, Gfx **gfx,
                        Mtx **mtx, Vtx **vtx);
...
void stopTrackAtTime(f32, enum comusic_e);
void showDelayedTextAtTime(f32 time, enum asset_e text_id, s32 arg2,
                           f32 position[3], ActorMarker *caller,
                           void (*callback_method_1)(ActorMarker *,
                                                     enum asset_e, s32),
                           void (*callback_method_2)(ActorMarker *,
                                                     enum asset_e, s32));
...
void spawnQueue_add_4(GenFunction_4, s32, s32, s32, s32);
...
void particleEmitter_setAccelerationRange(ParticleEmitter *, f32, f32, f32, f32,
                                          f32, f32);
void particleEmitter_setBounceFactor(ParticleEmitter *, f32);
void particleEmitter_setCollisionCount(ParticleEmitter *, s32);
...
void particleEmitter_setSpawnPositionRange(ParticleEmitter *, f32, f32, f32,
                                           f32, f32, f32);
...
void particleEmitter_setScaleAndLifetimeRanges(
    ParticleEmitter *, ParticleScaleAndLifetimeRanges *);
...
void particleEmitter_setPositionAndVelocityRanges(
    ParticleEmitter *pthis, ParticleSettingsVelocityPosition *arg1);
void particleEmitter_setAngularVelocityRange(ParticleEmitter *, f32, f32, f32,
                                             f32, f32, f32);
...
void particleEmitter_setParticleVelocityRange(ParticleEmitter *, f32, f32, f32,
                                              f32, f32, f32);
void particleEmitter_setCullDistance(ParticleEmitter *, f32);
...
void comusic_playTrackWithVolumeOverride(enum comusic_e, s32);
...
void baanim_playForDuration_onceStartingAt(enum asset_e anim_id, f32 duration,
                                           f32 arg2);
...
bool player_setCarryObjectPoseInCylinder(f32[3], f32, f32,
                                         enum actor_e actor_id, Actor **);
...
void basfx_playSfx(enum sfx_e, f32, s32);
void basfx_playSfxWithVolume(enum sfx_e, f32, s32);
...
void setMapTransitionWithDelay(f32, enum map_e, s32, s32, s32,
...
void particleEmitter_setSfxPitchRange(ParticleEmitter *, f32, f32);

ParticleEmitter *partEmitMgr_defragEmitter(ParticleEmitter *);
ParticleEmitter *createBubbleParticleEmitter(f32[3], f32);

extern s32 func_802F9AA8(enum sfx_e);

Actor *spawnActorWithYaw(enum actor_e id, s32 pos[3], s32 arg2, s32 arg3,
                         s32 arg4);
...
void func_8030E878(enum sfx_e uid, f32 arg1, u32 arg2, f32 arg3[3], f32 arg4,
                   f32 arg5);
void func_8030E8B4(u32, f32[3], u32);
void func_8030E988(enum sfx_e uid, f32 arg1, u32 arg2, f32 arg3[3], f32 arg4,
                   f32 arg5);
void func_8030E9C4(enum sfx_e uid, f32 arg1, u32 arg2, f32 arg3[3], f32 arg4,
                   f32 arg5);
...
Actor *actor_drawFullDepth(ActorMarker *marker, Gfx **gfx, Mtx **mtx,
                           Vtx **vtx);
...
void subaddie_set_state_with_direction(Actor *sthis, s32 myAnimId,
                                       f32 anim_start_position, s32 direction);
...
ActorMarker *func_8032FBE4(f32 *pos, MarkerDrawFunc arg1, int arg2,
                           enum asset_e model_id);

void marker_setFreeMethod(ActorMarker *, void (*)(Actor *));
void marker_setCollisionScripts(ActorMarker *mathis, MarkerCollisionFunc ow_func,
                                MarkerCollisionFunc arg2,
                                MarkerCollisionFunc die_func);
...
void func_80346C10(enum bs_e *retVal, enum bs_e fail_state,
                   enum bs_e success_state, enum item_e item_id, int use_item);
...
void collisionTri_copyData(Struct6Ds *, f32[3], f32[3], f32, s32);
void collisionTri_isHitFromAboveByMarker(Struct6Ds *arg0, f32 arg1[3],
                                         f32 arg2[3], f32 arg3, s32 arg4);
void collisionTri_isHitFromAboveByActor(Struct6Ds *, f32, f32, f32, s32);
...
NodeProp *nodeprop_findByActorIdAndPosition_f32(enum actor_e actor_id,
                                                f32 position[3]);
Actor *actorArray_findClosestActorFromActorId(f32 position[3],
                                              enum actor_e actor_id, s32 arg2,
                                              f32 *min_distance_ptr);
...
void baMotor_scheduleRumblePattern(f32, f32, f32, f32, f32, f32);
...
void playSoundEffectWithPositionAtTime(f32, enum sfx_e, f32, s32, f32[3], f32,
                                       f32);

f32 climbGetBottomY(void);
f32 climbGetTopY(void);
void ml_vec3f_closest_point_on_line_segment(f32 a0[3], f32 a1[3], f32 a2[3],
                                            f32 a3[3]);

void controller_copyFaceButtons(s32, s32[6]);

void spawnQueue_add_1(GenFunction_1, s32);
#define SPAWNQUEUE_ADD_ONE(method, arg0)                                       \
  spawnQueue_add_1((GenFunction_1)(method), reinterpret_cast(s32, (arg0)))

void func_802FAD64(enum item_e);
void nodeprop_getPosition(NodeProp *, f32[3]);
bool gcdialog_showText(s32 text_id, s32 arg1, f32 *pos, ActorMarker *marker,
...
extern BKModelBin *marker_loadModelBin(ActorMarker *mathis);
extern Struct70s *func_8034C2C4(ActorMarker *marker, s32 arg1);
extern void func_80326310(Actor *sthis); // actor_setBlendStateFadeOut ??
extern ActorMarker *marker_init(s32 *pos, MarkerDrawFunc draw_func, int arg2,
                                int marker_id, int arg4);
extern s32 asset_getFlag(enum asset_e arg0);
extern void
spawnableActorList_add(ActorInfo *arg0,
                       Actor *(*arg1)(s32[3], s32, ActorInfo *, u32), u32 arg2);
extern void spawnableActorList_addIfMapVisited(ActorInfo *arg0,
                                               Actor *(*arg1)(s32[3], s32,
                                                              ActorInfo *, u32),
                                               u32 arg2, enum map_e arg3);
extern void marker_setActorUpdateFunc(ActorMarker *marker,
                                      ActorUpdateFunc method);
extern void marker_setActorUpdate2Func(ActorMarker *marker,
                                       ActorUpdateFunc method);
extern void marker_callCollisionFunc(ActorMarker *, ActorMarker *,
...
extern void volatileFlag_setN(enum volatile_flags_e startIndex, s32 set,
                              s32 length);
...
//personal additions after this point
//placeholders, may or may not be moved as needed/allowed

extern void sns_find_and_parse_payload(void);
extern void assetCache_clear(void);
extern void heap_free_queue_flush(void);
extern void freeResources(void);
extern void game_reset(void);
extern void game_initialize(enum map_e map_id);
extern bool DEBUG_use_special_bootmap(void);
extern void rarezip_init(void);
extern void overlayManagerloadCore2(void);
extern void heap_init(void); 
extern void dummy_func_8025AFB0(void);
extern void allocUnusedBlock(void);
extern void assetCache_init(void);
extern void baMotor_init(void);
extern void audioManager_init(void);
extern void sns_write_payload_over_heap(void);
extern s32 game_getMode(void);
extern void dummy_func_802E35D0(void);
extern void baMotor_updateRumbleTimer(void);
extern void updateGameStateData(void);
extern void heap_free_temp_blocks_if_needed(void);
extern void heap_incrementCounter(void);
extern void spawnQueue_updateActorList(void);
extern bool game_updateState(void);
extern void game_draw(s32 arg0);
extern void spawnQueue_flush(void);
extern s32 updateGameSelectText(void);
extern s32 levelSpecificFlags_validateCRC1(void);
extern s32 dummy_func_80320240(void);
extern void viMgr_init(void);
extern void Main_Initialize(void);
extern void func_80253010(void *dest, void *src, s32 size);
extern void sendMesgToMainQueue(OSMesg arg0);
extern bool func_8028F2FC(void);
extern bool func_80329078(Actor *sthis, s32 arg1, s32 arg2);
extern bool func_80329480(Actor *sthis);
extern bool subaddie_playerIsWithinSphere(Actor *sthis, s32 dist);
extern bool func_803296D8(Actor *sthis, s32 dist);
extern void func_80348044(Gfx **gfx, BKSprite_s* sprite, s32 frame, s32 tmem, s32 rtile, s32 uls, s32 ult, s32 cms, s32 cmt, s32 *width, s32 *height, s32 *frame_width, s32 *frame_height, s32 *texture_x, s32 *texture_y, s32 *textureCount);
extern void func_80355C60(f32 arg0[3], f32 arg1);
extern void copyCollisionTriVertices(f32 arg0[3][3]);
extern bool mapModel_has_xlu_bin(void);
extern bool ncDynamicCamA_func_802C1DB0(f32 arg0);
extern bool is_within_yaw_range(f32 arg0[3], f32 arg1);
