...
/* .data */
ActorInfo D_80389AA0 = {MARKER_4B_CC_SCREW,
                        ACTOR_43_CLACKER_SCREW,
                        ASSET_890_MODEL_SCREW,
                        0,
                        NULL,
                        func_803864D4,
...
void func_803864D4(Actor *this) {
  ...
  } else if (this->state == 2) { // L80386734
    sp2C = local->unk8 / 1.0;
    if (local->unkC && 0.6 < sp2C) {
      FUNC_8030E8B4(SFX_91_METALLIC_SOUND, 1.0, 32000, this->position, 100,
                    6000);
      local->unkC = 0;
    } // L80386798
