...
ActorInfo D_80389E44 = {0x1A9, 0x28C,      0x435, 0, NULL, func_80389900,
                        NULL,  actor_draw, 0,     0, 0.0f, 0};

ActorInfo D_80389E68 = {0x1A9, 0x28D,      0x436, 0, NULL, func_80389900,
                        NULL,  actor_draw, 0,     0, 0.0f, 0};

ActorInfo D_80389E8C = {0x1A9, 0x28E,      0x437, 0, NULL, func_80389900,
                        NULL,  actor_draw, 0,     0, 0.0f, 0};
...
void func_803897F0(Actor *this, s32 next_state) {
  ...
  if (next_state == 2) {
    comusic_playTrackWithVolumeOverride(COMUSIC_2D_PUZZLE_SOLVED_FANFARE, -1);
...
void func_80389900(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    local->unk8 = 0;
    marker_setCollisionScripts(this->marker, NULL, func_80389890,
                               func_803898BC);
    func_803897F0(this, 1);
    if (this->modelCacheIndex == 0x28E &&
        jiggyscore_isSpawned(JIGGY_18_CC_BOLT)) {
      marker_despawn(this->marker);
    }
    return;
  } // L803899D4
