...
/* .data */
extern ActorInfo D_80389B00 = {MARKER_4C_CLANKER_TOKEN_TOOTH_EXT,
                               ACTOR_44_CLANKER_TOKEN_TOOTH_EXTERIOR,
                               ASSET_309_MODEL_CLANKER_TOKEN_TOOTH_EXTERIOR,
                               0,
                               NULL,
                               func_803870F8,
...
extern ActorInfo D_80389B24 = {MARKER_4D_CLANKER_JIGGY_TOOTH_EXT,
...
void CC_func_80386FE0(Actor *this, s32 next_state) {
  ...
  if (this->state == 2) {
    ...
    if (prev_state == 2) {
      levelSpecificFlags_set((local->unk0 == 1)
                                 ? LEVEL_FLAG_0_CC_TOKEN_TOOTH_OPEN
...
void CC_func_803870E0(void) { D_80389F80 = 0; }

void func_803870EC(s32 arg0) { D_80389F80 = arg0; }
...
void func_803870F8(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    if (levelSpecificFlags_get((local->unk0 == 1)
                                   ? LEVEL_FLAG_0_CC_TOKEN_TOOTH_OPEN
                                   : LEVEL_FLAG_1_CC_JIGGY_TOOTH_OPEN)) {
  ...
  if (this->state == 1 && D_80389F80 == local->unk0) {
    ...
    flagCnt = levelSpecificFlags_get(LEVEL_FLAG_0_CC_TOKEN_TOOTH_OPEN) +
              levelSpecificFlags_get(LEVEL_FLAG_1_CC_JIGGY_TOOTH_OPEN);
    if (!jiggyscore_isCollected(JIGGY_1B_CC_TOOTH)) {
      gcdialog_showText((local->unk0 == 1) ? ((flagCnt == 0) ? 0xd30 : 0xd31)
                                           : ((flagCnt == 0) ? 0xd2e : 0xd2f),
