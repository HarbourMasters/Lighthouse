...
Struct_CC_3130_0 D_80389C30[] = {
    {-80.0f, 0.4f},  {-160.0f, 0.6f}, {-240.0f, 0.8f}, {80.0f, 0.4f},
    {160.0f, 0.6f},  {240.0f, 0.8f},  {-80.0f, 0.4f},  {-160.0f, 0.6f},
    {-240.0f, 0.8f}, {80.0f, 0.4f},   {160.0f, 0.6f},  {240.0f, 0.8f}};

ActorInfo D_80389C90 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389CB4 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389CD8 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389CFC = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389D20 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389D44 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389D68 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389D8C = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389DB0 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389DD4 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389DF8 = {MARKER_28_CLANKER_SAWBLADE,
...
ActorInfo D_80389E1C = {MARKER_28_CLANKER_SAWBLADE,
...
void chSawblade_update(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    this->roll = this->yaw;
    this->yaw = 0.0f;
    marker_setCollisionScripts(this->marker, func_80389520, NULL,
                               CC_func_8038954C);
    local->unk0 = &D_80389C30[(this->modelCacheIndex < 0x43)
                                  ? this->modelCacheIndex - 0x3D
                                  : this->modelCacheIndex - 0x28A];
    local->unk4 = 0;
    ml_vec3f_snap_to_grid(this->position, 100);
  ...
  if ((tmp_f2 < 90.0f && this->roll >= 90.0f) ||
      ...
      (270.0f < tmp_f2 && this->roll <= 270.0f)) { // L80389790
    func_8030E878(SFX_2_CLAW_SWIPE, local->unk0->unk4, 30000, this->position,
                  500.0f, 1000.0f);
  } // L803897C8
  if (local->unk4 > 0)
    local->unk4--;
