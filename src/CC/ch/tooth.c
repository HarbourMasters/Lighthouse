...
extern void chTooth_update(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    local->unk0 =
        &D_80389B50[(this->modelCacheIndex == ACTOR_101_CLANKER_TOKEN_TOOTH)
                        ? 0
                        : 1];
