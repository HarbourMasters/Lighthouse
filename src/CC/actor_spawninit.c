...
extern ActorInfo mm_juju_count;
...
{
    spawnableActorList_add(&CC_TEXT_END, actor_new, ACTOR_FLAG_UNKNOWN_14 | ACTOR_FLAG_UNKNOWN_7 );
    ...
    spawnableActorList_add(&mm_juju_count, actor_new, ACTOR_FLAG_UNKNOWN_13 | ACTOR_FLAG_UNKNOWN_10 | ACTOR_FLAG_UNKNOWN_7 | ACTOR_FLAG_UNKNOWN_3);
