...
static Gfx sGfxSublist[] = {
    gsSPClearGeometryMode(G_CULL_BOTH | G_FOG | G_LIGHTING | G_TEXTURE_GEN |
                          G_TEXTURE_GEN_LINEAR | G_LOD | G_SHADING_SMOOTH |
                          G_CLIPPING | 0x0060CD00),
...
void stub_func_80241490(Gfx **gfx, Vtx **vtx, s32 arg2[3], s32 arg3[3], s32 arg4[3],
                   s32 arg5[3], bool cull_front, s32 arg7) {
  s32 vp_position[3];
  s32 var_a0;
  s32 var_v0;
  s32 var_v1;
  ...
  __gSPDisplayList((*gfx)++, sGfxSublist);
  ...
  gDPPipeSync((*gfx)++);
  gDPSetPrimColor((*gfx)++, 0, 0, colors[0][0], colors[0][1], colors[0][2],
                  colors[0][3]);
  gSP2Triangles((*gfx)++, 7, 3, 5, 0, 5, 3, 1, 0);
  gSP1Quadrangle((*gfx)++, 6, 4, 0, 2, 0);

  gDPPipeSync((*gfx)++);
  gDPSetPrimColor((*gfx)++, 0, 0, colors[1][0], colors[1][1], colors[1][2],
                  colors[1][3]);
  gSP1Quadrangle((*gfx)++, 7, 6, 2, 3, 0);
  gSP2Triangles((*gfx)++, 4, 5, 0, 0, 5, 1, 0, 0);

  gDPPipeSync((*gfx)++);
  gDPSetPrimColor((*gfx)++, 0, 0, colors[2][0], colors[2][1], colors[2][2],
                  colors[2][3]);
  gSP1Quadrangle((*gfx)++, 5, 4, 6, 7, 0);
  gSP2Triangles((*gfx)++, 0, 1, 2, 0, 1, 3, 2, 0);
}

void stub_func_80241928(Gfx **gfx, Vtx **vtx, s32 arg2[3], s32 arg3, s32 arg4[3]) {
  s32 vp_position[3];
  f32 var_f26;
  s32 var_fp;
  s32 var_s0;
  ...
  for (var_fp = 0; var_fp < 4; var_fp++) {
    ...
    for (var_f26 = 0; var_f26 < 4; var_f26++) {
      gDPSetPrimColor((*gfx)++, 0, 0, arg4[0], arg4[1], arg4[2],
                      90.0f + (var_fp * 25.0f) + (var_f26 * 6.25f));
      gSP2Triangles((*gfx)++, var_f26 * 2, var_f26 * 2 + 3, var_f26 * 2 + 1,
                    var_f26 * 2, var_f26 * 2, var_f26 * 2 + 2, var_f26 * 2 + 3,
                    var_f26 * 2);
    }
  }
}

void stub_func_802424D4(Gfx **gfx, Mtx **mtx, Vtx **vtx, f32 arg3[3], f32 arg4[3],
                   f32 arg5, s32 arg6[4]) {
  s32 var_a0;
  s32 var_v0;
  s32 var_v1;
  ...
  if ((arg3[0] != sp50[0]) || (arg3[1] != sp50[1]) || (arg3[2] != sp50[2])) {
    ...
    for (var_a0 = 0; var_a0 < 2; var_a0++) {
      for (var_v0 = -1; var_v0 < 3; var_v0 += 2) {
        (*vtx)->v.ob[0] =
            (arg3[0] + (var_a0 * sp80[0]) + (var_v0 * sp74[0])) - sp5C[0];
        (*vtx)->v.ob[1] =
            (arg3[1] + (var_a0 * sp80[1]) + (var_v0 * sp74[1])) - sp5C[1];
        (*vtx)->v.ob[2] =
            (arg3[2] + (var_a0 * sp80[2]) + (var_v0 * sp74[2])) - sp5C[2];
        (*vtx)->v.tc[0] = 0;
        (*vtx)->v.tc[1] = 0;
        (*vtx)->v.cn[0] = 0;
        (*vtx)->v.cn[1] = 0;
    ...
    for (var_a0 = 0; var_a0 < 2; var_a0++) {
      for (var_v0 = -1; var_v0 < 3; var_v0 += 2) {
        (*vtx)->v.ob[0] =
            (arg3[0] + (var_a0 * sp80[0]) + (var_v0 * sp68[0])) - sp5C[0];
        (*vtx)->v.ob[1] =
            (arg3[1] + (var_a0 * sp80[1]) + (var_v0 * sp68[1])) - sp5C[1];
        (*vtx)->v.ob[2] =
            (arg3[2] + (var_a0 * sp80[2]) + (var_v0 * sp68[2])) - sp5C[2];
        (*vtx)->v.tc[0] = 0;
        (*vtx)->v.tc[1] = 0;
        (*vtx)->v.cn[0] = 0;
        (*vtx)->v.cn[1] = 0;
...
void stub_func_80242BE8(Gfx **gfx, Vtx **vtx, f32 arg2[2][2][2][3], s32 color[3],
                   s32 alpha_values[3], s32 cull_back) {
  f32 vp_position[3];
#define var_v0                                                                 \
  ((f32 *)((u8 *)arg2 + (i << 2) * sizeof(f32[3]) +                            \
           (j << 1) * sizeof(f32[3]) + k * sizeof(f32[3])))
  s32 i;
  s32 j;
  s32 k;
...
#undef var_v0
  ...
  gDPPipeSync((*gfx)++);
  gDPSetPrimColor((*gfx)++, 0, 0, color[0], color[1], color[2],
                  alpha_values[0]);
  gSP2Triangles((*gfx)++, 7, 3, 5, 0, 5, 3, 1, 0);
  gSP1Quadrangle((*gfx)++, 6, 4, 0, 2, 0);
