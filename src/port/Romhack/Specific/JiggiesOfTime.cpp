 ...
 * file select as the default boot. But if you were to view the intro sequence, you'd see a stray Collywobble
 * spawned during the concert when it shouldn't be there at all.
 *
