...
#define EMPTY_HONEYCOMB_OPTION_ENABLED (selectedFileNum != DEFAULT_FILE_NUM && RANDO_SAVE_OPTIONS[RO_SHUFFLE_EMPTY_HONEYCOMBS].optionValue)
#define JIGGY_OPTION_ENABLED (selectedFileNum != DEFAULT_FILE_NUM && RANDO_SAVE_OPTIONS[RO_SHUFFLE_JIGGIES].optionValue)
#define MUMBO_TOKENS_OPTION_ENABLED (selectedFileNum != DEFAULT_FILE_NUM && RANDO_SAVE_OPTIONS[RO_SHUFFLE_MUMBO_TOKENS].optionValue)
