...
// Generated from the map_e enum in include/enums.h. shortName drops the leading
// level abbreviation, for labels that already sit under a level heading.
...
inline constexpr MapNameEntry mapNames[MAP_NUM_MAPS] = {
    ...
    { "MM Mumbo's Hut", "Mumbo's Hut" }, // 0x0E
    { "Unused", "Unused" }, // 0x0F
