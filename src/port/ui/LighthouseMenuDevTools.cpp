...
#endif
    AddWidget(path, "Show Nametags", WIDGET_CVAR_CHECKBOX)
        .CVar(CVAR_DEVELOPER_TOOLS("Nametags"))
        .Options(CheckboxOptions().Tooltip("Shows nametags for registered entities."));
