...
/* .code */
void badrone_set_type(BaDroneType type) { badrone.type = type; }

BaDroneType badrone_get_type(void) { return badrone.type; }
...
enum bs_e badrone_goto(f32 position[3], f32 duration,
                       void (*arg2)(ActorMarker *), ActorMarker *arg3) {
