...
void __baphysics_update_normal(void){
    ...
    ml_vec3f_rotate(0.0f, baphysics_target_yaw, 0.0f, 0.0f, baphysics_target_horizontal_velocity, &baphysics_target_velocity[0], &baphysics_target_velocity[1], &baphysics_target_velocity[2]);
...
void __baphysics_update_climb(void){
    ...
    ml_vec3f_rotate_direction(sp34, 0.0f, yaw_get(), 0.0f, 0.0f, -climbGetRadius());
...
void __baphysics_update_goto(void) {
  ...
  case 2: // L80297510
    ...
    sp2C = ml_map_f(baphysics_goto.elapsed_time, 0.0f, baphysics_goto.duration,
                    0.0f, 1.0f);
    ml_vec3f_copy(s_player_velocity, s_next_position);
    s_next_position[0] = ml_interpolate_f(
        sp2C, baphysics_goto.start_position[0], baphysics_goto.end_position[0]);
    s_next_position[1] = ml_interpolate_f(
        sp2C, baphysics_goto.start_position[1], baphysics_goto.end_position[1]);
    s_next_position[2] = ml_interpolate_f(
        sp2C, baphysics_goto.start_position[2], baphysics_goto.end_position[2]);
...
void __baphysics_update_transform(void) {
  ...
  temp_f0 = ml_fractional_part(D_8037C500, 1.2f);
...
void baphysics_set_vertical_velocity(f32 arg0) { s_player_velocity[1] = arg0; }

//clang-format off
void baphysics_set_horizontal_velocity(f32 yaw, f32 magnitude) { \
    ml_vec3f_rotate(0.0f, yaw, 0.0f, 0.0f, magnitude, &s_player_velocity[0], &s_player_velocity[1], &s_player_velocity[2]);
}
...
f32 baphysics_get_gravity(void) { return s_gravity; }

BaPhysicsType baphysics_get_type(void) { return baphysics_type; }
...
f32 baphysics_get_target_yaw(void) { return baphysics_target_yaw; }

void baphysics_get_velocity(f32 dst[3]) {
  ml_vec3f_copy(dst, s_player_velocity);
}

f32 baphysics_get_vertical_velocity(void) { return s_player_velocity[1]; }

f32 baphysics_get_horizontal_velocity(void) {
  return gu_sqrtf(s_player_velocity[0] * s_player_velocity[0] +
                  s_player_velocity[2] * s_player_velocity[2]);
}
...
void baphysics_set_acceleration(f32 arg0) { baphysics_acceleration = arg0; }
...
void baphysics_set_goto_duration(f32 arg0) { baphysics_goto.duration = arg0; }
...
void baphysics_set_gravity(f32 arg0) { s_gravity = arg0; }

void baphysics_set_terminal_velocity(f32 arg0) { s_terminal_velocity = arg0; }

int baphysics_is_slower_than(f32 arg0) {
  return s_player_velocity[0] * s_player_velocity[0] +
             s_player_velocity[2] * s_player_velocity[2] <=
         (arg0 * arg0);
}

int baphysics_goto_done(void) { return baphysics_goto.state == 3; }
