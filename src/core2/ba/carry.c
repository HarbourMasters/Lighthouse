...
void __bacarry_set_position_and_rotation(ActorMarker *marker, f32 arg1[3],
                                         f32 arg2[3]) {
...
void bacarry_reset_marker(void) { baCarry_marker = NULL; }

ActorMarker *bacarry_get_marker(void) { return baCarry_marker; }
