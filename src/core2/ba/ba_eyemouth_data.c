...
void func_802C71F0(Actor *actor){
    ...
    switch(actor->modelCacheIndex){
        ...
        case 0xAC:
        case 0xB8://L802C7254
            modelRender_setAppendageVisibility(0x1, (s32)ml_interpolate_f(local->unk0[0], 1.0f, 6.0f));
            modelRender_setAppendageVisibility(0x2, (s32)ml_interpolate_f(local->unk0[1], 1.0f, 6.0f));
            break;
        ...
        case 0x2FB://L802C72B4
            modelRender_setAppendageVisibility(0x1C, (s32)ml_interpolate_f(local->unk0[0], 1.0f, 8.0f));
            modelRender_setAppendageVisibility(0x1D, (s32)ml_interpolate_f(local->unk0[1], 1.0f, 8.0f));
            break;
    }
}
