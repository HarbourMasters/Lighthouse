...
static void _baModel_preDraw(int arg0) { baMarker_get()->unk14_21 = 1; }
...
void baModel_updateModel(void) { baModel_set(func_802985F0()); }
...
void baModel_reset(void) {
  ...
  spawnQueue_add_4((GenFunction_4)spawnQueue_actor_f32,
                     ACTOR_17_PLAYER_SHADOW, reinterpret_cast(s32, plyr_pos[0]),
...
BKModelBin *baModel_getModelBin(void) { return baModelBin; }

enum asset_e baModel_getModelId(void) { return baModelId; }

void baModel_setEnvAlpha(s32 alpha) { baModelEnvAlpha = alpha; }
...
void baModel_80292078(s32 arg0, f32 arg1) { D_8037C130[arg0][0] = arg1; }
...
void baModel_setDirection(enum player_model_direction_e direction) {
  if (direction != baModelDirection) {
    if (direction == PLAYER_MODEL_DIR_KAZOOIE ||
        PLAYER_MODEL_DIR_KAZOOIE == baModelDirection) {
      // flip model
...
void baModel_8029217C(f32 arg0) { D_8037C110[1] = arg0; }
...
void baModel_setYDisplacement(f32 arg0) { baModelDisplacement[1] = arg0; }

void baModel_setVisible(s32 arg0) { baModelIsVisible = arg0; }
...
f32 baModel_getYaw(void) { return baModelYaw; }

f32 baModel_80292230(void) { return D_8037C100[1]; }

void baModel_8029223C(f32 arg0[3]) { baModel_80291A50(8, arg0); }

void baModel_80292260(f32 arg0[3]) { baModel_80291A50(7, arg0); }
    ...
    case ASSET_374_MODEL_BANJO_CROC:
      ...
      if (D_8037C130[arg1][1] != 0.0f) {
        ml_vec3f_rotate_direction(
            sp44, D_8037C130[arg1][2],
            mlNormalizeAngle(yaw_get() + D_8037C130[arg1][3]), 0.0f, 0.0f,
            D_8037C130[arg1][1]);
        arg0[0] += sp44[0];
        arg0[1] += sp44[1];
        arg0[2] += sp44[2];
...
void baModel_802924B8(f32 arg0[3]) { baModel_80291A50(0xA, arg0); }
...
s32 baModel_isVisible(void) { return baModelIsVisible; }

void baModel_80292554(f32 arg0[3]) { baModel_80291A50(0x9, arg0); }

void baModel_80292578(f32 arg0[3]) { baModel_80291A50(0xA, arg0); }
