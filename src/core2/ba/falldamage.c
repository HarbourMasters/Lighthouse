...
struct_C0E0_1 bafalldamage_lookup_table[] = {
    {1000, 0, 0}, {1500, 0, 0}, {2000, 0, 0}, {7000, 8, 2},
    {6000, 7, 1}, {5000, 6, 1}, {4000, 5, 1}, {3000, 4, 1},
    {2000, 3, 1}, {1000, 2, 1}, {0, 1, 1},    {-1, 0, 0}};
...
s32 bafalldamage_get_state(void) { return bafalldamage_state; }
...
void bafalldamage_update(void) {
  ...
  if (player_isStable() || (player_getWaterState() != BSWATERGROUP_0_NONE) ||
