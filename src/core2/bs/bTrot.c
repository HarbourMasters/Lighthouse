...
void func_802A89D4(void) {
  ...
  if (!bastick_getZone()) {
    ...
    baphysics_set_target_horizontal_velocity(
        ml_interpolate_f(sp24, func_802A8900(), func_802A88B0()));
  }
}
...
void func_802A8AD8(void) {
  basfx_updateClockSfxSource(stateTimer_getPrevious(STATE_TIMER_3_TURBO_TALON),
                             stateTimer_get(STATE_TIMER_3_TURBO_TALON));
...
void bsbtrot_stand_end(void) { func_802A8BB0(); }

enum asset_e func_802A9030(void) {
  return func_802A8D00(ASSET_15_ANIM_BSBTROT_WALK,
                       ASSET_44_ANIM_BSBTROT_TURBO_WALK);
}

void func_802A9054(void) {
  f32 tmp = 1.0f;
  baanim_setVelocityMapRanges(func_802A8900(), func_802A88B0(), func_802A8984(),
                              func_802A8934());
  if (is_player_in_state()) {
    tmp = ml_map_f(baphysics_get_horizontal_velocity_percentage(), 0.0f, 1.0f,
                   0.6f, 0.9f);
...
void bsbtrot_walk_end(void) { func_802A8BB0(); }
...
void bsbtrot_jump_update(void) {
  ...
  case 0: // L802A9530
    ...
    break;
  case 1: // L802A9578
    if (is_player_stable_or_falling(0x8C)) {
...
void bsbtrot_exit_end(void) { func_802A8BB0(); }
...
void bsbtrot_slide_update(void) {
  ...
  if (player_shouldSlideTrot()) {
    func_80294480(sp30);
    ml_vec3f_yaw_towards(sp30, &sp2C);
    func_80299628(1);
    baphysics_set_target_horizontal_velocity(
        ml_map_f(pitch_getIdeal(), 20.0f, 60.0f, 550.0f, 700.0f));
...
void bsbtrot_slide_end(void) { func_802A8BB0(); }

int bsbtrot_inSet(s32 move_indx) {
  return (move_indx == BS_15_BTROT_IDLE) || (move_indx == BS_16_BTROT_WALK) ||
         (move_indx == BS_8_BTROT_JUMP) || (move_indx == BS_17_BTROT_EXIT) ||
         (move_indx == BS_45_BTROT_SLIDE) || (move_indx == BS_14_BTROT_ENTER) ||
         (move_indx == 0x79) || (move_indx == BS_BTROT_OW) ||
         (move_indx == BS_71_BTROT_FALL) || (move_indx == 0x9a);
}
...
void bsbtrot_fall_end(void) { func_802A8BB0(); }
