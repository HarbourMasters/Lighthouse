...
void func_802B3CCC(void) { func_8029E070(0); }
...
void func_802B3D6C(void) { func_802B3CCC(); }
...
void func_802B3E0C(void) { func_802B3CCC(); }
...
void func_802B3E64(void) {
  ...
  if (map_get() == MAP_27_FP_FREEZEEZY_PEAK &&
      baflag_isTrue(BA_FLAG_14_LOSE_BOGGY_RACE)) {
