...
void bsturn_init(void) {
  ...
  bsturn_starting_horizontal_velocity =
      gu_sqrtf(sp28[0] * sp28[0] + sp28[2] * sp28[2]);
...
void bsturn_update(void) {
  ...
  baphysics_set_target_horizontal_velocity(
      ml_map_f(anctrl_getAnimTimer(baanim_getAnimCtrlPtr()), 0.18f, 1.0f,
               bsturn_starting_horizontal_velocity, 0.0f));
  ...
  switch (D_8037D594) {
  case -1: // L802B68DC
    func_802927E0(baphysics_get_target_yaw() - 10.0f,
                  baphysics_get_horizontal_velocity() * 0.88);
    break;
  case 0: // L802B691C
    func_802927E0(baphysics_get_target_yaw(),
                  baphysics_get_horizontal_velocity());
    break;
  case 1: // L802B6940
    func_802927E0(baphysics_get_target_yaw() + 10.0f,
                  baphysics_get_horizontal_velocity() * 0.88);
