...
void __bsDroneEnter_setSubstate(enum bsdroneenter_state_e arg0) {
  ...
  case 1:
    ...
    break;
  case 2:
    comusic_playTrackWithDefaultVolume(COMUSIC_43_ENTER_LEVEL_GLITTER, 32000);
    ...
    break;
  case 3:
    comusic_fadeTrackWithArgsNoDelay(COMUSIC_43_ENTER_LEVEL_GLITTER, 0, 2000);
    batimer_set(0, 0.55f);
    break;
  }
...
void __bsDroneEnter_emitParticles(void) {
  ...
  particleEmitter_setAccelerationRange(bsDroneEnter.yellow_sparkle_emitter,
                                       0.0f, 700.0f, 0.0f, 0.0f, 1200.0f, 0.0f);
  particleEmitter_setSpawnPositionRange(bsDroneEnter.yellow_sparkle_emitter,
                                        -45.0f, -5.0f, -45.0f, 45.0f, 10.0f,
                                        45.0f);
  ...
  particleEmitter_setAccelerationRange(bsDroneEnter.white_sparkle_emitter, 0.0f,
                                       700.0f, 0.0f, 0.0f, 1200.0f, 0.0f);
  particleEmitter_setSpawnPositionRange(bsDroneEnter.yellow_sparkle_emitter,
                                        -45.0f, -5.0f, -45.0f, 45.0f, 10.0f,
                                        45.0f);
  ...
  plyr_pos[1] += 130.0f;
  particleEmitter_setAccelerationRange(bsDroneEnter.yellow_sparkle_emitter,
                                       0.0f, -700.0f, 0.0f, 0.0f, -1200.0f,
                                       0.0f);
  particleEmitter_setSpawnPositionRange(bsDroneEnter.yellow_sparkle_emitter,
                                        -45.0f, -10.0f, -45.0f, 45.0f, 10.0f,
                                        45.0f);
  particleEmitter_setPosition(bsDroneEnter.yellow_sparkle_emitter, plyr_pos);
  particleEmitter_emitN(bsDroneEnter.yellow_sparkle_emitter, 1);
...
void __bsDroneEnter_initParticleTypes(ParticleEmitter *p_ctrl,
  ...
  particleEmitter_setAngularVelocityRange(p_ctrl, 0.0f, 0.0f, 300.0f, 0.0f,
                                          0.0f, 300.0f);
...
void __bsDroneEnter_init(void) {
  ...
  __bsDroneEnter_initParticleTypes(bsDroneEnter.white_sparkle_emitter,
                                   ASSET_716_SPRITE_SPARKLE_WHITE);
  bsDroneEnter.yellow_sparkle_emitter = partEmitMgr_newEmitter(60);
  __bsDroneEnter_initParticleTypes(bsDroneEnter.yellow_sparkle_emitter,
...
void bsDroneEnter_update(void) {
  ...
  case BSDRONEENTER_SUBSTATE_2:
    ...
    baModel_setEnvAlpha(
        (s32)ml_map_f(batimer_get(0), 0.0f, 0.4f, 255.0f, 0.0f));
    if (sp20) {
