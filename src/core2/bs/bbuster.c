...
/*.code*/
int func_8029FB20(Actor *arg0) { return !arg0->unk124_0; }
...
s32 func_8029FC4C(void) { return D_8037D2B8; }

s32 bsbbuster_hitboxActive(void) { return D_8037D2B7; }
...
void bsbbuster_update(void) {
  ...
  case 2: // 8029FEA0
    ...
    if (D_8037D2B4 == 0 && is_player_stable_or_falling(0x8c)) {
      func_8030E5F4(SFX_13_BEAKBUSTER_GROUND, 1.0f);
      D_8037D2B4++;
    }
    if (D_8037D2B6 == 0 && is_player_stable_or_falling(0x4b)) {
      baMotor_setRumbleParams(1.0f, 0.3f, 0.4f);
      D_8037D2B6++;
    }
...
void func_802A02B4(s32 arg0) { D_8037D2BB = arg0; }
