...
void func_802A354C(void) {
  ...
  yaw_setIdeal(mlNormalizeAngle(
      yaw_getIdeal() + ml_map_f(sp2C, -1.0f, 1.0f, yaw_range, -yaw_range)));
}
...
int bsbfly_inSet(enum bs_e arg0) {
  return arg0 == BS_BOMB || arg0 == BS_57_BOMB_END ||
         arg0 == BS_18_FLY_KNOCKBACK || arg0 == BS_59_BFLY_UNK59 ||
         arg0 == BS_FLY_OW || arg0 == BS_76_BFLY_LOCKED || arg0 == BS_24_FLY ||
         arg0 == BS_99_BFLY_DRONE;
}

int func_802A37F8(void) { return bsbfly_inSet(bs_getState()); }
...
void bsbfly_update(void) {
  ...
  if (baflag_isTrue(BA_FLAG_9)) {
    ...
    baphysics_set_terminal_velocity(
        ml_map_f(sp3C, 60.0f, 80.0f, -99.9f, -1000.33));
    baphysics_set_gravity(ml_map_f(sp3C, 60.0f, 80.0f, -300.0f, -700.0f));
    sp38 = ml_map_f(sp3C, 60.0f, 80.0f, 600.0f, 60.0f);
  } else {
    baphysics_set_terminal_velocity(
        ml_map_f(sp3C, 300.0f, 310.0f, -399.99f, -99.9f));
  ...
  if (D_8037D320 == 0.0f && bakey_pressed(BUTTON_B) && can_beak_bomb()) {
    sp2C = 0;
...
void func_802A3F70(void) { func_802A34C8(); }

int bsbfly_bombHitboxActive(void) { return D_8037D345; }
...
void func_802A411C(void) {
  ...
  case 0:
    if (anctrl_isAt(sp58, 0.6905f)) {
      ...
      basfx_playSfx(SFX_50_KAZOOIE_RRRUH, 1.3f, 0x7FFF);
      D_8037D345 = 1;
      D_8037D324 = 0.0f;
      D_8037D344 = 1;
    }
  ...
  case 1:
    ...
    if (sp48[0] * sp48[0] + sp48[1] * sp48[1] + sp48[2] * sp48[2] >
        16000000.0f) {
...
void func_802A4430(void) {
  ...
  baphysics_reset_terminal_velocity();
  baModel_setYDisplacement(0.0f);
  basfx_playSfx(SFX_31_BANJO_OHHWAAOOO, 1.0f, 0x7fff);
  basfx_playSfxWithVolume(SFX_61_CARTOONY_FALL, 1.0f, 0x7fff);
  D_8037D320 = 0.35f;
  D_8037D344 = 0;
}
...
void func_802A4548(void) {
  ...
  switch (D_8037D344) {
  case 0: // L802A457C
    if (is_player_stable_or_falling(0x5A)) {
...
void func_802A4664(void) {
  s32 next_state;
  basfx_stopSfxSource2();
  basfx_stopSfxSource3();
  next_state = bs_getNextState();
  if (next_state == BS_20_LANDING || next_state == BS_24_FLY ||
      next_state == BS_2D_SWIM_IDLE) {
...
void bsbfly_beakbomb_crash_init(void) {
  ...
  basfx_playSfx(SFX_36_BANJO_DOH, 1.0f, 28000);
  baMotor_setRumbleParams(1.0f, 0.5f, 0.5f);
  item_dec(ITEM_14_HEALTH);
  func_802A46C8();
...
void func_802A47E0(void) {
  ...
  if (anctrl_isAt(sp1C, 0.3659f)) {
    ...
    basfx_playSfx(SFX_8B_KAZOOIE_RAWW, 1.0f, 28000);
  }
  if (anctrl_isAt(sp1C, 0.6862f)) {
    FUNC_8030E624(SFX_1F_HITTING_AN_ENEMY_3, 0.8f, 18000);
    basfx_playSfx(SFX_38_BANJO_AYE_1, 1.0f, 22000);
  }
...
void func_802A48B4(void) {
  ...
  case 1:
    if (anctrl_isAt(sp18, 0.219f)) {
      basfx_playSfx(SFX_36_BANJO_DOH, 1.0f, 16000);
    }
...
void func_802A4CD0(void) { func_802A4A78(0); }

void func_802A4CF0(void) { func_802A4C34(0); }

void func_802A4D10(void) { func_802A4C88(0); }

void func_802A4D30(void) { func_802A4A78(1); }

void func_802A4D50(void) { func_802A4C34(1); }

void func_802A4D70(void) { func_802A4C88(1); }
...
void func_802A503C(void) { func_802A34C8(); }
...
void func_802A50D8(void) { bsdrone_update(); }
...
void func_802A5120(void) {
  ...
  basfx_playSfx(SFX_63_BANJO_UWAAAAOOH, 1.0f, 32000);
}
