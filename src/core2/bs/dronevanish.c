...
void __bsDroneVanish_emitParticles(void) {
  ...
  particleEmitter_setAccelerationRange(D_8037D450.unk4, 0.0f, 700.0f, 0.0f,
                                       0.0f, 1200.0f, 0.0f);
  particleEmitter_setPosition(D_8037D450.unk4, position);
  particleEmitter_emitN(D_8037D450.unk4, 1);
  particleEmitter_setAccelerationRange(D_8037D450.unk0, 0.0f, 700.0f, 0.0f,
                                       0.0f, 1200.0f, 0.0f);
...
void __bsDroneVanish_particleEmitInit(ParticleEmitter *p_ctrl,
  ...
  particleEmitter_setSpawnPositionRange(p_ctrl, -45.0f, 0.0f, -45.0f, 45.0f,
                                        0.0f, 45.0f);
...
void __bsDroneVanish_init(void) {
  ...
  __bsDroneVanish_particleEmitInit(D_8037D450.unk0,
                                   ASSET_716_SPRITE_SPARKLE_WHITE);
  D_8037D450.unk4 = partEmitMgr_newEmitter(60);
  __bsDroneVanish_particleEmitInit(D_8037D450.unk4,
...
void bsDroneVanish_update(void) {
  ...
  case 2:
    ...
    baModel_setEnvAlpha(
        (s32)ml_map_f(batimer_get(0), 0.0f, 0.4f, 0.0f, 255.0f));
    if (sp20) {
