...
void func_802AF7A0(ParticleEmitter *arg0, enum asset_e arg1) {
  ...
  particleEmitter_setAccelerationRange(arg0, 0.0f, -50.0f, 0.0f, 0.0f, -50.0f,
                                       0.0f);
  particleEmitter_setFade(arg0, 0.4f, 0.8f);
  particleEmitter_setFinalScaleRange(arg0, 0.03f, 0.03f);
  particleEmitter_setAngularVelocityRange(arg0, 0.0f, 0.0f, 300.0f, 0.0f, 0.0f,
                                          300.0f);
  particleEmitter_setParticleLifeTimeRange(arg0, 0.65f, 0.65f);
  particleEmitter_setCullDistance(arg0, 1.0f);
}

void func_802AF88C(ParticleEmitter *arg0, f32 arg1, f32 arg2) {
  particleEmitter_setParticleVelocityRange(arg0, arg1 * 30.0f, 10.0f,
                                           arg2 * 30.0f, arg1 * 30.0f, 10.0f,
                                           arg2 * 30.0f);
...
void func_802AF900(void) {
  ...
  sp48 = ml_fractional_part(sp3C, 0.38f);
  sp4C = sp48 * 6.283185308;
  sp40 = sinf(sp4C);
  sp44 = cosf(sp4C);
  sp30[0] += sp40 * D_8037D470.unk18;
  sp30[1] += ml_interpolate_f(ml_fractional_part(sp3C, 1.14f), 0.0f, 130.0f);
  ...
  sp30[1] += ml_interpolate_f(ml_fractional_part(sp3C, 1.14f), 130.0f, 0.0f);
...
void func_802AFB94(f32 arg0) { D_8037D470.unkC = arg0; }

void func_802AFBA0(f32 arg0) { D_8037D470.unk18 = arg0; }

void func_802AFBAC(f32 arg0) { D_8037D470.unk14 = arg0; }
...
void func_802AFBB8(f32 arg0[3]) {
  ...
  particleEmitter_setAngularVelocityRange(s0, 0.0f, 0.0f, 300.0f, 0.0f, 0.0f,
                                          300.0f);
  particleEmitter_setParticleLifeTimeRange(s0, 2.0f, 2.0f);
  particleEmitter_setCullDistance(s0, 1.0f);
  particleEmitter_setPosition(s0, arg0);
  ...
  particleEmitter_setBounceFactor(s0, 0.4f);
  particleEmitter_setCollisionCount(s0, 3);
...
void func_802B0060(UNK_TYPE(s32) arg0, UNK_TYPE(s32) arg1) {
  ...
  for (i = 0; i < 3; i++) {
    sp4C[i] =
        ml_smoothstep_sin_2pi(D_8037D470.unk20 + ((f32)i / 3.0) * 0.5, 0.5f) *
            (D_8037D470.unk24 * D_8037D470.unk28) +
        D_8037D470.unk24;
  }
  boneTransformList_setBoneScale(arg0, 3, sp4C);
}

void func_802B014C(void) { baanim_setModifyMethod(NULL); }
...
void func_802B01B0(f32 arg0) { D_8037D470.unk28 = arg0; }

void func_802B01BC(f32 arg0) { D_8037D470.unk24 = arg0; }

void func_802B01C8(void) { D_8037D470.unk20 += time_getDelta(); }
...
static void __bsdronexform_setState(int next_state) {
  ...
  case 6: // 802B033C
    ...
    if (D_8037D470.room_transformation == TRANSFORM_7_WISHWASHY ||
        D_8037D470.player_transformation == TRANSFORM_7_WISHWASHY) {
  ...
  case 8: // 802B03FC
    if (D_8037D470.room_transformation == TRANSFORM_1_BANJO &&
        D_8037D470.player_transformation == TRANSFORM_1_BANJO) {
...
void bsdronexform_update(void) {
  ...
  case 1:
    ...
    func_8031B990((s32)func_802B051C(0, 2.8f, 255.0f, 200.0f),
  ...
  case 8:
    ...
    func_8031B990((s32)func_802B051C(0, 1.0f, 200.0f, 255.0f),
