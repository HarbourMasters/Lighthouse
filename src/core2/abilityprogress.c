...
s32 ability_getAllLearned(void) { return abilityprogress_learnedAbilities; }
...
void ability_setAllLearned(s32 val) { abilityprogress_learnedAbilities = val; }

void ability_setAllUsed(s32 val) { abilityprogress_usedAbilities = val; }
