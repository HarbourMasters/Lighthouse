...
static void __ncCameraNodeList_setCameraNodeType(int camera_node_index,
                                                 s32 type);
...
s32 __ncCameraNodeList_capacity() { return NC_CAMERA_NODE_LIST_CAPACITY; }
...
void __ncCameraNodeList_nodeFromFile(File *file_ptr, int camera_node_index) {
  ...
  case 4:
    cameraNodeType4_fromFile(
        file_ptr, ncCameraNodeList_getCameraNodeType4(camera_node_index));
    break;
  case 3:
    cameraNodeType3_fromFile(
        file_ptr, ncCameraNodeList_getCameraNodeType3(camera_node_index));
    break;
  case 1:
    cameraNodeType1_fromFile(
        file_ptr, ncCameraNodeList_getCameraNodeType1(camera_node_index));
    break;
  case 2:
    cameraNodeType2_fromFile(
        file_ptr, ncCameraNodeList_getCameraNodeType2(camera_node_index));
    break;
  case 0:
    break;
  }
