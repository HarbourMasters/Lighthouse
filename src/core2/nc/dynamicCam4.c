...
void ncDynamicCam4_update(void) {
  ...
  sp44 += ml_clamp_abs(temp_f10 * D_8037DB10, sp38 * D_8037DB14);
  ml_vec3f_angles_between_points(sp84[0], sp84[1], sp84[2], sp6C[0], sp6C[1],
                                 sp6C[2], &sp54[0], &sp54[1]);
  ...
  sp48[0] = ml_clamp_abs(sp48[0], sp38 * 40.0f);
  sp48[1] = ml_clamp_abs(sp48[1], sp38 * D_8037DB20);
  sp54[0] = mlNormalizeAngle(sp54[0] + sp48[0]);
  sp54[1] = mlNormalizeAngle(sp54[1] + sp48[1]);

  ml_vec3f_rotate_direction(sp60, -sp54[0], sp54[1], 0.0f, 0.0f, sp44);
  ml_vec3f_add(sp78, sp84, sp60);
  ncDynamicCamera_setPosition(sp78);
  ml_vec3f_angles_between_points(sp84[0], sp84[1], sp84[2], sp78[0], sp78[1],
                                 sp78[2], &sp54[0], &sp54[1]);
  sp54[0] = -sp54[0];
  sp54[2] = 0.0f;
  func_802BD720(sp54);
}
