...
bool __ncFirstPersonCamera_fullyZoomedIn(void) {
  return (ml_vec3f_distance(D_8037DC60.position,
                            D_8037DC60.zoomed_in_position) < 40.0f);
}

void __ncFirstPersonCamera_getPositionAndRotation_entering(f32 arg0[3],
                                                           f32 arg1[3]) {
  s32 i;

  ml_sub_delta_time(&D_8037DC60.transistion_timer);
  for (i = 0; i < 3; i++) {
    D_8037DC60.position[i] = ml_mapSmoothstepTwice(
        D_8037DC60.transistion_timer, 1.0f, 0.0f,
        D_8037DC60.zoomed_out_position[i], D_8037DC60.zoomed_in_position[i]);
    D_8037DC60.rotation[i] = mlNormalizeAngle(
        D_8037DC60.zoomed_out_rotation[i] +
        ml_mapSmoothstepTwice(D_8037DC60.transistion_timer, 0.5f, 0.0f, 0.0f,
                              mlDiffDegF(D_8037DC60.zoomed_in_rotation[i],
                                         D_8037DC60.zoomed_out_rotation[i])));
  }
...
void __ncFirstPersonCamera_getPositionAndRotation_exiting(f32 arg0[3],
                                                          f32 arg1[3]) {
  s32 i;

  ml_sub_delta_time(&D_8037DC60.transistion_timer);
  for (i = 0; i < 3; i++) {
    D_8037DC60.position[i] =
        ml_mapSmoothstepTwice(D_8037DC60.transistion_timer, 1.0f, 0.0f,
                              D_8037DC60.zoomed_in_position[i], arg0[i]);
    D_8037DC60.rotation[i] = mlNormalizeAngle(
        D_8037DC60.zoomed_in_rotation[i] +
        ml_mapSmoothstepTwice(
            D_8037DC60.transistion_timer, 1.0f, 0.5f, 0.0f,
            mlDiffDegF(arg1[i], D_8037DC60.zoomed_in_rotation[i])));
  }
  if (D_8037DC60.transistion_timer == 0.0f) {
...
void __ncFirstPersonCamera_getPositionAndRotation_idle(f32 arg0[3],
                                                       f32 arg1[3]) {
  ml_vec3f_copy(D_8037DC60.position, D_8037DC60.zoomed_in_position);
  func_802BD780(D_8037DC60.zoomed_in_rotation, D_8037DC60.rotation, 10.0f,
                20.0f, 120.0f, 200.0f);
...
void ncFirstPersonCamera_getPositionAndRotation(f32 position[3],
                                                f32 rotation[3]) {
...
s32 ncFirstPersonCamera_getState(void) { return D_8037DC60.state; }
