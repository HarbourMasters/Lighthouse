...
extern void cameraTransition_start(f32);
...
void func_802C069C(void) {
  ...
  ml_vec3f_yaw_towards(sp28, &D_8037DBA8);
  D_8037DBAC = 0.0f;
}
...
void ncDynamicCam13_init(void) {
  ...
  func_802C0150(6);
  cameraTransition_start(0.5f);
  func_802C069C();
  func_802C095C();
}

f32 func_802C0780(void) { return func_802BD51C(); }
...
void ncDynamicCam13_update(void) {
  ...
  ml_vec3f_rotate_direction(sp60, 0.0f, D_8037DBA8, 0.0f, 0.0f, sp40);
