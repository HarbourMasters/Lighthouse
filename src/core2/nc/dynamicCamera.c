...
extern bool checkCollisionBelow(f32[3], f32[3], f32, f32, u32);
extern int findCollisionTriAlongPath(f32[3], f32[3], f32[3], u32, f32);
extern int findCollisionTri(f32[3], f32[3], f32, f32[3], s32, u32);
extern f32 func_8028E82C(void);
extern f32 player_getYaw(void);
extern f32 func_8028EF88(void);
extern int checkCollisionAlongPathWithRadius(f32[3], f32, f32[3], u32);
...
f32 D_80365CD0[] = {0.0f};
f32 D_80365CD4[] = {0.0f,  -25.0f,  25.0f,  -50.0f,  50.0f, -80.0f,
                    80.0f, -120.0f, 120.0f, -140.0f, 140.0f};
f32 D_80365D00[] = {0.0f,   20.0f,  40.0f,  60.0f,  80.0f,  100.0f,
                    120.0f, 140.0f, 160.0f, 180.0f, 200.0f, 220.0f,
                    240.0f, 260.0f, 280.0f, 300.0f, 320.0f, 340.0f};
...
bool func_802BC640(f32 arg0[3], f32 arg1[3], f32 arg2, s32 arg3) {
  ...
  for (phi_s0 = phi_s4->unk0; phi_s0 < phi_s4->unk0 + phi_s4->unk4; phi_s0++) {
    ...
    findCollisionTriAlongPath(arg0, sp78, sp88, 0x9E0000, 40.0f);
    findCollisionTri(arg0, sp78, 40.0f, sp88, 4, 0x9E0000);
...
s32 func_802BC84C(s32 arg0) {
  ...
  target_distance =
      gu_sqrtf(d_target[0] * d_target[0] + d_target[1] * d_target[1] +
               d_target[2] * d_target[2]);
  ...
  if (findCollisionTriAlongPathWithFlags(camera_position, sp20, sp74, 0x9E0000)) {
    D_8037D9F6++;
    if (D_8037D9F6 >= 5) {
      D_8037D9F6 = 0;
      return func_802BC640(player_position, target_direction, target_distance,
                           arg0);
    }
  } else {
    D_8037D9F6 = 0;
...
void func_802BCA58(void) {
    ...
    ml_vec3f_rotate_direction(D_8037D9A8, 0.0f, sp4C, 0.0f, 0.0f, ml_map_f(gu_sqrtf(sp34[0]*sp34[0] + sp34[2]*sp34[2]), 300.0f, 450.0f, 0.0f, sp48));
...
f32 func_802BCD60(void) {
  ...
  temp_v0 = checkCollisionBelow(sp28, sp34, 10.0f, -600.0f, 0x800000);
  if (temp_v0 == 0) {
...
bool func_802BCE0C(f32 arg0[3], f32 arg1[3]) {
  ...
  if (findCollisionTriAlongPath(arg0, sp2C, sp20, 0x9E0000, 40.0f)) {
    return FALSE;
  }
  if (findCollisionTri(arg0, sp2C, 40.0f, sp20, 4, 0x9E0000)) {
    return FALSE;
  }
  return TRUE;
}
...
void ncDynamicCamera_update(void) {
  ...
  cameraTransition_update(sp24, sp18);
...
int ncDynamicCamera_getState(void) { return dynamicCameraState; }
...
void ncDynamicCamera_setUpdateEnabled(bool arg0) { cameraUpdateEnabled = arg0; }
...
void func_802BD610(f32 arg0[3], f32 arg1[3], f32 arg2, f32 arg3, f32 arg4,
                   f32 arg5) {
  f32 sp24[3];
  ...
  sp24[0] = ml_clamp_abs(sp24[0], D_8037D98C * 0.003333);
  sp24[1] = ml_clamp_abs(sp24[1], D_8037D990 * 0.003333);
  sp24[2] = 0.0f;
...
void func_802BD780(f32 arg0[3], f32 arg1[3], f32 arg2, f32 arg3, f32 arg4,
                   f32 arg5) {
  s32 temp_s0;
  s32 temp_s1;
  s32 i;
...
f32 func_802BD8C8(void) { return D_8037D99C; }

f32 func_802BD8D4(void) { return D_8037D994; }

f32 func_802BD8E0(void) { return D_8037D998; }

void func_802BD8EC(f32 arg0) { D_8037D974 = arg0; }

f32 func_802BD8F8(void) { return D_8037D974; }
...
void func_802BDB30(f32 arg0, f32 *arg1, f32 *arg2, f32 arg3, f32 arg4,
                   f32 arg5) {
  f32 phi_f0;
  f32 sp38;
  s32 pad34;
...
void func_802BDCE0(f32 arg0, f32 *arg1, f32 *arg2, f32 arg3, f32 arg4) {
  ...
  *arg2 = (0.0333 * sp30) * arg4;
  if ((mlAbsF(sp34) < 0.5) ||
      ((mlAbsF(*arg2) > mlAbsF(sp34)) && ((sp34 * *arg2) > 0.0f))) {
    *arg2 = 0.0f;
    *arg1 = arg0;
  }
...
void func_802BE258(f32 arg0[3], f32 arg1) {
  ...
  for (i = 0; checkCollisionAlongPathWithRadius(arg0, arg1, sp54, 0x9e0000) && i < 1;
       i++) { // L802BE2C0
...
void func_802BE384(f32 arg0[3], f32 arg1[3], f32 arg2[3], f32 arg3[3],
                   f32 arg4[3]) {
  f32 sp34[3];
  f32 sp28[3];
  f32 sp1C[3];
...
void func_802BE484(f32 arg0[3], f32 arg1[3]) {
  ...
  sp3C[1] += sp30[1];
  sp3C[2] += sp30[2];
  sp2C = findCollisionTriAlongPathWithFlags(sp48, sp3C, sp54, 0x9e0000);
  ml_vec3f_diff(sp3C, sp30);

  tmp_v0 = findCollisionTri(sp48, sp3C, 35.0f, sp54, 3, 0x9e0000);
  if (sp2C || tmp_v0) {
    ...
    arg1[1] += sp30[1];
    arg1[2] += sp30[2];
    findCollisionTriAlongPathWithFlags(arg0, arg1, sp54, 0x9e0000);
...
int func_802BE60C(void) {
  ...
  return !(sp1C[0] == cameraPosition[0]) || !(sp1C[1] == cameraPosition[1]) ||
         !(sp1C[2] == cameraPosition[2]);
}
...
void func_802BE794(void) {
  f32 sp2C[3];
  f32 sp20[3];
  if (dynamicCameraState == 1 || dynamicCameraState == 0xb ||
      dynamicCameraState == 3) {
...
int func_802BE834(f32 arg0[3]) {
  ...
  sp30[1] += 60.0f;
  if (findCollisionTriAlongPathWithFlags(sp30, sp18, sp24, 0x9e0000))
    return 0;
  return 1;
}
