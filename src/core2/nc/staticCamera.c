...
void ncStaticCamera_rotateToTarget(f32 target[3]) {
  ml_vec3f_angles_between_points(
      target[0], target[1], target[2], ncStaticCameraPosition[0],
      ncStaticCameraPosition[1], ncStaticCameraPosition[2],
...
void ncStaticCamera_exit(void) { camera_setType(CAMERA_TYPE_2_DYNAMIC); }
