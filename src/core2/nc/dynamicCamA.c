...
extern void ml_vec3f_set_yaw_length(f32[3], f32, f32);
...
bool ncDynamicCamA_func_802C1DB0(f32 arg0) {
  ...
  ml_vec3f_yaw_towards(sp34, &D_80365DA4);
  D_80365DA8 = 0.0f;
  D_80365DA0 = mlNormalizeAngle(D_80365DA4 + arg0);
  D_80365DB0 = 0;
  pad4C = (arg0 / 5.0);
  ml_vec3f_set_yaw_length(sp1C, mlNormalizeAngle(D_80365DA4 + pad4C),
                          D_80365DAC);
  sp1C[0] += sp28[0];
  sp1C[2] += sp28[2];
...
bool ncDynamicCamA_func_802C1EE0(void) { return D_80365DB0; }
...
void ncDynamicCamA_update(void) {
  ...
  ml_vec3f_rotate_direction(sp90, 0.0f, D_80365DA4, 0.0f, 0.0f, D_80365DAC);
