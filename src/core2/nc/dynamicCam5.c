...
void ncDynamicCam5_update(void) {
  ...
  sp30 = ml_map_f(
      D_8037DABC, 0.2f, 0.5f,
      gu_sqrtf(sp5C[0] * sp5C[0] + sp5C[1] * sp5C[1] + sp5C[2] * sp5C[2]),
      300.0f);
  ...
  ml_vec3f_angles_between_points(sp74[0], sp74[1], sp74[2], sp68[0], sp68[1],
                                 sp68[2], &sp38[0], &sp38[1]);
  sp38[0] = -sp38[0];
  sp38[2] = 0.0f;
  func_802BD904(sp38);
}
