...
f32 ncDynamicCam9_func_802C09E8(void) {
  ...
  return ml_min_f(gu_sqrtf(d_pos[0] * d_pos[0] + d_pos[2] * d_pos[2]),
                  D_8037DBBC) /
         D_8037DBBC;
}
...
void ncDynamicCam9_func_802C0A60(f32 arg0[3]) {
  ...
  func_802BD4C0(sp54);
  ml_vec3f_angles_between_points(sp54[0], sp54[1], sp54[2], D_8037DBB0[0],
                                 D_8037DBB0[1], D_8037DBB0[2], &sp30[0],
                                 &sp30[1]);
  sp30[1] = mlNormalizeAngle(sp30[1] - 60.0f);
  ml_vec3f_rotate_direction(sp48, 0.0f, sp30[1], 0.0f, 0.0f, D_8037DBC0);
...
void ncDynamicCam9_func_802C0B70(f32 arg0[3], f32 arg1[3]) {
  ...
  sp3C[1] *= dt * 1.0;
  sp3C[2] *= dt * 1.5;
  sp3C[0] = ml_clamp_abs(sp3C[0], dt * 1000.0);
  sp3C[1] = ml_clamp_abs(sp3C[1], dt * 1000.0);
  sp3C[2] = ml_clamp_abs(sp3C[2], dt * 1000.0);
...
void ncDynamicCam9_func_802C0C5C(f32 arg0[3], f32 arg1[3]) {
  ...
  ml_vec3f_angles_between_points(sp54[0], sp54[1], sp54[2], arg1[0], arg1[1],
                                 arg1[2], &arg0[0], &arg0[1]);
...
void ncDynamicCam9_func_802C0E38(f32 arg0, f32 arg1, f32 arg2, f32 arg3,
                                 f32 arg4) {
  D_8037DBB0[0] = arg0;
  D_8037DBB0[1] = arg1;
  D_8037DBB0[2] = arg2;
