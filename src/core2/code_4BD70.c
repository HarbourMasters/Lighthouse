...
/* .data */
ActorInfo mumboSign5Tokens = {MARKER_1E9_MUMBO_COST_SIGN,
                        ACTOR_368_5_MUMBO_TOKEN_SIGN,
                        ASSET_301_MODEL_5_MUMBO_TOKEN_SIGN,
                        0x0,
                        0x0,
                        chMumboSign_update,
                        ...
                        0.0f,
                        0};
ActorInfo mumboSign10Tokens = {MARKER_1E9_MUMBO_COST_SIGN,
                        ...
                        0.0f,
                        0};
ActorInfo mumboSign15Tokens = {MARKER_1E9_MUMBO_COST_SIGN,
                        ...
                        0.0f,
                        0};
ActorInfo mumboSign20Tokens = {MARKER_1E9_MUMBO_COST_SIGN,
                        ...
                        0.0f,
                        0};
ActorInfo mumboSign25Tokens = {MARKER_1E9_MUMBO_COST_SIGN,
...
void chMumboSign_update(Actor *this) {
  if (!this->volatile_initialized) {
    if (fileProgressFlag_get(this->modelCacheIndex -
                             ACTOR_368_5_MUMBO_TOKEN_SIGN +
