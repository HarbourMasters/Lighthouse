...
BKSprite_s *assetCache_releaseSound(enum asset_e sprite_id, BKSpriteDisplayData **arg1);
...
gczoomboxPortraitInfo D_8036C6C0[] = {
    ...
    {ASSET_7E6_SPRITE_VILE, 0xF2, 0x0A, {{SFX_6E_VILE_EGH, 20000, 1.0f}}},
    {ASSET_7E6_SPRITE_VILE, 0xF2, 0x0A, {{SFX_6E_VILE_EGH, 20000, 1.0f}}},
    {ASSET_7E6_SPRITE_VILE, 0xF2, 0x0A, {{SFX_6E_VILE_EGH, 20000, 1.0f}}},
    {ASSET_7EF_SPRITE_BANJO, 0xF4, 0x06, {{SFX_95_BANJO_TALKING, 20000, 1.2f}}},
    {ASSET_816_SPRITE_GRUNTILDA,
     0xDA,
     0xE5,
     {{SFX_EC_GRUNTY_TALKING_1, 20000, 1.1f},
    ...
    {ASSET_80D_SPRITE_LIVE_JIGGY,
     0xEE,
     0x05,
     {{SFX_E6_MEEP_1, 20000, 1.8f}, {SFX_E7_MEEP_2, 20000, 1.8f}}},
    ...
    {ASSET_81B_SPRITE_LIVE_MUSIC_NOTE,
     0xF2,
     0x06,
    ...
    {ASSET_80D_SPRITE_LIVE_JIGGY,
     ...
     0x05,
     {{SFX_E6_MEEP_1, 20000, 1.8f}, {SFX_E7_MEEP_2, 20000, 1.8f}}},
    {ASSET_81D_SPRITE_LIVE_EXTRA_HEALTH_MAX,
     0xED,
     0x06,
     {{SFX_102_ZUBBA_TALKING, 20000, 1.4f}}},
    {ASSET_827_SPRITE_LIVE_CLOCK, 0xEE, 0x08, {{SFX_6E_VILE_EGH, 20000, 1.0f}}},
    {ASSET_7EF_SPRITE_BANJO, 0xF4, 0x06, {{SFX_95_BANJO_TALKING, 20000, 1.2f}}},
    ...
    {ASSET_800_SPRITE_SNIPPET,
     0xF1,
     0x04,
     {{SFX_3F8_UNKNOWN, 32000, 1.1f}, {SFX_3D_TICKER_WALKING, 32000, 1.1f}}},
    {ASSET_7E6_SPRITE_VILE, 0xF0, 0x0A, {{SFX_6E_VILE_EGH, 20000, 1.0f}}},
    ...
    {ASSET_7F7_SPRITE_GOBI, 0xEE, 0x06, {{SFX_84_GOBI_CRYING, 20000, 1.0f}}},
    {ASSET_7FF_SPRITE_GRABBA, 0xE2, 0xF6, {{SFX_D7_GRABBA_DEATH, 30000, 0.7f}}},
    ...
    {ASSET_808_SPRITE_LIVE_MUMBO_TOKEN,
     0xEC,
     0x08,
    ...
    {ASSET_80E_SPRITE_LIVE_EXTRA_LIFE,
     0xF0,
     0x04,
     {{SFX_E6_MEEP_1, 20000, 0.8f}, {SFX_E7_MEEP_2, 20000, 0.8f}}},
    {ASSET_80D_SPRITE_LIVE_JIGGY,
     0xEE,
     0x05,
     {{SFX_E6_MEEP_1, 20000, 1.8f}, {SFX_E7_MEEP_2, 20000, 1.8f}}},
    {ASSET_812_SPRITE_LIVE_EMPTY_HONEYCOMB,
     0xEF,
     0x04,
    ...
    {ASSET_80C_SPRITE_LIVE_WADING_BOOTS,
     0xEB,
     0x02,
     {{SFX_101_LOGGO_TALKING, 20000, 1.2f}}},
    {ASSET_813_SPRITE_PIRANHA, 0xEE, 0x07, {{SFX_6D_CROC_BITE, 20000, 1.2f}}},
    ...
    {ASSET_839_SPRITE_YUMYUM, 0xED, 0x05, {{SFX_4C_LIP_SMACK, 32000, 1.1f}}},
    ...
    {ASSET_82A_SPRITE_LEAKY,
     0xF1,
     0x07,
     {{SFX_109_LOGGO_LID_CLAP, 32000, 1.1f}}},
    {ASSET_836_SPRITE_GLOOP, 0xED, 0x07, {{SFX_C6_SHAKING_MOUTH, 20000, 0.7f}}},
    {ASSET_82F_SPRITE_TIPTUP_CHOIR_MEMBER,
     0xEF,
     0x07,
     {{SFX_86_TIPTUP_CHORUS_AH, 20000, 1.2f}}},
    {ASSET_814_SPRITE_SNACKER, 0xEE, 0x07, {{SFX_6D_CROC_BITE, 20000, 0.9f}}},
    ...
    {ASSET_838_SPRITE_SNORKEL, 0xF1, 0x0A, {{SFX_D1_SNORKEL_WAH, 20000, 1.2f}}},
    ...
    {ASSET_835_SPRITE_WOZZA, 0xEE, 0x08, {{SFX_88_WOZZA_NOISE, 20000, 1.0f}}},
    ...
    {ASSET_831_SPRITE_NABNUT, 0xF0, 0x05, {{SFX_C3_HEGH, 20000, 1.7f}}},
    ...
    {ASSET_7FA_SPRITE_WARP_CAULDRON, 0xED, 0x07, {{SFX_3ED, 20000, 0.8f}}},
    ...
    {ASSET_815_SPRITE_TOOTY,
     ...
     {{SFX_E8_TOOTY_TALKING_1, 20000, 1.1f},
      {SFX_E9_TOOTY_TALKING_2, 20000, 1.1f},
      {SFX_122_TOOTY_TALKING_3, 22000, 1.0f}}},
    {ASSET_833_SPRITE_DINGPOT, 0xEF, 0x06, {{SFX_3ED, 20000, 0.8f}}},
...
void func_80315200(GcZoombox *this) {
  ...
  if (-1.0f == this->unk110[0]) {
    if (comusic_isTrackQueued(this->unk108[0])) {
      comusic_stopTrack(this->unk108[0]);
    }
  } else {
    for (s1 = 0; s1 < 5; s1++) {
      if (this->unk108[s1]) {
...
void func_803152C4(GcZoombox *this) {
  if (this->unk100 != NULL) {
    assetCache_releaseBKModelBin(&this->unk100);
    this->unk100 = NULL;
  }
}
...
void func_80315300(GcZoombox *this) {
  if (this->model != NULL) {
    assetCache_releaseBKModelBin(&this->model);
    this->model = NULL;
  }
  ...
  if (this->unkF8 != NULL) {
    assetCache_releaseBKModelBin(&this->unkF8);
    this->unkF8 = NULL;
  }
  func_803152C4(this);
}
...
void func_80315484(GcZoombox *this) {
  if (this->unk1A4_31 && !this->unk1A4_26) {
    this->unk16C =
        0.5 * ((this->unk1A4_19) ? 0xf : 0xc) * this->unk198 + this->unk166;
  } else { // L803154F4
...
static s32 _gczoombox_findLineBreak(char *string, s32 line_length) {
  s32 i;
  for (i = gczoombox_strlen(string);
       (line_length < (__get_str_print_len(string, i)) || (' ' != string[i]));
       i--)
    ;
  return i;
}
  ...
  if (this != NULL && this->sfx_count != 0 && this->unk1A4_11) {
    ...
    if (this->unk110[0] == -1.0f) {
      ...
      if (this->sfx_count != 1) {
        ...
        } while (current_sfx == this->prev_sfx ||
                 this->unk124[current_sfx] == 0);
      }
      ...
      if (phi_f14 < -1.0f) {
        ...
        } while (phi_f12 == -11.0 || phi_f12 == -9.0 || phi_f12 == -7.0 ||
                 phi_f12 == -6.0 || phi_f12 == -4.0 || phi_f12 == -2.0 ||
                 phi_f12 == -1.0);
        ...
        sfxsource_playSfxAtVolume(this->unk108[current_sfx],
                                  alCents2Ratio(phi_f12 * 100.0f));
      } else {
        ...
        sfxsource_playSfxAtVolume(this->unk108[current_sfx],
                                  randf2(phi_f12, phi_f14));
      }

      phi_a0 = (this->unk124[current_sfx] - phi_s1_3 < 0)
                   ? 0
                   : this->unk124[current_sfx] - phi_s1_3;
      phi_a1 = (this->unk124[current_sfx] - phi_s2 < 0)
                   ? 0
                   : this->unk124[current_sfx] - phi_s2;
      sfxsource_setSampleRate(this->unk108[current_sfx],
                              randi2(phi_a0, phi_a1));
...
void gczoombox_func_803160A8(GcZoombox *this) {
  ...
  if (D_8036C6C0[this->portrait_id].soundInfo[0].pitch != -1.0f) {
    ...
    if (func_8030ED70(
            D_8036C6C0[this->portrait_id].soundInfo[sound_index].sfx_id) == 0) {
      func_8030E760(D_8036C6C0[this->portrait_id].soundInfo[sound_index].sfx_id,
                    randf2(sp40, sp3C),
                    randi2((sp50 - 6000 < 0) ? 0 : sp50 - 6000,
                           (sp50 - phi_a1 < 0) ? 0 : sp50 - phi_a1));
    }
  }
}

void func_803162B4(GcZoombox *this) {
  setPrintColor(this->unk168, this->unk168, this->unk168);
  if (this->unk1A4_30) {
    if (this->unk1A4_17) {
      printDialogWithGradient(this->unk16A, this->unk16C, this->unk0, this->unk166, -1);
...
void func_803163A8(GcZoombox *this, Gfx **gfx, Mtx **mtx) {
  ...
  modelRender_draw(gfx, mtx, sp50, sp5C, this->unk198 * sp34, sp38,
                   this->model);
}

void func_803164B0(GcZoombox *this, Gfx **gfx, Mtx **mtx, s32 arg3, s32 arg4,
                   BKSpriteDisplayData *arg5, f32 arg6) {
  f32 sp2C[3];
  f32 temp_f12;
  ...
  sp2C[2] = -10.0f;
  mlMtx_set_translation_vec3f((sp2C[0] * 4.0f) - ((f32)gFramebufferWidth * 2),
                              ((f32)gFramebufferHeight * 2) - (sp2C[1] * 4.0f),
                              sp2C[2]);
...
void func_80316764(GcZoombox *this, s32 arg1) {
  ...
  if (!this->unk1A4_10) {
    ...
    pfsManager_getSideButtonState(0, sp2C);
    phi_f0 = time_getDelta();
  } else {
    pfsManager_getFirstControllerFaceButtonState(0, sp38);
    pfsManager_getFirstControllerSideButtonState(0, sp2C);
...
void gczoombox_draw(GcZoombox *this, Gfx **gdl, Mtx **mptr, void *vptr) {
  ...
  if (this->unk1A4_28 && this->state && this->model) {
    ...
    if (this->unk139 == 2 ||
        (game_getMode() != GAME_MODE_3_NORMAL &&
         game_getMode() != GAME_MODE_8_BOTTLES_BONUS &&
         game_getMode() != GAME_MODE_A_SNS_PICTURE &&
         !volatileFlag_get(
             VOLATILE_FLAG_1F_IN_CHARACTER_PARADE))) { // L80316C64
    ...
    if (!this->unk1A4_13) {
      func_803164B0(this, gdl, mptr, this->unk176, this->unk177, this->unkFC,
                    1.0f);
    } else {
      func_803164B0(this, gdl, mptr, this->unk176, this->unk177, this->unkFC,
                    1.0 - this->unk17C);
      func_803164B0(this, gdl, mptr, this->unk178, this->unk179, this->unk104,
                    this->unk17C);
    } // L80316D40
...
s32 gczoombox_strlen(u8 *arg0) { return bk_strlen(arg0); }
...
void gczoombox_update(GcZoombox *this) {
  ...
  if (!this->unk1A4_10) {
    ...
    pfsManager_getSideButtonState(0, sp4C);
    tmp_f0 = time_getDelta();
  } else {
    pfsManager_getFirstControllerFaceButtonState(0, sp58);
    pfsManager_getFirstControllerSideButtonState(0, sp4C);
  ...
  case 0x1: // L80316F90
    if (this->unk15D) {
      ...
      this->unk166 =
          ((this->unk1A4_19) ? 0x11 : 0x14) * this->unk198 + this->unk164;
    }
  ...
  case 0x2: // L80317190
  {
    ...
    while (sp44 < this->unk18C && this->unk15C >= this->unk15E) {
      ...
      if (func_803156F0(this->unk60[this->unk15E], this->unk1A4_19)) {
        this->unk18C -=
            (sp58[FACE_BUTTON(BUTTON_A)] && this->unk1A4_12) ? 0.05 : 0.1;
      } // L803172B4
      this->unk18C -= sp44;
    } // L803172EC
    if (this->unk1A4_26) {
  ...
  case 0x5: // L803177D4
    if (this->unk1A4_16) {
      ...
      if (this->unk1A4_14) {
        this->unk17C =
            1.0 - anctrl_getAnimTimer(this->anim_ctrl) / this->unk194;
      }
    } // L8031782C
...
void __gczoombox_load_sprite(GcZoombox *this, GcZoomboxSprite portrait_id) {
  this->unkF8 = assetCache_releaseSound(D_8036C6C0[portrait_id].spite_id, &this->unkFC);
    ...
    if (D_8036C6C0[portrait_id].soundInfo[0].pitch == -1.0f) {
      ...
      for (i = 0; i < 5; i++) { // L80317DFC
        if (D_8036C6C0[portrait_id].soundInfo[i].unk2) {
          this->unk108[i] = func_80315BC0(
              this, D_8036C6C0[portrait_id].soundInfo[i].sfx_id, 3);
...
GcZoombox *gczoombox_new(s32 y, GcZoomboxSprite portrait_id, s32 arg2, s32 arg3,
                         void (*callback)(s32 portrait_id, s32 state)) {
  GcZoombox *this;
  s32 i;
  s32 temp_v1;

  this = (GcZoombox *)heap_malloc(sizeof(GcZoombox));
  ...
  this->unk181 = this->unk185 = this->unk186 = this->unk187 = this->unk189 =
      this->unk18A = 0;
  this->unk180 = 0;
  this->unk18C = 0.0f;
  this->unk194 = 0.999f;
  ...
  this->unk1A4_31 = this->unk1A4_30 = this->unk1A4_29 = this->unk1A4_28 =
      this->unk1A4_27 = this->unk1A4_26 = this->unk1A4_25 = this->unk1A4_23 =
          this->unk1A4_22 = this->unk1A4_21 = this->unk1A4_20 =
              this->unk1A4_17 = this->unk1A4_16 = this->unk1A4_15 =
                  this->unk1A4_14 = this->unk1A4_13 = 0;
  ...
  gczoombox_func_803184C8(
      this, 15.0f, 5, 2, 0.4f, 0,
      0); // gczoombox_func_803184C8(this, 15.0f, 5, 2, D_80378940, 0, 0);
...
void gczoombox_open(GcZoombox *this) { this->unk13A |= 0x1; }

void gczoombox_close(GcZoombox *this) { this->unk13A |= 0x10; }

void gczoombox_maximize(GcZoombox *this) { this->unk13A |= 0x2; }

void gczoombox_minimize(GcZoombox *this) { this->unk13A |= 0x8; }

void func_8031842C(GcZoombox *this) { this->unk13A |= 0x20; }
...
void func_80318478(GcZoombox *this) { this->unk13A &= (u8) ~(0x1); }

void func_80318488(GcZoombox *this) { this->unk13A &= (u8) ~(0x10); }

void func_80318498(GcZoombox *this) { this->unk13A &= (u8) ~(0x2); }

void gczoombox_resolve_minimize(GcZoombox *this) {
  this->unk13A &= (u8) ~(0x8);
}

void func_803184B8(GcZoombox *this) { this->unk13A &= (u8) ~(0x20); }

void gczoombox_func_803184C8(GcZoombox *this, f32 arg1, s32 arg2, s32 arg3,
                             f32 animation_duration, bool arg5, bool arg6) {
...
bool gczoombox_is_highlighted(GcZoombox *this) { return this->highlighted; }
...
void gczoombox_setUnk13ATo0(GcZoombox *this) { this->unk13A = 0; }

bool func_8031877C(GcZoombox *this) {
  if (this == NULL || this->state == 0 || this->state == 0xb ||
      this->state == 0x9 || this->state == 0x6 || this->state == 0x7) {
    return FALSE;
  }
  _gczoombox_memClear(this->unk0, 0x30);
  _gczoombox_memClear(this->unk30, 0x30);

  this->unk1A4_30 = this->unk1A4_29 = this->unk1A4_27 = this->unk1A4_26 =
      this->unk1A4_31 = this->unk1A4_23 = this->unk15D = 0;

  if (this->state == 10 || this->state == 0x1 || this->state == 0x2 ||
      this->state == 0x3 || this->state == 0x4) {
    this->state = 10;
    this->unk134 = 3;
  }
  func_8031843C(this);
...
bool func_803188B4(GcZoombox *this) {
  ...
  if ((this == NULL) || (this->state == 0) || (this->state == 7) ||
      (this->state == 9)) {
    return FALSE;
  }
...
bool gczoombox_loadSprite(GcZoombox *this, GcZoomboxSprite arg1) {
  if (this == NULL || arg1 == this->portrait_id ||
      (this->state != 6 && this->state != 0xa && this->state != 0xb &&
       this->state != 0x9)) {
    return FALSE;
  }
...
bool func_80318BEC(GcZoombox *this) { return this != NULL && !this->state; }
    ...
    if (this->unk1A4_29) {
      if (arg1 != FALSE) {
        if (this->unk30[0] == 0xFD) {
          ...
          this->unk30[0] = 0xFD;
          this->unk30[1] = 0x68;
          func_803153A8(D_803830B0, &this->unk30[2], 0,
                        sizeof(this->unk30) - 2);
        }
