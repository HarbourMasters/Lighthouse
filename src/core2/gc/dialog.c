...
void loadAndCreateDialogs(s32 text_id, s32 arg1, ActorMarker *marker, void(*callback)(ActorMarker *, s32, s32), void(*arg4)(ActorMarker *, s32, s32), s32(*arg5)(ActorMarker *, s32, s32)){ // [port] arg5 was s32 — function pointer
    s32 i;
    s32 j;
...
void updateDialogYPositions(void){
    ...
    if(g_Dialog.unk128_4){
        g_Dialog.unk132++;
        ch = Y_POSITION_MODIFIERS[g_Dialog.unk132];
...
int func_803110F8(s32 next_state, s32 arg1, s32 arg2, s32 arg3, void (*arg4)(ActorMarker *, enum asset_e, s32)){
    ...
    gcdialog_showDialogConditional(next_state + 0xe57, 0x84, NULL, NULL, NULL, NULL, (s32(*)(ActorMarker *, s32, s32))arg4); // [port] polymorphic callback type
    func_80310A5C(arg2, arg3, arg1, 0, 0);
    return 1;
}

int gcdialog_showDialogConditional(s32 text_id, s32 arg1, f32 *pos, ActorMarker *marker, void(*callback)(ActorMarker *, enum asset_e, s32), void(*arg5)(ActorMarker *, enum asset_e, s32), s32(*arg6)(ActorMarker *, s32, s32)){ // [port] arg6 was s32 — function pointer
    f32 pad;
    s32 temp_v1;
