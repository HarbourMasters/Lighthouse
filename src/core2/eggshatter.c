...
void eggShatter_free(void) { particleEmitter_free(gEggShatter_controller); }
...
void eggShatter_init(void) {
  ...
  particleEmitter_setBounceFactor(gEggShatter_controller, 0.6f);
  particleEmitter_setCollisionCount(gEggShatter_controller, 0);
  particleEmitter_setStartingScaleRange(gEggShatter_controller, 0.8f, 1.0f);
  particleEmitter_setAngularVelocityRange(
      gEggShatter_controller, 400.0f, 400.0f, 400.0f, 800.0f, 800.0f, 800.0f);
  ...
  particleEmitter_setVelocityAccelerationAndPositionRanges(
      gEggShatter_controller, &D_803637A0);
}

void eggShatter_update(void) { particleEmitter_update(gEggShatter_controller); }
