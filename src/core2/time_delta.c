...
void func_80352CF4(f32 arg0[3], f32 arg1[3], f32 arg2, f32 arg3) {
    ...
    if (commonParticle_new(7, 1) >= 0) {
        ...
        sp1B = func_8033E93C();
        sp1C = (f32*)commonParticle_getCurrentParticle(); // [port] ParticleStruct0s* to f32* — decomp treats struct as float array
        sp1C[0] = arg2;
...
void func_80352F58(void){
    f32 *sp2C = (f32*)commonParticle_getCurrentParticle(); // [port] ParticleStruct0s* to f32* — decomp treats struct as float array
