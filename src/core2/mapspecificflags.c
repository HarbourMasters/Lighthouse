...
/* .code */
u32 mapSpecificFlags_calcCRC1(void) { return D_80367000 ^ 0x1195E97; }

void mapSpecificFlags_updateCRCs(void) {
  D_8037DDE4 = D_80367000 ^ 0xA84E38C8;
  D_8037DDE0 = mapSpecificFlags_calcCRC1();
...
s32 mapSpecificFlags_get(s32 i) { return (D_80367000 & (1 << i)) ? 1 : 0; }
...
u32 mapSpecificFlags_getAll(void) { return D_80367000; }
...
s32 *bitfield_new(s32 arg0) {
  ...
  phi_v0 = (s32 *)heap_malloc((((arg0 + 0x1F) >> 5) + 1) * sizeof(s32));
  *phi_v0 = arg0;
  return phi_v0;
}

void bitfield_free(s32 *arg0) { bk_free(arg0); }
...
s32 mapSpecificFlags_validateCRC1(void) {
  return mapSpecificFlags_calcCRC1() == D_8037DDE0;
}
