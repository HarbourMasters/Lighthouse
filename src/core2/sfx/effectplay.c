...
extern void func_802DB4E0(ActorMarker *, s32); // [port] was (s32, s32), first param is ActorMarker*
...
typedef struct {
    ...
    s16 unk2A;
    f32 unk2C;
    void (*unk30)(ActorMarker *, s32); // [port] was (s32, s32), pointer truncation fix
    void (*unk34)(ActorMarker *, s32); // [port] was (s32, s32), pointer truncation fix
}ActorLocal_Skeleton;
...
void chskeleton_despawn(ActorMarker *marker, s32 arg1) {
    ...
    SFX_PLAYFADE(SFX_119_FISH_DEATH, 1.0f, 32000, this->position, 1250, 2500);
