...
void func_8035CF60(ActorMarker * marker, s32 arg1) {
    ...
    SFX_PLAYFADE(SFX_C2_GRUBLIN_EGH, 1.0f, 32000, actor->position, 1250, 2500);
...
void func_8035D058(Actor *this) {
    ...
    if (this->state == 5) {
        if (actor_animationIsAt(this, 0.18f) != 0) {
            SFX_PLAYFADE(SFX_2_CLAW_SWIPE, 1.0f, 28000, this->position, 0x4E2, 0x9C4);
        }
        if (actor_animationIsAt(this, 0.7f) != 0) {
            SFX_PLAYFADE(SFX_1F_HITTING_AN_ENEMY_3, 1.0f, 28000, this->position, 0x4E2, 0x9C4);
