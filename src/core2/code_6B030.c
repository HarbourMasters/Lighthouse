...
Gfx D_80368AC0[] = {
    ...
    gsDPSetCombineLERP(TEXEL1, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, 0, 0, 0,
...
Gfx D_80368B08[] = {
    gsDPPipeSync(),
    gsDPSetCombineLERP(TEXEL0, PRIMITIVE, TEXEL0, PRIMITIVE, TEXEL0, 0, SHADE,
                       0, COMBINED, 0, SHADE, 0, 0, 0, 0, COMBINED),
    gsDPSetPrimColor(0, 0, 0x50, 0xF0, 0xFF, 0xFF), gsSPEndDisplayList()};

Struct_core2_6B030_1 D_80368B28[] = {{0x704, 0xFFFF}, {0x705, 0xFFFF}};
...
/* .code */
void drawSpriteWithEffects(Struct65s *self, Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  f32 temp_f2;
  s16 *temp_addr;
  f32 spDC[3];
  f32 spD0[3];
  ...
  mlMtx_set_translation_vec3f(spD0[0], spD0[1], spD0[2]);
  mlMtxApply(*mtx);
  ...
  temp_s5 = (s32)((f32)self->unk20 * ((1.0f - (self->unk25 / 255.0f)) +
                                      ((self->unk25 / 255.0f) - temp_f2)));
  mlMtxSet(&D_80380A18);
  ...
  __gSPDisplayList((*gfx)++, D_80368AC0);
  func_80347FC0(gfx, D_80368AB0[1].unk0, 0, 0, 0, 0, 0, NULL, NULL, &width,
                &height);
  temp_addr = &gFramebuffers[getOtherFramebuffer()]
                            [spC0 * gFramebufferWidth + (spC4 & 0xFFFC)];
  gDPSetTextureImage((*gfx)++, G_IM_FMT_RGBA, G_IM_SIZ_16b, gFramebufferWidth,
                     temp_addr);
  gDPSetTile((*gfx)++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 9, 0x0080, G_TX_LOADTILE, 0,
             G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOLOD,
             G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOLOD);
  gDPLoadSync((*gfx)++);
  gDPLoadTile((*gfx)++, G_TX_LOADTILE, 0, 0, 0x008C, 0x007C);
  gDPPipeSync((*gfx)++);
  gDPSetTile((*gfx)++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 9, 0x0080, 1, 0,
             G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOLOD,
             G_TX_NOMIRROR | G_TX_CLAMP, G_TX_NOMASK, G_TX_NOLOD);
  gDPSetTileSize((*gfx)++, 1, ((3 - (spC4 % 4)) + 1 - 1) << 2, 0,
                 (((3 - (spC4 % 4)) + 0x20) - 1) << 2, 0x007C);
  __gSPVertex((*gfx)++, *vtx, 8, 0);
  gSP1Quadrangle((*gfx)++, 0, 1, 3, 2, 0);
  func_80349AD0();
  func_80347FC0(gfx, (D_80368AB0 + self->unk22)->unk0, 0, 0, 0, 0, 0, 2, 2,
                &width, &height);
  if ((D_80368AB0 + self->unk22)->unk4 != NULL) {
    func_80347FC0(gfx, (D_80368AB0 + self->unk22)->unk4, 0, 0x100, 1, 0, 0, 2,
                  2, &width, &height);
  }
  __gSPDisplayList((*gfx)++, D_80368B08);
...
void removeInactiveStructs(Struct64s *arg0) {
  s32 i;
  Struct65s *i_ptr;
  Struct65s *end_ptr;
  ...
  while (i < arg0->unk4 - 1) {
    ...
    if (!(i_ptr->unk23 & 1)) {
      ...
      if (i_ptr != end_ptr) {
        ...
        heap_memcpy(i_ptr, end_ptr, sizeof(Struct65s));
      } else {
      ...
      if (arg0->unk4 != 0) {
        ...
        arg0->unk0 =
            (Struct65s *)bk_realloc(arg0->unk0, arg0->unk4 * sizeof(Struct65s));
      } else {
...
void updateStructPosition(Struct65s *arg0) {
  f32 sp1C;
  s32 sp18;
...
void *initializeStruct(void) {
  ...
  if (D_80368AB4 == 0) {
    ...
    D_80380A10 = (f32 *)heap_malloc(0x100 * sizeof(f32));
    for (var_s1 = 0; var_s1 < 0x100; var_s1++) {
      D_80380A10[var_s1] = 0.0f;
    };
  }
  D_80368AB4++;
  temp_v0 = heap_malloc(8);
  if (temp_v0 == NULL) {
    return NULL;
  }
  temp_v0->unk0 = 0;
  temp_v0->unk4 = 0;
  D_80380A58 = heap_getTotalSize() - heap_get_occupied_size();
  return temp_v0;
}

void freeStruct(Struct64s *arg0) {
  s32 var_s1;
...
void updateStructs(Struct64s *arg0) {
  Struct65s *var_s0;
  ...
  if ((arg0 != NULL) && (arg0->unk4 != 0)) {
    ...
    for (var_s0 = arg0->unk0; var_s0 < arg0->unk0 + arg0->unk4; var_s0++) {
      if (var_s0->unk23 & 1) {
        if (var_s0->unk10(var_s0->unk0, (f32)var_s0->unk20, var_s0->unkC) ==
            0) {
          updateStructPosition(var_s0);
        } else {
          var_s0->unk23 &= ~1;
        }
      }
    }
    removeInactiveStructs(arg0);
  }
}

void deactivateStruct(Struct65s *arg0) { arg0->unk23 &= ~1; }

void drawStructs(Struct64s *arg0, Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  Struct65s *phi_s0;
  f32 sp38[3];
  ...
  if (arg0 != NULL && arg0->unk4) {
    ...
    for (phi_s0 = arg0->unk0; phi_s0 < arg0->unk0 + arg0->unk4; phi_s0++) {
      if (phi_s0->unk23 & 1) {
        drawSpriteWithEffects(phi_s0, gfx, mtx, vtx);
      }
    }
  }
}

void addStruct(Struct64s *arg0, f32 arg1[3], s16 arg2, f32 arg3,
                   ActorMarker *arg4, s32 (*arg5)(f32[3], f32, ActorMarker *)) {
  Struct65s *var_v0;

  if (arg0 != NULL) {
    if ((arg0->unk4 != 0x20) && (D_80380A58 >= 0x19000)) {
      if (arg0->unk0 != NULL) {
        var_v0 = (Struct65s *)bk_realloc(arg0->unk0,
                                      (arg0->unk4 + 1) * sizeof(Struct65s));
      } else {
        var_v0 = heap_malloc(sizeof(Struct65s));
      }
      if (var_v0 != NULL) {
        arg0->unk0 = var_v0;
        var_v0 += arg0->unk4;
        ...
        var_v0->unk27 = 0x14;
        var_v0->unk25 = (u8)(ml_smoothstep_range(1.0f, 50.0f, arg3) * 64.0f);
        var_v0->unkC = arg4;
        var_v0->unk10 = arg5;
      }
    }
...
void addStructWithParams(Struct64s *arg0, f32 arg1[3], f32 arg2, ActorMarker *arg3,
                   s32 (*arg4)(f32[3], f32, ActorMarker *)) {
  addStruct(arg0, arg1, 8, arg2, arg3, arg4);
}
...
s32 returnInput(s32 arg0) { return arg0; }
