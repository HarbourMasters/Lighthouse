...
int isRandfInRange(f32 min, f32 max) {
  f32 val = randf();
  return (min <= val) && (val < max);
}

f32 randf2(f32 min, f32 max) { return min + randf() * (max - min); }

f32 sfx_randf2(f32 min, f32 max) { return min + sfx_rand() * (max - min); }

s32 randi2(s32 min, s32 max) { return min + randf() * (max - min); }

s32 sfx_randi2(s32 min, s32 max) { return min + sfx_rand() * (max - min); }
