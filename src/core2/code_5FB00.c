...
void updateVertexPositions(BKModelUnk28List *arg0, BKVertexList *arg1, s32 arg2,
                   f32 arg3[3]) {
  Vtx *i_vtx;
  Vtx *vtx_list;
  s32 i;
...
void applyAnimationToVertices(BKModelUnk28List *arg0, BKVertexList *arg1,
                   AnimMtxList *mtx_list) {
  Vtx *vtx;
  Vtx *i_vtx;
  s32 i;
  BKModelUnk28 *i_ptr;
