...
/* .data */
ActorInfo D_80372840 = {0x29,
                        ACTOR_1CC_GRILL_CHOMPA,
                        ASSET_430_MODEL_GRILL_CHOMPA,
                        0,
                        NULL,
                        func_80356CCC,
                        NULL,
...
void func_803569F0(Actor *this, s32 next_state) {
  ...
  if (next_state == 4) {
    ...
    skeletalAnim_set(this->unk148, ASSET_15A_ANIM_GRILL_CHOMPA_ATTACK, 0,
                     randf2(2.3f, 2.7f));
  ...
  if (next_state == 5) {
    ...
    skeletalAnim_set(this->unk148, ASSET_15B_ANIM_GRILL_CHOMPA_DIE, 0.05f,
                     2.0f);
    skeletalAnim_setBehavior(this->unk148, SKELETAL_ANIM_2_ONCE);
  }
...
void func_80356CCC(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    this->unk16C_0 = 1;
    marker_setCollisionScripts(this->marker, NULL, func_80356BF4,
                               func_80356C24);
