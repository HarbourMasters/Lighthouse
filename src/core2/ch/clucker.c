...
/* .data */
extern ActorInfo D_80372870 = {MARKER_1B2_CLUCKER_A,
                               ACTOR_29F_CLUCKER,
...
void func_80357264(Actor *this, s32 next_state) {
  ...
  if (next_state == 1 || next_state == 2) {
    skeletalAnim_set(this->unk148, ASSET_184_ANIM_CLUCKER_ATTACK_SHORT, 0.0f,
                     2.5f);
  ...
  if (next_state == 4) {
    ...
    if (local->unk0 < 2)
      ...
      skeletalAnim_set(this->unk148, ASSET_185_ANIM_CLUCKER_ATTACK_LONG, 0.0f,
                       randf2(2.3f, 2.7f));
  ...
  if (next_state == 5) {
    if (!levelSpecificFlags_get(LEVEL_FLAG_14_TTC_UNKNOWN) &&
        !(actorArray_findClosestActorFromActorId(this->position, 0x318, -1,
                                                 &sp38) &&
          (sp38 < 250.0f))) {
...
Actor *func_803575B8(ActorMarker *marker, Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  func_8033A45C(
      4, (this->state == 0 || this->state == 1 || this->state == 6) ? 0 : 1);
...
void func_8035765C(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    this->unk16C_0 = TRUE;
    if (this->state != 6) {
      marker_setCollisionScripts(this->marker, NULL, func_80357564,
                                 func_8035758C);
      local->unk0 = 0xff;
  ...
  if (this->state == 4) {
    ...
    if (skeletalAnim_getAnimId(this->unk148) == 0x185) {
      ...
      if ((sp4C < 0.11 && 0.11 <= sp48) || (sp4C < 0.32 && 0.32 <= sp48) ||
          (sp4C < 0.53 && 0.53 <= sp48)) {
