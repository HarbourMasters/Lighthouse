...
/* .data */
ActorAnimationInfo D_80372F80[] = {{0, 0.0f},
...
ActorInfo D_80372FC0 = {MARKER_96_GRAVESTONE,
                        ACTOR_C7_GRAVESTONE,
...
ActorInfo D_80372FE4 = {MARKER_297_GIANT_GRAVESTONE,
...
Actor *func_8035ECA0(ActorMarker *marker, Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  modelRender_draw(gfx, mtx, this->position, rotation, this->scale, D_80373008,
                   func_803257B4(marker));
  return this;
}
...
void func_8035EDB0(f32 position[3], s32 count, enum asset_e sprite) {
  ...
  static ParticleScaleAndLifetimeRanges D_80373020 = {
      {0.4f, 0.8f}, {1.4f, 2.0f}, {0.0f, 0.01f}, {1.2f, 1.8f}, 0.0f, 0.01};
...
void func_8035EF3C(Actor *this) {
  if (actor_animationIsAt(this, 0.2f) || actor_animationIsAt(this, 0.7f)) {
    FUNC_8030E8B4(SFX_123_BANJO_LANDING_10, 0.5f, 24000, this->position, 1750,
                  3500);
  }
}
...
void func_8035EF9C(ActorMarker *marker, ActorMarker *other_marker) {
  ...
  FUNC_8030E8B4(SFX_115_BUZZBOMB_DEATH, 0.6f, 32000, this->position, 1750,
                3500);
  FUNC_8030E8B4(SFX_1D_HITTING_AN_ENEMY_1, 0.9f, 22000, this->position, 1750,
                3500);
  func_8035EE48(this);
}
...
void func_8035F048(ActorMarker *marker, ActorMarker *other_marker) {
  ...
  FUNC_8030E8B4(SFX_F9_GRUNTLING_NOISE_1, 1.2f, 22000, this->position, 1750,
                3500);
  FUNC_8030E8B4(SFX_1D_HITTING_AN_ENEMY_1, 0.9f, 22000, this->position, 1750,
                3500);
  this->velocity[2] = 0.0f;
...
void func_8035F138(Actor *this) {
  ...
  case 1: // L8035F20C
    if (!this->volatile_initialized) {
      ...
      marker_setCollisionScripts(this->marker, func_8035F0E8, func_8035F048,
                                 func_8035EF9C);
      local->unk0 = 1;
    ...
    if (func_80329530(this, (s32)(this->scale * 650.0f)) &&
        func_803292E0(this)) {
  ...
  case 2: // L8035F2F4
    ...
    if (actor_animationIsAt(this, 0.66f)) {
      FUNC_8030E8B4(SFX_F9_GRUNTLING_NOISE_1, 0.8f, 32000, this->position, 1750,
                    3500);
    }
  ...
  case 3: // L8035F3AC
    func_8035EF3C(this);
    if (!func_80329530(this, (s32)(this->scale * 1050.0f)) ||
        !func_803292E0(this)) {
      func_8035EEC0(this);
      break;
    }
    ...
    if (((this->actor_specific_1_f + 0.28) <= 18.0) &&
        (0.36 <= anctrl_getDuration(this->anctrl) - 0.0056000000000000008)) {
      this->actor_specific_1_f += 0.28;
      anctrl_setDuration(this->anctrl, anctrl_getDuration(this->anctrl) -
                                           0.0056000000000000008);
    }
    break;

  case 4: // L8035F4FC
    func_8035EF3C(this);
    if (((f64)this->unk38_31 <= 0.0) &&
        func_80329530(this, (s32)(this->scale * 1050.0f)) &&
        func_803292E0(this)) {
      func_8035EE80(this);
      break;
    }
    ...
    this->yaw_ideal = (f32)(s32)ml_angle_between_points_2D(
        this->position[0], this->position[2], this->unk1C[0], this->unk1C[2]);
  ...
  case 7: // L8035F840
    if (actor_animationIsAt(this, 0.3f)) {
      FUNC_8030E8B4(SFX_1E_HITTING_AN_ENEMY_2, 0.6f, 32000, this->position,
                    1750, 3500);
      FUNC_8030E8B4(SFX_1D_HITTING_AN_ENEMY_1, 0.9f, 26000, this->position,
                    1750, 3500);
    }

    if (actor_animationIsAt(this, 0.5f) || actor_animationIsAt(this, 0.7f)) {
      FUNC_8030E8B4(SFX_1F_HITTING_AN_ENEMY_3, 0.8f, 16000, this->position,
                    1750, 3500);
    }

    if (actor_animationIsAt(this, 0.8f)) {
      FUNC_8030E8B4(SFX_1F_HITTING_AN_ENEMY_3, 0.8f, 14000, this->position,
                    1750, 3500);
    }

    if (actor_animationIsAt(this, 0.9f)) {
      FUNC_8030E8B4(SFX_1F_HITTING_AN_ENEMY_3, 0.8f, 12000, this->position,
                    1750, 3500);
    }
