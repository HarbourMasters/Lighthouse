...
Actor *chBadShad_draw(ActorMarker *marker, Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  sp40 = ml_map_f(this->actor_specific_1_f, 0.0f, 800.0f, 0.53f, 0.18f) *
         this->unk1C[1];
  modelRender_setDepthMode(MODEL_RENDER_DEPTH_COMPARE);
  modelRender_draw(gfx, mtx, this->position, sp44, sp40, NULL,
...
void func_802D7124(Actor *actor, f32 arg1) {
  ...
  if ((actor->position[0] - vp[0]) * (actor->position[0] - vp[0]) +
          (actor->position[2] - vp[2]) * (actor->position[2] - vp[2]) <
      12250000.0f) {
...
void func_802D729C(Actor *actor, f32 arg1) {
  ...
  if (!actor->unk104) {
    spawnQueue_add_2((GenFunction_2)func_802D71A0, (s32)actor->marker,
