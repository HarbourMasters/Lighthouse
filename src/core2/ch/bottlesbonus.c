...
extern void comusic_playTrackWithDefaultVolume(enum comusic_e arg0, s32 arg1);
extern void chBottlesBonusCursor_func_802DF99C(void);
extern f32 *chBottlesBonusCursor_func_802E05AC(s32);
extern f32 game_getTime(void);
...
#define CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT                                    \
  (CH_BOTTLES_BONUS_PUZZLE_HEIGHT * CH_BOTTLES_BONUS_PUZZLE_WIDTH)
...
Actor *chBottlesBonus_draw(ActorMarker *marker, Gfx **gfx, Mtx **mtx,
                           Vtx **vtx);
void chBottlesBonus_update(Actor *this);

/* .data */
Struct_core2_560F0_0 D_803681A0[] = {
    {0, 0x000, 0, 0x211},  {99, 0xE27, 0, 0x2C1}, {99, 0xE29, 0, 0x2C2},
    {99, 0xE2B, 0, 0x2C9}, {99, 0xE2D, 0, 0x2C3}, {99, 0xE2F, 0, 0x2C4},
    {99, 0xE31, 0, 0x2C5}, {75, 0xE34, 0, 0x007}};

ActorAnimationInfo chBottlesBonusAnimations[] = {
    {0x000, 0.0f},          {0x211, 9000000000.0f}, {0x211, 2.0f},
    {0x211, 9000000000.0f}, {0x211, 9000000000.0f}, {0x211, 9000000000.0f},
};

f32 D_80368250 = 0.999388993f;

s32 D_80368254[CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT] = {
    0x3C, 0x3D, 0x3F, 0x40, 0x42, 0x41, 0x43, 0x3A, 0x32, 0x30,
    0x2E, 0x3E, 0x2A, 0x33, 0x2F, 0x31, 0x2D, 0x34, 0x3B, 0x39};

s32 D_803682A4[4] = {0xD8, 0xD8, 0xD8, 0xFF};
s32 D_803682B4[4] = {0xFF, 0x60, 0x50, 0xFF};
f32 D_803682C4[3] = {0.0f, 0.0f, 0.0f};

ActorInfo chBottlesBonusDescription = {0x179,
                                       0x1E0,
                                       0x46C,
                                       0x1,
                                       chBottlesBonusAnimations,
                                       chBottlesBonus_update,
...
Actor *chBottlesBonus_draw(ActorMarker *marker, Gfx **gfx, Mtx **mtx,
  ...
  if ((sp50 == NULL) || (game_getMode() != GAME_MODE_8_BOTTLES_BONUS))
    return sp6C;
  ...
  modelRender_draw(gfx, mtx, sp60, NULL, 1.0f, sp54,
                   chBottleBonusBookselfModelBin);
  ...
  gDPSetTextureFilter((*gfx)++, G_TF_POINT);
  __gSPSegment((*gfx)++, 0x04, osVirtualToPhysical(sp50));
  modelRender_preDraw((GenFunction_1)actor_predrawMethod, (s32)sp6C);
  modelRender_postDraw((GenFunction_1)actor_postdrawMethod, (s32)marker);

  modelRender_draw(gfx, mtx, sp60, NULL, D_80368250, sp54,
...
void chBottlesBonus_func_802DD484(f32 dst[3], f32 arg1, f32 avg, f32 range) {
  ...
  for (i = 0; i < 3; i++) {
    dst[i] =
        avg +
        range * (0.5 + 0.5 * sinf((2.0 * BAD_PI) *
                                  ml_fractional_part(
                                      (arg1 + 2.0 * ((f32)i / 3.0)), 2.0f)));
  }
}
...
f32 *chBottlesBonus_func_802DD584(s32 arg0) {
  ...
  temp_v1 = (BKAnimation *)(model_getAnimationList(
                                marker_loadModelBin(chBottlesBonusMarker)) +
                            1);
...
void chBottlesBonus_func_802DD6E0(BoneTransformList *arg0, s32 arg1,
                                  f32 arg2[3]) {
  f32 sp1C[3];
...
void chBottlesBonus_func_802DD778(BoneTransformList *arg0, s32 arg1,
                                  f32 arg2[3]) {
  f32 sp1C[3];
...
void chBottlesBonus_func_802DD8AC(BoneTransformList *arg0, s32 arg1) {
  ...
  if (D_8037DEB0 == 0) {
    ...
    for (i = 0; i < CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT; i++) {
      ...
      chBottlesBonusCursor_func_802DF460(
          i + CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT, chBottlesBonusMarker,
          D_8037DEC4[i].unk0);
    }
  }
  ...
  if ((actor->state == 4 || actor->state == 5)) {
    if (D_8037DEB4 == 0) {
      ...
      for (i = 0; i < CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT; i++) {
        ...
        boneTransformList_getBoneScale(arg0, D_80368254[i],
                                       D_8037DEB8[i].unk1C);
        ...
        chBottlesBonusCursor_func_802DF460(i, chBottlesBonusMarker,
                                           D_8037DEB8[i].unk0);
      }
    }
    ...
    for (i = 0; i < CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT; i++) {
      ...
      case 1: // L802DDBB4
        ...
        ml_vec3f_interpolate(D_8037DEBC[i].unk0, D_8037DEB8[i].unk0,
                             chBottlesBonus_func_802DD60C(i),
                             chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.2));
        ml_vec3f_interpolate(D_8037DEBC[i].unk1C, D_8037DEB8[i].unk1C,
                             D_8037DEC4[i].unk1C,
                             chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.2));
        func_80345D30(spAC, chBottlesBonusCursor_func_802E068C(i),
                      D_8037DEB8[i].unkC);
        func_803458E4(spBC, D_8037DEB8[i].unkC, spAC,
                      chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.4));

        func_80345D30(spAC, chBottlesBonusCursor_func_802E0664(i),
                      D_8037DEB8[i].unkC);
        func_803458E4(D_8037DEBC[i].unkC, spBC, spAC,
                      chBottlesBonus_func_802DD804(D_8037DF18[i] / 0.2));
      ...
      case 2: // L802DDD9C
        chBottlesBonus_func_802DD484(spD8, spD4, 1.0f, 0.2);
        ml_vec3f_interpolate(
            D_8037DEBC[i].unk0,
            D_8037DEC4[chBottlesBonusCursor_func_802E0588(i)].unk0,
            chBottlesBonus_func_802DD60C(i),
            chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.2));
        func_80345D30(sp9C, chBottlesBonusCursor_func_802E068C(i),
                      D_8037DEB8[i].unkC);
        func_80345D30(sp8C, chBottlesBonusCursor_func_802E0664(i),
                      D_8037DEB8[i].unkC);
        func_803458E4(D_8037DEBC[i].unkC, sp9C, sp8C,
                      chBottlesBonus_func_802DD804(D_8037DF18[i] / 0.2));
        D_8037DEC0[i].unk0[0] = D_8037DEBC[i].unk0[0];
        D_8037DEC0[i].unk0[1] = D_8037DEBC[i].unk0[1];
        D_8037DEC0[i].unk0[2] = D_8037DEBC[i].unk0[2];
      ...
      case 3: // L802DDF48
        chBottlesBonusCursor_func_802DF460(
            ...
            D_8037DEC4[chBottlesBonusCursor_func_802E0588(i)].unk0);
        ml_vec3f_interpolate(
            D_8037DEBC[i].unk0, D_8037DEC0[i].unk0,
            D_8037DEC4[chBottlesBonusCursor_func_802E0588(i)].unk0,
            chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.4));
        ml_vec3f_interpolate(
            D_8037DEBC[i].unk1C, D_8037DEC0[i].unk1C,
            D_8037DEC4[chBottlesBonusCursor_func_802E0588(i)].unk1C,
            chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.4));
        func_80345D30(sp7C, chBottlesBonusCursor_func_802E0664(i),
                      D_8037DEB8[i].unkC);
        func_803458E4(D_8037DEBC[i].unkC, D_8037DEC0[i].unkC, sp7C,
                      chBottlesBonus_func_802DD804(D_8037DF18[i] / 0.2));
        break;

      case 0: // L802DE084
        ml_vec3f_interpolate(D_8037DEBC[i].unk0, D_8037DEC0[i].unk0,
                             D_8037DEB8[i].unk0,
                             chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.4));
        ml_vec3f_interpolate(D_8037DEBC[i].unk1C, D_8037DEC0[i].unk1C,
                             D_8037DEB8[i].unk1C,
                             chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.4));
        func_803458E4(D_8037DEBC[i].unkC, D_8037DEC0[i].unkC,
                      D_8037DEB8[i].unkC,
                      chBottlesBonus_func_802DD804(D_8037DEC8[i] / 0.4));
        break;
      }
...
void chBottlesBonus_func_802DE224(ActorMarker *caller, enum asset_e text_id,
                                  s32 arg2) {
  func_8034BB08(0);
}
...
void chBottlesBonus_lose(u8 *arg0, enum asset_e text_id) {
  ...
  comusic_playTrackWithDefaultVolume(COMUSIC_3C_MINIGAME_LOSS, 28000);
  actor->state = 5;
  ...
  if (*arg0 == 0) {
    *arg0 = 1;
    ...
    func_80311714(0);
    gcdialog_showText(text_id, 0x86, actor->position, chBottlesBonusMarker,
                      chBottlesBonus_func_802DE224, NULL);
    func_80311714(1);
  } else {
...
void chBottlesBonus_IncrementPuzzle(ActorMarker *caller, enum asset_e text_id,
                                    s32 arg2) {
...
void chBottlesBonus_completedPuzzle(void) {
  ...
  func_80311714(0);
  gcdialog_showText(D_803681A0[chBottleBonusPuzzleIndex + 1].text_id, 0x86,
                    actor->position, chBottlesBonusMarker,
                    chBottlesBonus_IncrementPuzzle, NULL);
  func_80311714(1);
}

s32 chBottlesBonus_getPuzzleIndex(void) { return chBottleBonusPuzzleIndex; }
...
void chBottlesBonus_startTimer(ActorMarker *arg0, enum asset_e arg1, s32 arg2) {
  ...
  timedFunc_set_2(0.25f, (GenFunction_2)item_set, ITEM_0_HOURGLASS_TIMER,
                  D_803681A0[chBottleBonusPuzzleIndex + 1].time_seconds * 60 -
                      1);
}
...
void chBottlesBonus_update(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    if (D_8037DEAC == NULL) {
      D_8037DEAC =
          func_8033F5F8(func_8033A0B0(chBottleBonusBookselfModelBin),
                        model_getVtxList(chBottleBonusBookselfModelBin));
      func_8034CF74(local, 0, D_8037DEAC, 0xF0);
    }
    anctrl_setCallback(this->anctrl, (GenFunction_2)chBottlesBonus_func_802DD8AC);
    for (phi_s0 = 0; phi_s0 < CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT; phi_s0++) {
      func_8034DFB0(&func_8034C2C4(this->marker, phi_s0 + 0x190)->type_6D,
                    D_803682B4, D_803682A4, 0.0f);
    }
    D_8037DEB8 = (Struct_core2_560F0_1 *)heap_malloc(
        CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT * sizeof(Struct_core2_560F0_1));
    D_8037DEBC = (Struct_core2_560F0_1 *)heap_malloc(
        CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT * sizeof(Struct_core2_560F0_1));
    D_8037DEC0 = (Struct_core2_560F0_1 *)heap_malloc(
        CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT * sizeof(Struct_core2_560F0_1));
    D_8037DEC4 = (Struct_core2_560F0_1 *)heap_malloc(
        CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT * sizeof(Struct_core2_560F0_1));
  }
  func_8034CF90(local, D_8037DEAC, 0xF0);
  sp48 = chBottlesBonusCursor_func_802E06B4() - 1;
  cursor_state = chBottlesBonusCursor_getState();
  for (phi_s0_2 = 0; phi_s0_2 < CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT;
       phi_s0_2++) {
    sp40 = D_8037DF90[phi_s0_2];
    temp_v0_2 = &func_8034C2C4(this->marker, phi_s0_2 + 0x190)->type_6D;
    if ((phi_s0_2 == sp48) && (cursor_state == 1) &&
        !chBottlesBonusCursor_func_802E0538(phi_s0_2)) {
  ...
  case 1:
    if ((this->lifetime_value > 2.0) && gctransition_done()) {
      this->lifetime_value = 0.0f;
      comusic_playTrackWithVolumeOverride(COMUSIC_98_BBONUS_PIECES_SHUFFLE, -1);
      comusic_fadeTrackWithArgsNoDelay(COMUSIC_95_BBONUS_A, 0, 2000);
  ...
  case 2:
    if (anctrl_isStopped(this->anctrl)) {
      this->state = 3;
      comusic_stopTrack(COMUSIC_98_BBONUS_PIECES_SHUFFLE);
      if (D_8037DCC7 == 0) {
        func_80311714(0);
        gcdialog_showText(ASSET_E24_DIALOG_UNKNOWN, 0x87, this->position,
                          chBottlesBonusMarker, chBottlesBonus_startTimer,
                          NULL);
        func_80311714(1);
        D_8037DCC7 = 1;
      } else {
  ...
  case 4:
    if (this->lifetime_value > 2.0) {
      comusic_setTrackVolume(
          COMUSIC_94_BBONUS,
          ((item_getCount(ITEM_0_HOURGLASS_TIMER) * 0x201D2) /
           (s32)((D_803681A0[chBottleBonusPuzzleIndex + 1].time_seconds * 60) -
                 1)) +
              330000);
      if ((item_getCount(ITEM_6_HOURGLASS) == 0) &&
          (chBottlesBonusCursor_isPuzzleCompleted() == 0)) {
...
void chBottlesBonus_spawn(s32 arg0, s32 arg1) {
  if (chBottlesBonusMarker == NULL) {
    spawnQueue_add_0(__chBottlesBonus_spawn);
  }
}
...
void chBottlesBonus_func_802DEA74(s32 arg0) { D_8037DF18[arg0] = 0.0f; }
...
f32 *chBottlesBonus_get_piece_distance_vec4f(
    s32 arg0) { // returns distance bk_vector of puzzle piece id
  return D_8037DEBC[arg0].unkC;
}

Actor *chBottlesBonus_new(s32 position[3], s32 yaw, ActorInfo *actor_info,
                          u32 flags) {
  int i;

  for (i = 1; i < 6; i++) {
    chBottlesBonusAnimations[i].index =
        D_803681A0[chBottleBonusPuzzleIndex].anim_id;
  }
