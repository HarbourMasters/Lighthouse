...
/* .data */
ActorInfo chSnowball = {MARKER_B2_SNOWBALL,
                        ACTOR_125_SNOWBALL,
...
void __chSnowball_spawnPieces(f32 position[3]) {
  static ParticleScaleAndLifetimeRanges D_80368734 = {
      {0.65f, 1.1}, {0.0f, 0.0f}, {0.0f, 0.01f}, {0.8f, 0.8f}, 0.0f, 0.5f};
...
void __chSnowball_collisionCallback(Actor *this, bool water_collision) {
  ...
  if (water_collision) {
    ...
    emitBubbleParticles(D_8037E640);
    func_8030E878(SFX_2F_ORANGE_SPLAT, 1.0f, 10000, this->position, 1250.0f,
                  2500.0f);
    func_8030E878(SFX_F_SMALL_WATER_SPLASH, randf2(0.8f, 1.2f), 32000,
                  this->position, 1250.0f, 2500.0f);
    actor_collisionOff(this);
    func_80326310(this);
    subaddie_set_state(this, 2U);
  } else {
    func_8030E878(SFX_2F_ORANGE_SPLAT, 1.0f, 32000, this->position, 1250.0f,
                  2500.0f);
...
void __chSnowball_actorCollisionCallback(ActorMarker *marker,
...
void chSnowball_update(Actor *this) {
    ...
    case 1:
        ...
        if (local->unk4 >= 6) {
            temp_v0_3 = findCollisionTriWithOffsetAndFlags(sp64, this->position, func_8033229C(this->marker) * 1.2, sp70, 5, 0);
            if (temp_v0_3 != 0) {
