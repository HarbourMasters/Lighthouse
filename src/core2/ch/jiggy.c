...
/* .data */
ActorAnimationInfo D_80366290[] = {{0, 0.0f}, {0, 0.0f}, {0, 0.0f}};

ActorInfo D_803662A8 = {0x52,
                        ACTOR_46_JIGGY,
...
enum jiggy_e func_802C7A30(Actor *this) {
  ...
  id = findStructInArrayD4WithRadius(sp18);
  if (id < 0) {
    return 0;
  } else {
    return getStructArrayD4Index(id) + 1;
  }
}
...
void func_802C7AF8(u32 x, u32 y, u32 z, u32 arg3) {
  spawnQueue_add_4((GenFunction_4)spawnQueue_actor_s32, ACTOR_4C_STEAM, x, y,
                     z);
  spawnQueue_add_4((GenFunction_4)spawnQueue_actor_s32,
                     ACTOR_14F_DESTROYED_JIGGY, x, y, z);
  mapSpecificFlags_set(arg3, 1);
}

void func_802C7B6C(u32 arg0) { mapSpecificFlags_set(arg0, 0); }

void func_802C7B8C(Actor *this, s32 arg1, s32 arg2, s32 arg3, s32 arg4,
                   s32 arg5, enum volatile_flags_e arg6) {
  if (!mapSpecificFlags_get(arg1) && mapSpecificFlags_get(arg2) &&
    ...
    timedFunc_set_4(0.6f, (GenFunction_4)func_802C7AF8, (s32)this->position[0],
                    (s32)this->position[1], (s32)this->position[2], arg4);
    timedFunc_set_2(0.6f, (GenFunction_2)func_802C7AB0, (s32)this->marker,
                    arg5);
...
Actor *chjiggy_draw(ActorMarker *this, Gfx **gdl, Mtx **mptr, Vtx **arg3) {
  ...
  if (!local->unk0) {
    ...
    if ((jiggyId == JIGGY_1C_CC_RINGS) ||
        (jiggyId == JIGGY_1D_CC_SLOW_SAWBLADES)) {
      func_8033A280(10.0f);
