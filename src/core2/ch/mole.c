...
void chmole_additionalAbilityLearnActions(ActorMarker *marker,
                                          enum asset_e arg1, s32 arg2);
...
ChMoleDescription moleTable[] = {
    {ASSET_C23_DIALOG_BEAKBOMB_LEARN, ASSET_C24_DIALOG_BEAKBOMB_REFRESHER, 0x0F,
     ABILITY_1_BEAK_BOMB},
    {ASSET_B47_DIALOG_EGGS_LEARN, ASSET_B4B_DIALOG_EGGS_REFRESHER, 0x16,
     ABILITY_6_EGGS},
    {ASSET_B48_DIALOG_BEAKBUSTER_LEARN, ASSET_B4C_DIALOG_BEAKBUSTER_REFRESHER,
     0x17, ABILITY_2_BEAK_BUSTER},
    {ASSET_B49_DIALOG_TALON_TROT_LEARN, ASSET_B4A_DIALOG_TALON_TROT_REFRESHER,
     0x18, ABILITY_10_TALON_TROT},
    {ASSET_A1F_DIALOG_SHOCKJUMP_LEARN, ASSET_A23_DIALOG_SHOCKJUMP_REFRESHER,
     0x0C, ABILITY_D_SHOCK_JUMP},
    {ASSET_A20_DIALOG_FLY_LEARN, ASSET_A22_DIALOG_FLY_REFRESHER, 0x0D,
     ABILITY_9_FLIGHT},
    {ASSET_D35_DIALOG_WONDERWING_LEARN, ASSET_D36_DIALOG_WONDERWING_REFRESHER,
     0x01, ABILITY_12_WONDERWING},
    {ASSET_C88_DIALOG_LONGLEG_LEARN, ASSET_C89_DIALOG_LONGLEG_REFRESHER, 0x10,
     ABILITY_E_WADING_BOOTS},
    {ASSET_A84_DIALOG_TURBOTRAINERS_LEARN,
     ASSET_A85_DIALOG_TURBOTRAINERS_REFRESHER, 0x19, ABILITY_11_TURBO_TALON},
    {ASSET_F64_DIALOG_NOTEDOORS_LEARN, ASSET_F65_DIALOG_NOTEDOORS_REFRESHER,
     0x0E, ABILITY_13_1ST_NOTEDOOR}};
...
enum asset_e chmole_learnedAllLevelAbilitiesDialog(void) {
  // If the player has learned all game abilities, use "learned all abilities"
  // dialog If the player learned all level abilities, use "learned world
  // abilities" dialog
  ...
  case LEVEL_2_TREASURE_TROVE_COVE:
    return learned_all_moves ? ASSET_A27_DIALOG_BOTTLES_ALL_TTC_MOVES_LEARNED
                             : ASSET_D38_DIALOG_BOTTLES_ALL_MOVES_LEARNED;
  case LEVEL_3_CLANKERS_CAVERN:
    return learned_all_moves ? ASSET_D37_DIALOG_BOTTLES_ALL_CC_MOVES_LEARNED
                             : ASSET_D38_DIALOG_BOTTLES_ALL_MOVES_LEARNED;
  case LEVEL_4_BUBBLEGLOOP_SWAMP:
    return learned_all_moves ? ASSET_C8A_DIALOG_BOTTLES_ALL_BGS_MOVES_LEARNED
                             : ASSET_D38_DIALOG_BOTTLES_ALL_MOVES_LEARNED;
  case LEVEL_5_FREEZEEZY_PEAK:
    return learned_all_moves ? ASSET_C2A_DIALOG_BOTTLES_ALL_FP_GV_MOVES_LEARNED
                             : ASSET_D38_DIALOG_BOTTLES_ALL_MOVES_LEARNED;
  case LEVEL_7_GOBIS_VALLEY:
    return learned_all_moves ? ASSET_C2A_DIALOG_BOTTLES_ALL_FP_GV_MOVES_LEARNED
                             : ASSET_D38_DIALOG_BOTTLES_ALL_MOVES_LEARNED;
...
void chmole_healthRefill(ActorMarker *marker, enum asset_e arg1, s32 arg2) {
  ...
  if (arg1 == moleTable[actor->unkF4_8 - 9].teach_text_id &&
    ...
    gcdialog_showText(ASSET_D39_DIALOG_BOTTLES_REFILL_HEALTH, 7, 0,
                      actor->marker, chmole_healthRefill,
                      chmole_additionalAbilityLearnActions);
  } // L802D9738
  else if (arg1 == moleTable[actor->unkF4_8 - 9].teach_text_id ||
           arg1 == ASSET_D39_DIALOG_BOTTLES_REFILL_HEALTH) {
    gcdialog_showText(chmole_learnedAllGameAbilities()
                          ? 0xa87
                          : chmole_learnedAllLevelAbilitiesDialog(),
                      7, 0, actor->marker, chmole_healthRefill, NULL);
  } else { // L802D97BC
...
int chmole_learnAbility(Actor *this) {
  ...
  gcdialog_showText(sp2C, sp28, this->position, this->marker,
                    chmole_healthRefill, chmole_additionalAbilityLearnActions);
  return TRUE;
}
...
void chmole_update(Actor *this) {
  ...
  // Anything lower is a Spiral Mountain ability, and should use a different
  // actor id
  ...
  if (!this->volatile_initialized) {
    ...
    if (this->initialized) {
      other = actorArray_findClosestActorFromActorId(
          this->position, ACTOR_12C_MOLEHILL, -1, &sp4C);
  ...
  if (!this->initialized) {
    // Checks if player is within radius of a specific actor exists within the
    // same cube If actor exists and player is within radius, force trigger
    // conversation
    ...
    // Spawns molehill
    spawnQueue_add_1((GenFunction_1)chmole_spawnMolehill,
  ...
  case 1: // L802D9F70
    ...
    if (func_8028F20C() && func_8028F0D4() && !isPlayerInWater()) {
      if (this->unkF4_8 == 0x12 &&
        ...
        if (ml_vec3f_distance(sp34, this->velocity) <
            this->actor_specific_1_f) {
          chmole_startingDialog(this);
        }
      } else { // L802DA054
        if (!player_movementGroup() && func_80329530(this, 0xFA) &&
            func_8028EFC8() && sp50[FACE_BUTTON(BUTTON_B)] == 1) {
          chmole_startingDialog(this);
        }
      }
    }
  ...
  case 2: // L802DA0A0
    ...
    if (actor_animationIsAt(this, 0.9999f)) {
      ...
      FUNC_8030E8B4(SFX_C6_SHAKING_MOUTH, 1.2f, 24000, this->position, 1250,
                    2500);
    } else if (actor_animationIsAt(this, 0.4f)) { // L802DA188
      FUNC_8030E8B4(SFX_2C_PULLING_NOISE, 1.2f, 24000, this->position, 1250,
                    2500);
    } else if (actor_animationIsAt(this, 0.75f)) { // L802DA1BC
      FUNC_8030E8B4(SFX_C5_TWINKLY_POP, 1.0f, 32000, this->position, 1250,
                    2500);
  ...
  case 3: // L802DA210
    this->yaw_ideal = func_80329784(this);
    func_80328FB0(this, 4.0f);
    if ((actor_animationIsAt(this, 0.37f) || actor_animationIsAt(this, 0.66f) ||
         actor_animationIsAt(this, 0.85f)) &&
        randf() < 0.2) {
      anctrl_setDirection(this->anctrl,
                          1 ^ anctrl_isPlayedForwards(this->anctrl));
    } else if (actor_animationIsAt(this, 0.25f) ||
               actor_animationIsAt(this, 0.28f) ||
               actor_animationIsAt(this, 0.31f)) { // L802DA2B4
      func_8030E878(SFX_6F_BANJO_HEADSCRATCH, randf2(1.4f, 1.55f), 16000,
                    this->position, 1250.0f, 2500.0f);
               ...
               actor_animationIsAt(this, 0.76f)) { // L802DA33C
      func_8030E878(SFX_6F_BANJO_HEADSCRATCH, randf2(1.35f, 1.5f), 6000,
                    this->position, 1250.0f, 2500.0f);
    }
    break;
  case 4: // L802DA400
