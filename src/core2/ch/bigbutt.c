...
void func_802C5FF8(Actor *this) {
  if (!this->unk138_28 && actor_animationIsAt(this, 0.4f) && randf() < 0.14 &&
      player_getWaterState() != BSWATERGROUP_2_UNDERWATER) {
    func_8030E878(SFX_2B_BULL_MOO_1, randf2(0.9f, 1.1f), 32000, this->position,
                  0.0f, 2000.0f);
  }
}
...
void func_802C60AC(ActorMarker *marker, ActorMarker *other_marker) {
  ...
  if (actor->state == 4 && 5.0 <= actor->actor_specific_1_f &&
...
void func_802C6150(ActorMarker *marker, ActorMarker *other_marker) {
  ...
  func_8030E878(SFX_2B_BULL_MOO_1, randf2(1.28f, 1.37f), 32000, actor->position,
                0.0f, 2000.0f);
}

void func_802C61C0(ActorMarker *marker, ActorMarker *other_marker) {
  Actor *actor = marker_getActor(marker);
  if (actor->state != 0xd && actor->state != 0xe && actor->state != 0xf) {
...
void func_802C6240(Actor *this) {
    ...
    if (!this->unk138_28) {
      if (actor_animationIsAt(this, 0.157f) ||
        ...
        if (player_getWaterState() != BSWATERGROUP_2_UNDERWATER) {
          func_8030E878(SFX_C8_CRUNCH, randf2(0.93f, 1.07f), 10000,
                        this->position, 0.0f, 1800.0f);
        }
      }
    } // L802C63C4
    if (sp2C == 2) {
  ...
  case 0x3: // L802C6620
    ...
    if (!(globalTimer_getTime() & 0xf) &&
        subaddie_maybe_set_state(this, 2, 0.08f))
      func_802C5E80(this);
    func_802C5EB8(this);
    break;

  case 0x6: // L802C66D0
    anctrl_setDuration(this->anctrl,
                       D_80366010[6].duration - (3 - this->unk10_12) * 0.1085);
    ...
    if (this->unk10_12 == 0 ||
        (this->unk10_12 < 3 && func_80329530(this, 300))) {
  ...
  case 0x5: // L802C6B28
    ...
    anctrl_setDuration(this->anctrl,
                       D_80366010[5].duration +
                           ((0.65 < tmp_f0) ? (tmp_f0 - 0.65) * 16.0 : 0.0));
  ...
  if (marker->unk14_21) {
    ...
    case 1: // L802C6FB4
      if (actor_animationIsAt(actor, 0.85f) &&
          (globalTimer_getTime() & 0xe) == 8 && randf() < 0.6) {
