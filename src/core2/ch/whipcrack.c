...
/* .data */
ActorInfo D_80373100 = {MARKER_1C5_WHIPCRACK,
                        ACTOR_30F_WHIPCRACK,
...
void __chwhipcrack_spawnPieces(Actor *this, enum asset_e model_id, s32 cnt) {
  ...
  particleEmitter_setSfxPitchRange(pCtrl, 0.5f, 1.0f);
  particleEmitter_setSfx(pCtrl, SFX_1F_HITTING_AN_ENEMY_3, 10000);
  particleEmitter_setModel(pCtrl, model_id);
  particleEmitter_setSpawnPositionRange(pCtrl, -120.0f, 50.0f, -120.0f, 120.0f,
                                        300.0f, 120.0f);
  particleEmitter_setPosition(pCtrl, this->position);
  particleEmitter_setStartingScaleRange(pCtrl, 0.5f, 1.0f);
  particleEmitter_setAngularVelocityRange(pCtrl, -500.0f, -500.0f, -500.0f,
                                          500.0f, 500.0f, 500.0f);
  particleEmitter_setSpawnIntervalRange(pCtrl, 0.0f, 0.01f);
  particleEmitter_setParticleLifeTimeRange(pCtrl, 4.0f, 4.0f);
  particleEmitter_setParticleVelocityRange(pCtrl, -300.0f, 250.0f, -300.0f,
...
void __chwhipcrack_spawnSmoke(Actor *this, s32 cnt) {
  ...
  particleEmitter_setSpawnPositionRange(pCtrl, -50.0f, 50.0f, -50.0f, 50.0f,
                                        200.0f, 50.0f);
  particleEmitter_setParticleVelocityRange(pCtrl, -30.0f, 150.0f, -30.0f, 30.0f,
                                           300.0f, 30.0f);
...
void chwhipcrack_update(Actor *this) {
  ...
  if (this->state == 2) {
    ...
    if ((sp44 < 0.13) && (0.13 <= sp40)) {
      func_8030E878(SFX_69_WHIPCRACK_CREAKING, randf2(1.05f, 1.1f), 15000,
                    this->position, 500.0f, 1000.0f);
    }

    if ((sp44 < 0.8) && (0.8 <= sp40)) {
      func_8030E878(SFX_2_CLAW_SWIPE, randf2(0.9f, 1.1f), randi2(28000, 32000),
                    this->position, 500.0f, 1000.0f);
    }
