...
bool chCollectible_collectItem(Actor *, enum file_progress_e, enum asset_e,
                               enum comusic_e, enum item_e, f32);
Actor *chCollectible_draw(ActorMarker *this, Gfx **gdl, Mtx **mptr, Vtx **arg3);
void chCollectible_update(Actor *this);

/* .data */
extern ActorInfo D_80367D00 = {MARKER_60_BLUE_EGG_COLLECTIBLE,
                               ACTOR_52_BLUE_EGG,
                               ASSET_36D_SPRITE_BLUE_EGG,
                               0,
                               NULL,
                               chCollectible_update,
...
extern ActorInfo D_80367D24 = {MARKER_B5_RED_FEATHER_COLLECTIBLE,
                               ACTOR_129_RED_FEATHER,
...
extern ActorInfo D_80367D48 = {MARKER_1E5_GOLD_FEATHER_COLLECTIBLE,
...
bool chCollectible_collectItem(Actor *actor, enum file_progress_e arg1,
                               enum asset_e dialogId, enum comusic_e sfxId,
                               enum item_e itemId, f32 arg5) {
  comusic_playTrackWithVolumeOverride(sfxId, 32000);
...
s32 chCollectible_collectEgg(ActorProp *arg0) {
  ...
  chCollectible_collectItem(actPtr, FILEPROG_5_BLUE_EGG_TEXT, 0xD9E,
                            COMUSIC_C_EGG_COLLECTED, 0xD, 2.0f);
}
...
void chCollectible_collectRedFeather(ActorProp *arg0) {
  ...
  if (arg0->unk8_0)
    actPtr = marker_getActor(arg0->marker);
  chCollectible_collectItem(actPtr, FILEPROG_6_RED_FEATHER_TEXT, 0xD9F,
                            COMUSIC_B_RED_FEATHER_COLLECTED, 0xF, 4.0f);
}
...
void chCollectible_collectGoldFeather(ActorProp *arg0) {
  ...
  if (arg0->unk8_0)
    actPtr = marker_getActor(arg0->marker);
  chCollectible_collectItem(actPtr, FILEPROG_7_GOLD_FEATHER_TEXT, 0xDA0,
                            COMUSIC_14_GOLD_FEATHER_COLLECTED,
                            ITEM_10_GOLD_FEATHER, 6.0f);
}

Actor *chCollectible_draw(ActorMarker *this, Gfx **gdl, Mtx **mptr,
                          Vtx **arg3) {
...
void chCollectible_update(Actor *this) {
  ...
  if (volatileFlag_getN(VOLATILE_FLAG_23_FINAL_BOSS_PHASE, 3) !=
      this->unk10_12) {
    func_802D8C98(this,
                  volatileFlag_getN(VOLATILE_FLAG_23_FINAL_BOSS_PHASE, 3));
  }
