...
ActorInfo chGloop = {MARKER_6A_GLOOP,
                     ACTOR_E6_GLOOP,
...
void chgloop_spawnBubble(s32 arg0, s32 arg1, s32 arg2, s32 arg3) {
  ...
  actor_spawnWithYaw_f32(ACTOR_E7_GLOOP_BUBBLE, sp1C,
                         (s32) reinterpret_cast(f32, arg3));
}
...
void chgloop_update(Actor *this) {
  ...
  case 2: // L802D14DC
    ...
    if (!mapSpecificFlags_get(2) && func_80329530(this, 350) &&
        gcdialog_showText(ASSET_D34_DIALOG_GLOOP_MEET, 0, NULL, NULL, NULL,
                          NULL)) {
  ...
  case 4: // L802D1558
    ...
    if (actor_animationIsAt(this, 0.6f)) {
      ...
      if (func_80329530(this, 1900)) {
        spawnQueue_add_4(chgloop_spawnBubble, reinterpret_cast(s32, sp34[0]),
                           reinterpret_cast(s32, sp34[1]),
                           reinterpret_cast(s32, sp34[2]),
                           reinterpret_cast(s32, this->yaw));
      }

      func_8030E9C4(SFX_3ED, randf() / 2 + 0.6, 32000, this->position, 100.0f,
                    3000.0f);
    }
    break;
  } // L802D1670
