...
ActorInfo D_80367390 = {
    0x1A8, ACTOR_28B_SOUND_SOURCE, 0, 0, NULL, func_802D07C8,
  ...
  if (D_80367340[(s32)this->yaw].unk8 != -1) {
    if (this->unk1C[0] == this->unk1C[1])
      sfxsource_setSampleRate(local->sfxsourceIdx,
                              D_80367340[(s32)this->yaw].unk8);
    else {
      sfxsource_setSampleRate(
          local->sfxsourceIdx,
          (s32)((D_80367340[(s32)this->yaw].unk8 / this->unk1C[1]) *
                this->unk1C[0]));
    }
  }
}
...
void func_802D05A0(Actor *this, s32 next_state) {
  ...
  if (next_state == 2) {
    ...
    sfxsource_set_fade_distances(local->sfxsourceIdx,
                                 D_80367340[(s32)this->yaw].unk4 * this->scale,
                                 D_80367340[(s32)this->yaw].unk6 * this->scale);
    func_8030DFB4(local->sfxsourceIdx, 1);
    func_802D0500(this);
    if (-1.0f != D_80367340[(s32)this->yaw].unkC)
      sfxsource_playSfxAtVolume(local->sfxsourceIdx,
                                D_80367340[(s32)this->yaw].unkC);
    func_8030E2C4(local->sfxsourceIdx);
  } // L802D0780
  this->state = next_state;
}

void func_802D07A8(Actor *this) { func_802D05A0(this, 0); }
...
void func_802D09B8(Actor *this, s32 arg1) {
  spawnQueue_add_4((GenFunction_4)func_802D096C,
                     reinterpret_cast(s32, this->position[0]),
                     reinterpret_cast(s32, this->position[1]),
                     reinterpret_cast(s32, this->position[2]), arg1);
}
