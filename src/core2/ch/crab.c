...
void __chCrab_802CB078(Actor *this) {
  ...
  if ((this->modelCacheIndex != ACTOR_F2_BLACK_SNIPPET) ||
      maCastle_hasBanjoKazooieCodeBeenEntered()) {
    ...
    if (this->unk38_31 != 0) {
      ...
      if (func_80329530(this, 1500) &&
          ((this->modelCacheIndex == ACTOR_F2_BLACK_SNIPPET) ||
           func_803292E0(this))) {
...
void __chCrab_touch(ActorMarker *marker, ActorMarker *other) {
  ...
  if ((this->state == 4) && func_803294F0(this, 80, func_80329784(this))) {
    FUNC_8030E8B4(SFX_1E_HITTING_AN_ENEMY_2, 1.0f, 28000, this->position, 950,
                  1900);
...
void __chCrab_particleEmitterSetup(ParticleEmitter *p_ctrl, f32 position[3]) {
  ...
  particleEmitter_setBounceFactor(p_ctrl, 0.7f);
  particleEmitter_setCollisionCount(p_ctrl, 5);
...
void __chCrab_emitClawPiece(ParticleEmitter *p_ctrl, f32 position[3],
                            enum asset_e model_id) {
  __chCrab_particleEmitterSetup(p_ctrl, position);
  particleEmitter_setAccelerationRange(p_ctrl, 0.0f, -1800.0f, 0.0f, 0.0f,
                                       -1800.0f, 0.0f);
  particleEmitter_setModel(p_ctrl, model_id);
  particleEmitter_setStartingScaleRange(p_ctrl, 0.5f, 0.8f);
  particleEmitter_setAngularVelocityRange(p_ctrl, -800.0f, -800.0f, -800.0f,
                                          800.0f, 800.0f, 800.0f);
  particleEmitter_setParticleVelocityRange(p_ctrl, -200.0f, 850.0f, -200.0f,
                                           400.0f, 1000.0f, 400.0f);
  particleEmitter_emitN(p_ctrl, 2);
}

void __chCrab_emitLegPiece(ParticleEmitter *p_ctrl, f32 position[3],
                           enum asset_e model_id) {
  __chCrab_particleEmitterSetup(p_ctrl, position);
  particleEmitter_setAccelerationRange(p_ctrl, 0.0f, -1800.0f, 0.0f, 0.0f,
                                       -1800.0f, 0.0f);
...
void __chCrab_emitHeadPiece(ParticleEmitter *p_ctrl, f32 position[3],
                            enum asset_e model_id) {
  __chCrab_particleEmitterSetup(p_ctrl, position);
  particleEmitter_setAccelerationRange(p_ctrl, 0.0f, -1800.0f, 0.0f, 0.0f,
                                       -1800.0f, 0.0f);
  ...
  particleEmitter_setAngularVelocityRange(p_ctrl, -600.0f, -600.0f, -600.0f,
                                          600.0f, 600.0f, 600.0f);
  particleEmitter_setParticleVelocityRange(p_ctrl, -50.0f, 750.0f, -50.0f,
                                           120.0f, 900.0f, 120.0f);
...
void __chCrab_mutantTextCallback(ActorMarker *caller, enum asset_e text_id,
                                 s32 model_id) {
...
void __chCrab_die(ActorMarker *marker, ActorMarker *other) {
  ...
  if (map_get() == MAP_B_CC_CLANKERS_CAVERN &&
      ml_vec3f_point_within_horizontal_distance(this->position, 13778.0f, 0.0f,
                                                3000.0f)) {
    this->depth_mode = MODEL_RENDER_DEPTH_COMPARE;
    if (!jiggyscore_isCollected(JIGGY_16_CC_SNIPPETS) &&
        ((actorArray_findClosestActorFromActorId(
              this->position, ACTOR_F5_MUTIE_SNIPPET, -1, &sp44) == NULL) ||
         (3000.0f < sp44))) {
      ...
      showDelayedTextAtTime(2.25f, ASSET_D33_DIALOG_MUTANT_CRAB_DEFEAT, 0xF,
                    jiggy_spawn_position, NULL, __chCrab_mutantTextCallback,
                    NULL);
    }
  }
...
void __chCrab_walkSfxUpdate(Actor *this) {
  if (actor_animationIsAt(this, 0.4f)) {
    FUNC_8030E8B4(SFX_3D_TICKER_WALKING, 0.85f, 15000, this->position, 950,
                  1900);
  }
  if (actor_animationIsAt(this, 0.9f)) {
    FUNC_8030E8B4(SFX_3D_TICKER_WALKING, 1.15f, 15000, this->position, 950,
                  1900);
  }
}
...
void chCrab_update(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    marker_setCollisionScripts(this->marker, __chCrab_touch, __chCrab_ow,
                               __chCrab_die);
  ...
  if ((map_get() == MAP_B_CC_CLANKERS_CAVERN) && !mapSpecificFlags_get(0) &&
      is_mutant_snippet && !jiggyscore_isCollected(JIGGY_16_CC_SNIPPETS) &&
      func_80329530(this, 500) && !func_80329530(this, 200) &&
      !player_movementGroup()) {
    if ((this->state != 6) && (this->state != 5)) {
      gcdialog_showText(ASSET_D32_DIALOG_MUTANT_CRAB_MEET, 0xF, this->position,
                        NULL, __chCrab_mutantTextCallback, NULL);
  ...
  if (levelSpecificFlags_get(LEVEL_FLAG_E_CC_UNKNOWN)) {
    if ((this->state != 8) && (this->state != 9)) {
      subaddie_set_state_with_direction(this, (this->has_met_before) ? 8 : 9,
                                        0.0f, 1);
      this->has_met_before = FALSE;
    }
  }
  ...
  case 2: // L802CBE9C
    ...
    if (func_8032CA80(this, (this->modelCacheIndex == ACTOR_F2_BLACK_SNIPPET)
                                ? 0xD
                                : 0) &&
        func_80329480(this)) {
...
/* .data */
ActorInfo D_803670B8 = {MARKER_13_SNIPPET,
                        ACTOR_67_SNIPPET,
                        ASSET_358_SNIPPET,
                        0x1,
                        chCrabAnimations,
                        ...
                        0.8f,
                        0};
ActorInfo D_803670DC = {MARKER_DD_BLACK_SNIPPET,
                        ...
                        0.8f,
                        0};
ActorInfo D_80367100 = {MARKER_13_SNIPPET,
                        ACTOR_F5_MUTIE_SNIPPET,
                        ASSET_38F_MODEL_MUTIE_SNIPPET,
                        0x1,
                        chCrabMutantAnimations,
                        chCrab_update,
                        actor_update_func_80326224,
                        actor_draw,
                        1900,
