...
Actor *chOverlayPressStart_draw(ActorMarker *marker, Gfx **gfx, Mtx **mtx,
                                Vtx **vtx);
void chOverlayPressStart_update(Actor *this);

/* .data */
ActorAnimationInfo D_80368100[] = {{0, 0.0f}, {0x284, 1.6f}, {0x285, 1.6f}};

f32 D_80368118[3] = {0.0f, 0.0f, 0.0f};

ActorInfo D_80368124 = {MARKER_177_PRESS_START_OVERLAY,
...
/* .code */
Actor *chOverlayPressStart_draw(ActorMarker *marker, Gfx **gdl, Mtx **mptr,
                                Vtx **vptr) {
  Actor *actor;
  f32 sp58[3];
  f32 sp4C[3];
...
void __chOverlayPressStart_spawn(void) {
  if (D_8037DE80 == NULL) {
    D_8037DE80 =
        actor_spawnWithYaw_f32(ACTOR_1DE_PRESS_START_OVERLAY, D_80368118, 0)
            ->marker;
  }
}
...
void chOverlayPressStart_spawn(s32 arg0, s32 arg1) {
  if (D_8037DE80 == NULL) {
    spawnQueue_add_0(__chOverlayPressStart_spawn);
  }
}

void chOverlayPressStart_func_802DCDB0(void) { D_8037DE84 = TRUE; }
