...
extern void comusic_stopTrackById(enum comusic_e);
extern f32 pfsManager_calculateStickValue(s32, s32, s32);
...
ActorAnimationInfo D_803683B0[] = {
    {0x000, 0.0f}, {0x2A2, 1.0f}, {0x2A5, 1.0f}, {0x2A4, 0.4f}, {0x2A3, 0.4f},
    {0x2A1, 0.3f}, {0x2A7, 0.4f}, {0x2A1, 0.3f}, {0x2A6, 2.6f}, {0x2A8, 2.6f}};

f32 D_80368400[3] = {570.0f, 328.9f, -186.4f};
f32 D_8036840C[3] = {-11.28f, 3.92f, -52.96f};

ActorInfo D_80368418 = {0x17A,
                        0x2B4,
                        0x565,
                        0x1,
                        D_803683B0,
                        chBottlesBonusCursor_update,
...
/* .code */
void chBottlesBonusCursor_func_802DF460(s32 indx, ActorMarker *caller,
                                        f32 arg2[3]) {
  f32 sp1C[3];
  ...
  if (viewport_projectPointToScreen(sp1C, D_8037E068[indx]) == 0) {
    D_8037E068[indx][0] = D_8037E068[indx][1] = 0.0f;
  }
}

static f32 __XY_dist_square(f32 arg0[2], f32 arg1[2]) {
  return (arg0[0] - arg1[0]) * (arg0[0] - arg1[0]) +
         (arg0[1] - arg1[1]) * (arg0[1] - arg1[1]);
}
...
bool chBottlesBonusCursor_checkPuzzleCompletion(void) {
  ...
  for (i = 0; i < 20 && D_8037E5C0.is_completed != 0; i++) {
    if ((D_8037E248[i].state != 3) || (i != D_8037E248[i].piece_id) ||
  ...
  if (D_8037E5C0.is_completed) {
    ...
    timedFunc_set_3(0.25f, (GenFunction_3)comusic_fadeTrackWithArgsNoDelay, COMUSIC_94_BBONUS,
                    0, 2000);
    timedFunc_set_2(0.3f, (GenFunction_2)comusic_playTrackWithVolumeOverride,
                    COMUSIC_2D_PUZZLE_SOLVED_FANFARE, 22000);
...
void chBottlesBonusCursor_draw(Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  modelRender_postDraw((GenFunction_1)actor_postdrawMethod,
                       (s32)chBottlesBonusCursorMarker);
  modelRender_setDepthMode(MODEL_RENDER_DEPTH_FULL);
  actor_setOpacity(this, 0xB9);
  viewport_projectPointToScreen(this->position, D_8037E5C0.unk18);
  sp3C = (this->scale * 650.0f);
  depthBuffer_draw(gfx, (s32)(D_8037E5C0.unk18[0] - sp3C / 2),
                   (s32)(D_8037E5C0.unk18[1] - sp3C / 2), (s32)sp3C, (s32)sp3C,
                   gFramebuffers[getActiveFramebuffer()]);
  modelRender_draw(gfx, mtx, this->position, rotation, this->scale, NULL,
                   marker_loadModelBin(chBottlesBonusCursorMarker));
  viewport_projectPointToScreen(this->position, D_8037E5C0.unk10);
  if (this->state == 1) {
...
void chBottlesBonusCursor_func_802DF99C(void) {
  func_803228D8();
  comusic_updateTrackWithArgs(-1, 2000, 7);
}
...
void chBottlesBonusCursor_update(Actor *this) {
  ...
  sp5C = pfsManager_getControllerData();
  ...
  if (!this->initialized) {
    ...
    timedFunc_set_2(3.0f, (GenFunction_2)comusic_playTrackWithVolumeOverride, COMUSIC_94_BBONUS,
                    0x5DC0);
    timedFunc_set_1(3.0f, (GenFunction_1)comusic_stopTrackById, COMUSIC_94_BBONUS);
    for (i = 0; i < 20; i++) {
  ...
  if (this->state != 8 && this->state != 9 && chBottlesBonus_getState() == 4) {
    if (this->state != 6) {
      sp54 = pfsManager_calculateStickValue(sp5C->stick_x, 7, 0x3B);
      sp50 = pfsManager_calculateStickValue(sp5C->stick_y, 7, 0x3D);
    ...
    if ((sp5C->button & START_BUTTON) &&
        !(D_8037E5C0.prev_button & START_BUTTON) &&
        chBottlesBonus_getState() == 4) {
      chBottlesBonus_lose(&D_8037DCC8, 0xE25);
    }

    if (this->state == 2 || this->state == 3 || this->state == 4) {
      if ((sp5C->button & L_CBUTTONS) &&
          !(D_8037E5C0.prev_button & L_CBUTTONS)) {
      ...
      if ((sp5C->button & R_CBUTTONS) &&
          !(D_8037E5C0.prev_button & R_CBUTTONS)) {
        held_piece->rotation = mlNormalizeAngle(held_piece->rotation + 90.0);
        chBottlesBonusCursor_func_802DF928(D_8037E5C0.unk0);
        chBottlesBonus_func_802DEA74(D_8037E5C0.unk0);
    ...
    case 1: // L802E00AC //no piece in hand
      if ((D_8037E5B8 > 0) && (D_8037E5B8 < 0x15) &&
        ...
        if (D_8037E248[D_8037E5B8 - 1].state == 0) {
          ...
          chBottlesBonusCursor_func_802DF928(D_8037E5C0.unk0);
          chBottlesBonusCursor_func_802DF928(D_8037E5C0.unk0);
          comusic_playTrackWithVolumeOverride(COMUSIC_96_BBONUS_PICKUP_PIECE, -1);
      ...
      if (((D_8037E5B8 >= 0x29) && (D_8037E5B8 < 0x3D)) &&
        ...
        if (D_8037E248[D_8037E5B8 - 41].state == 3) {
          if (D_8037E5B8 - 41 != D_8037E248[D_8037E5B8 - 41].piece_id ||
              !vec4f_isAlmostZero(
                  chBottlesBonus_get_piece_distance_vec4f(D_8037E5B8 - 41))) {
    ...
    case 2: // L802E029C
      if ((sp5C->button & B_BUTTON) && !(D_8037E5C0.prev_button & B_BUTTON)) {
        ...
        comusic_playTrackWithVolumeOverride(COMUISC_97_BBONUS_DROP_PIECE, -1);
        chBottlesBonus_func_802DEA50(D_8037E5C0.unk0);
        D_8037E5C0.unk0 = -1;
        break;
      }
      ...
      if ((sp5C->button & A_BUTTON) && !(D_8037E5C0.prev_button & A_BUTTON)) {
        if ((D_8037E5B8 >= 21) && (D_8037E5B8 < 41)) {
          ...
          if ((D_8037E5C0.unk0 == held_piece->piece_id) &&
              vec4f_isAlmostZero(
                  chBottlesBonus_get_piece_distance_vec4f(D_8037E5C0.unk0))) {
            // placed correctly
          ...
          timedFunc_set_2(0.25f, (GenFunction_2)comusic_playTrackWithVolumeOverride, sp44, 26000);
          chBottlesBonus_func_802DEA50(D_8037E5C0.unk0);
          D_8037E5C0.unk0 = -1;
        }
      }
...
f32 *chBottlesBonusCursor_func_802E05AC(s32 indx) {
  if (indx == D_8037E5C0.unk0) {
    D_8037E5F8[0] = D_8036840C[0] +
                    marker_getActor(chBottlesBonusCursorMarker)->position[0];
    D_8037E5F8[1] = D_8036840C[1] +
                    marker_getActor(chBottlesBonusCursorMarker)->position[1];
    D_8037E5F8[2] = D_8036840C[2] +
                    marker_getActor(chBottlesBonusCursorMarker)->position[2];
  } else {
...
s32 chBottlesBonusCursor_func_802E06B4(void) { return D_8037E5B8; }
