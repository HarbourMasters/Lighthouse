...
ActorInfo chTrainers = {MARKER_38_TURBO_TALON_TRAINERS,
                        ACTOR_2C_TURBO_TALON_TRAINERS,
                        ASSET_367_MODEL_TURBO_TALON_TRAINERS,
                        0x0,
                        chTrainersAnimations,
                        chtrainers_update,
...
void _chtrainers_802CA378(Actor *this, bool arg1) {
  ...
  if (actor_animationIsAt(this, 0.38f) || actor_animationIsAt(this, 0.88f)) {
    if (arg1)
      FUNC_8030E624(SFX_8_BANJO_LANDING_04, 1.6f, 7000);
    else
      FUNC_8030E8B4(SFX_8_BANJO_LANDING_04, 1.6f, 7000, this->position, 600,
                    1500);
  }

  ml_vec3f_set_yaw_length(sp24, this->velocity[1], 40.0f);
  sp24[1] = 0.0f;
...
void chtrainers_update(Actor *this) {
  ...
  if (!volatileFlag_get(VOLATILE_FLAG_F_HAS_MEET_TURBO_SHOES) &&
...
f32 chtrainers_getDuration(Actor *this) { return this->velocity[0]; }
