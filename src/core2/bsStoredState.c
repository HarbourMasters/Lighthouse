...
/* .code */
void bsStoredState_debug(void) { ability_debug(); }
...
f32 bsStoredState_getLongLegTimer(void) { return bsStoredState.longleg_timer; }

f32 bsStoredState_getTurboTimer(void) { return bsStoredState.turbo_timer; }

s32 bsStoredState_getTrotFlag(void) { return bsStoredStateInTrot; }
...
void bsStoredState_setTurboTimer(f32 arg0) { bsStoredState.turbo_timer = arg0; }

void bsStoredState_setTrot(bool arg0) { bsStoredStateInTrot = arg0; }
