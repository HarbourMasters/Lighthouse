...
void resetHitboxState(void) { D_8037BFA0 = 0; }

void decrementHitboxState(void) {
  if (D_8037BFA0 != 0)
    D_8037BFA0--;
}

void setHitboxState(void) { D_8037BFA0 = 2; }
...
enum hitbox_e hitbox_getHitboxForActor(ActorMarker *arg0) {
  ...
  case BS_CLAW: // 8028DBF8
    if (arg0 && !is_within_yaw_range(marker_getActor(arg0)->position, 90.0f))
  ...
  case BS_11_BPECK: // 8028DC50
    if (arg0 && !is_within_yaw_range(marker_getActor(arg0)->position, 60.0f))
      return HITBOX_0_NONE;
