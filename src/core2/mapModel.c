...
extern UNK_TYPE(s32)
    findCollisionTriInSphere(BKCollisionList *, BKVertexList *, f32[3], f32[3],
                             f32, f32[3], s32, s32);
extern UNK_TYPE(s32)
    findCollisionTriAtPosition(BKCollisionList *, BKVertexList *, f32[3], f32,
                               f32[3], s32);
extern s32 func_802EC394(BKModelUnk14List *arg0, s32 arg1, s32 arg2, f32 arg3,
...
BKCollisionTri *findCollisionTriAlongPath3(f32 arg0[3], f32 arg1[3],
                                           f32 arg2[3], s32 arg3);
...
MapModelDescription D_8036ABE0[] = {
    ...
    {MAP_7_TTC_TREASURE_TROVE_COVE,
     ASSET_146B_MODEL_TTC_TREASURE_TROVE_COVE_OPA,
    ...
    {MAP_B_CC_CLANKERS_CAVERN,
     ASSET_14ED_MODEL_CC_CLANKERS_CAVERN_OPA,
    ...
    {MAP_1E_CS_START_NINTENDO,
     ASSET_149D_MODEL_CS_START_NINTENDO_OPA,
    ...
    {MAP_31_RBB_RUSTY_BUCKET_BAY,
     ASSET_14B0_MODEL_RBB_RUSTY_BUCKET_BAY_OPA,
    ...
    {MAP_6E_GL_GV_LOBBY,
     ...
     ASSET_14A8_MODEL_GL_GV_LOBBY_XLU,
     {0, 0, 0},
     {0, 0, 0},
     1.0f},
    {MAP_6F_GL_FP_LOBBY,
...
/* .code */
static MapModelDescription *mapModel_mapIdToDescription(enum map_e map_id) {
...
f32 mapModel_findFloorY(f32 arg0[3], u32 arg1) {
  s32 phi_s2;
  f32 sp70[3];
  f32 sp64[3];
  f32 sp58[3];
  ...
  sp58[2] = arg0[2];
  sp58[1] -= 2000.0f;
  if (findCollisionTriAlongPath3(sp64, sp58, sp70, arg1)) {
    return sp58[1];
  }
  phi_s2 = 150;
  phi_s1 = 1000;
...
void mapModel_opa_draw(Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  if (func_80320708() && levelSpecificFlags_validateCRC2() &&
      dummy_func_80320248()) {
    ...
    case MAP_12_GV_GOBIS_VALLEY:
      ...
      func_8033A45C(2,
                    jiggyscore_isCollected(JIGGY_42_GV_WATER_PYRAMID) ? 0 : 1);
      func_8033A45C(5,
                    jiggyscore_isCollected(JIGGY_42_GV_WATER_PYRAMID) ? 1 : 0);
      break;
    ...
    case MAP_93_GL_DINGPOT:
      ...
      func_8033A45C(
          6, (func_8038EAE0(0xA) ||
              fileProgressFlag_get(FILEPROG_E2_DOOR_OF_GRUNTY_OPEN) ||
    ...
    modelRender_setEnvColor(mapModel.env_red, mapModel.env_green,
                            mapModel.env_blue, 0xFF);
    modelRender_draw(gfx, mtx, NULL, NULL, mapModel.description->scale, NULL,
                     mapModel.model_bin_opa);
...
void mapModel_xlu_draw(Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  if (mapModel.model_bin_xlu != NULL) {
    if (map_get() == MAP_1D_MMM_CELLAR) {
      func_8033A45C(1,
                    (actorArray_findActorFromActorId(0x191) != NULL) ? 0 : 1);
    }
    ...
    modelRender_setEnvColor(mapModel.env_red, mapModel.env_green,
                            mapModel.env_blue, 0xFF);
    modelRender_draw(gfx, mtx, NULL, NULL, mapModel.description->scale, NULL,
                     mapModel.model_bin_xlu);
    func_802F7BC0(gfx, mtx, vtx);
  }
}

void noop3(s32 arg0, s32 arg1, s32 arg2) {}

s32 getCollisionOpaUnk12(void) { return mapModel.collision_opa->unk12; }

f32 mapModel_getFloorY(f32 arg0[3]) {
  return mapModel_findFloorY(arg0, 0x1e0000);
}
...
s32 getMapModelUnk20(void) { return mapModel.unk20; }

struct5Bs *getMapModelUnk24(void) { return mapModel.unk24; }
...
void mapModel_getBounds(s32 min[3], s32 max[3]) {
  ...
  if (mapModel.model_bin_xlu != NULL) {
    vtxList_getBounds_s32(model_getVtxList(mapModel.model_bin_xlu), xlu_min,
                          xlu_max);
    for (j = 0; j < 3; j++) {
      if (xlu_min[j] < min[j]) {
        min[j] = xlu_min[j];
...
f32 mapModel_findFloorYWithFlags(f32 arg0[3]) {
  return mapModel_findFloorY(arg0, 0xf800ff0f);
}

BKCollisionTri *findCollisionTriAlongPath3(f32 startPoint[3], f32 endPoint[3],
                                           f32 arg2[3], s32 flagFilter) {
  ...
  if (mapModel.collision_xlu != NULL) {
    if ((flagFilter & 0x80001F00) == 0x80001F00) {
      ...
      opaqueTri = findCollisionTriAlongPath2(
          mapModel.collision_opa, model_getVtxList(mapModel.model_bin_opa),
          startPoint, endPoint, arg2, flagFilter);
    }

    transparentTri = findCollisionTriAlongPath2(
        mapModel.collision_xlu, model_getVtxList(mapModel.model_bin_xlu),
        startPoint, endPoint, arg2, flagFilter);
...
BKCollisionTri *findCollisionTriAlongPathWithModelBin(f32 arg0[3], f32 arg1[3],
                                                      f32 arg2[3],
                                                      s32 flagFilter,
                                                      BKModelBin **arg4) {
  BKCollisionTri *sp2C;
  ...
  sp2C = findCollisionTriAlongPath2(mapModel.collision_opa,
                                    model_getVtxList(mapModel.model_bin_opa),
                                    arg0, arg1, arg2, flagFilter);
  if (sp2C != NULL) {
  ...
  phi_v0 = findCollisionTriAlongPath2(mapModel.collision_xlu,
                                      model_getVtxList(mapModel.model_bin_xlu),
                                      arg0, arg1, arg2, flagFilter);
  if (phi_v0 != 0) {
...
bool checkCollisionWithModel(f32 arg0[3], UNK_TYPE(s32) arg1) {
...
UNK_TYPE(s32) findCollisionTriInSphereWithFlags(f32 currentPosition[3], f32 next_position[3],
                                  f32 arg2, f32 arg3[3], s32 arg4, s32 arg5) {
  s32 sp34;
  s32 temp_v0_2;

  mapModel.unk20 = 0;
  sp34 = findCollisionTriInSphere(
      mapModel.collision_opa, model_getVtxList(mapModel.model_bin_opa),
      currentPosition, next_position, arg2, arg3, arg4, arg5);
  if (sp34 != 0) {
    mapModel.unk20 = (s32)mapModel.model_bin_opa;
  }
  ...
  temp_v0_2 = findCollisionTriInSphere(
      mapModel.collision_xlu, model_getVtxList(mapModel.model_bin_xlu),
      currentPosition, next_position, arg2, arg3, arg4, arg5);
  if (temp_v0_2 != 0) {
    mapModel.unk20 = (s32)mapModel.model_bin_xlu;
...
UNK_TYPE(s32) findCollisionTriAtPositionWithFlags(f32 arg0[3], f32 arg1, f32 arg2[3],
                                    s32 arg3) {
  s32 sp24;
  s32 temp_v0_2;

  sp24 = findCollisionTriAtPosition(mapModel.collision_opa,
                                    model_getVtxList(mapModel.model_bin_opa),
                                    arg0, arg1, arg2, arg3);
  if (mapModel.collision_xlu == 0) {
    return sp24;
  }
  temp_v0_2 = findCollisionTriAtPosition(
      mapModel.collision_xlu, model_getVtxList(mapModel.model_bin_xlu), arg0,
      arg1, arg2, arg3);
...
bool isMapModelAvailable(enum map_e map_id) {
  MapModelDescription *i_ptr;
...
void func_8030A078(void) {
  ...
  if (sp24 != NULL) {
    mapModel.model_opa =
        func_8033F5F8(sp24, model_getVtxList(mapModel.model_bin_opa));
  } else {
  ...
  if (sp24 != NULL) {
    mapModel.model_xlu =
        func_8033F5F8(sp24, model_getVtxList(mapModel.model_bin_xlu));
  } else {
  ...
  func_80320B44(findCollisionTriAlongPath3, findCollisionTriInSphereWithFlags,
                findCollisionTriAtPositionWithFlags, getMapModelUnk20);

  if ((mapModel.model_bin_opa != NULL) &&
      (model_getAnimTextureList(mapModel.model_bin_opa) != NULL)) {
    mapModel.unk0 = AnimTextureListCache_newList();
    AnimTextureListCache_at(mapModel.unk0,
                            model_getAnimTextureList(mapModel.model_bin_opa));
  } else {
    mapModel.unk0 = NULL;
  }
  if ((mapModel.model_bin_xlu != NULL) &&
      (model_getAnimTextureList(mapModel.model_bin_xlu) != 0)) {
    mapModel.unk4 = AnimTextureListCache_newList();
    AnimTextureListCache_at(mapModel.unk4,
                            model_getAnimTextureList(mapModel.model_bin_xlu));
  } else {
    mapModel.unk4 = NULL;
  }
}
