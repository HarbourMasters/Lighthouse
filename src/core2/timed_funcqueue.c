...
TimedFunction* __timedFuncQueue_insert(f32, s32, void *funcPtr, uintptr_t, uintptr_t, uintptr_t, uintptr_t, uintptr_t);
...
/* .code */
TimedFunction* __timedFuncQueue_insert(f32 time, s32 cnt, void *funcPtr, uintptr_t arg0, uintptr_t arg1, uintptr_t arg2, uintptr_t arg3, uintptr_t arg4){
    ...
    retVal = (TimedFunction * )bk_vector_insertNew((bk_vector(TimedFunction)**)&D_80383380, ((uintptr_t)iPtr - (uintptr_t)startPtr)/(uintptr_t)sizeof(TimedFunction));
    retVal->time = time;
    retVal->arg_cnt = cnt;
