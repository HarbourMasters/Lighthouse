...
void __chLevelCollectible_callDialog(enum asset_e text_id){
    gcdialog_showDialogConditional(text_id, 0, NULL, NULL, NULL, NULL, (s32(*)(ActorMarker*,s32,s32))__chLevelCollectible_dialogCallback); // [port] polymorphic callback
}
    ...
    if ((this->state == 1) || (this->state == 2)) {
        ...
        switch (marker->id) {
            ...
            case MARKER_37_GOLD_BULLION:
                ...
                timedFunc_set_1(0.5f, (GenFunction_1)progressDialog_showDialogMaskFour, FILEPROG_9_GOLD_BULLION_TEXT); // [port]
                dialog_id = 0;
                break;
