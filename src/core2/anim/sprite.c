...
/* .bss */
u8 controllerState[0x10];
static AnimSprite s_animsprite_list[40];

/* .code */
static void __animsprite_reset_loop(AnimSprite *this) {
  this->remaining_time += this->steps[this->current_step].duration *
                          (1.0 / 30.0) * this->speed_multiplier;
}
 ...
 * @param this
 */
void animsprite_free(AnimSprite *this) { this->active = 0; }
 ...
 */
void animsprite_set_steps(AnimSprite *this, AnimSpriteStep *step_list,
                          s32 size) {
 ...
 * @return s32
 */
s32 animsprite_get_frame(AnimSprite *this) { return this->current_frame; }
 ...
 * @note This bit is not used in the final release of Banjo-Kazooie
 */
s32 animsprite_get_unknown(AnimSprite *this) { return this->unknown; }
 ...
 * @return f32
 */
f32 animsprite_get_speed(AnimSprite *this) { return this->speed_multiplier; }
