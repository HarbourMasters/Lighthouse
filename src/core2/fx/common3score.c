...
extern void depthBuffer_draw(Gfx **gdl, s32 x, s32 y, s32 w, s32 h,
                             void *color_buffer);
...
Struct_core2_79830_0 D_8036A2B0[] = {
    {{0},    0,     {0},    ITEM_E_JIGGY, ASSET_35F_MODEL_JIGGY,
     0,      0.0f,  136.0f, 236.0f,       0.0f,
     0.375f, 28.0f, -10.0f, 300.0f,       20.0f,
     -1.0f,  -1.0f, NULL,   {'\0'},       0.0f,
     0.0f,   NULL},
    {{0},
     0,
     {0},
     ...
     0.0f,
     NULL},
    {{0},   0,     {0},    ITEM_19_ORANGE, ASSET_2D2_MODEL_ORANGE,
     0,     0.0f,  224.0f, 226.0f,         25.0f,
     0.4f,  32.0f, 0.0f,   100.0f,         20.0f,
     -1.0f, -1.0f, NULL,   {'\0'},         0.0f,
     0.0f,  NULL},
    {{0},
     0,
    ...
    {{0},
     ...
     ASSET_47F_MODEL_XMAS_GIFT_BLUE,
     0,
     0.0f,
     224.0f,
     226.0f,
    ...
    {{0},
     ...
     0.0f,
     NULL},
    {{0},    0,     {0},    ITEM_2B_UNKNOWN, ASSET_35F_MODEL_JIGGY,
     0,      0.0f,  208.0f, 238.0f,          0.0f,
     0.325f, 29.0f, -10.0f, 300.0f,          15.0f,
     -1.0f,  -1.0f, NULL,   {'\0'},          0.0f,
     0.0f,   NULL},
    {{0}, 0, {0}, -1}};
...
void fxcommon3score_draw(enum item_e item_id, void *arg1, Gfx **gfx, Mtx **mtx,
                         Vtx **vtx) {
  Struct_core2_79830_0 *a1 = (Struct_core2_79830_0 *)arg1;
  f32 sp68[3];
  f32 sp5C[3];
  ...
  if (a1->model != NULL && func_802FB0D4(arg1)) {
    ...
    print_bold_spaced(a1->unk30 + a1->unk40, sp40 + a1->unk44,
                      a1->value_string);
    ...
    sp68[0] += a1->unk4C;
    if (a1->unk6C == 0.0f) {
      a1->unk6C = 1.1 * (vtxList_getGlobalNorm(model_getVtxList(a1->model)) *
                         a1->unk3C);
    }
    depthBuffer_draw(gfx, a1->unk30 - a1->unk6C, sp40 - a1->unk6C,
                     2 * a1->unk6C, 2 * a1->unk6C,
