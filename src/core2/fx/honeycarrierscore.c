...
Gfx D_8036A030[] = {
    ...
    gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0,
...
void fxhoneycarrierscore_draw(s32 arg0, struct8s *arg1, Gfx **arg2, Mtx **arg3,
                              Vtx **arg4) {
  f64 var_f24;
  s32 sp13C;
  s32 sp138;
  ...
  if (D_8036A010 != 0) {
    func_80347FC0(arg2,
                  (sp118) ? (D_8036A014 != 0) ? D_8036A014 : D_8036A010
                          : D_8036A010,
                  0, 0, 0, 0, 0, 2, 2, &sp13C, &sp138);
    viewport_setRenderViewportAndOrthoMatrix(arg2, arg3);
    __gSPDisplayList((*arg2)++, D_8036A030);
    for (sp134 = 0; sp134 < ((sp118) ? ((D_8036A014 != 0) ? 2 : 1) : 6);
         sp134++) {
      ...
      if (sp118) {
        if (sp134 != 0) {
          ...
          gDPSetPrimColor((*arg2)++, 0, 0, 0x00, 0x00, 0x00,
                          (0xFF - D_803815E4));
        } else {
      ...
      gSPMatrix((*arg2)++, OS_K0_TO_PHYSICAL((*arg3)++),
      ...
      sp130 = cosf(((D_803815CC + sp110) * 0.017453292519943295)) *
              (var_f24 * 24.5) * D_803815D0;
      var_f24 = MIN(1.0, MAX(0.0, D_803815C8));
      sp12C = sinf(((D_803815CC + sp110) * 0.017453292519943295)) *
              (var_f24 * 24.5) * D_803815D0;
      __gSPVertex((*arg2)++, *arg4, 4, 0);
      for (var_v1 = 0; var_v1 < 2; var_v1++) {
        for (var_v0 = 0; var_v0 < 2; var_v0++, (*arg4)++) {
          (*arg4)->v.ob[0] =
              ((((sp13C * D_803815D0) * var_v0) - ((sp13C * D_803815D0) / 2)) +
               (s32)(sp130 + sp128)) *
              4.0f;
          (*arg4)->v.ob[1] =
              ((((sp138 * D_803815D0) / 2) - ((sp138 * D_803815D0) * var_v1)) +
               (s32)(sp12C + sp124)) *
              4.0f;
          (*arg4)->v.ob[2] = -0x14;
  ...
  case 2:
    ...
    case 0: // L802FEA40
      if (D_803815EC) {
        if (6.0f <= D_803815D4 && D_80381610 && D_803815E8 == 0xFF) {
          D_803815C0 = 1;
          D_803815DC = 20.0f;
          comusic_playTrackWithVolumeOverride(COMUSIC_18_HEALTH_UPGRADE, 28000);
        } else {
          if (1.0f < D_803815D4 && !D_80381610) {
            D_803815D8 += _76D90_MAX(
                (((D_803815D4 - 1.0f) * 60.0 - D_803815D8) * sp24 * 3.0), 2.0);
          }
        }
      }
      break;
    case 1: // L802FEB70
      ...
      if (D_803815C8 < 0.0f) {
        ...
        timedFunc_set_2(0.25f, (GenFunction_2)comusic_playTrackWithVolumeOverride, COMUSIC_2B_DING_B,
                        28000);
        item_adjustByDiffWithHud(ITEM_14_HEALTH, 0);
        timedFunc_set_1(1.25f, (GenFunction_1)item_inc, ITEM_15_HEALTH_TOTAL);
        timedFunc_set_1(1.25f, (GenFunction_1)sfxsource_playHighPriority,
                        SFX_3EA_UNKNOWN);
        timedFunc_set_2(1.25f, (GenFunction_2)item_set, ITEM_14_HEALTH,
                        item_getCount(ITEM_15_HEALTH_TOTAL) + 1);
