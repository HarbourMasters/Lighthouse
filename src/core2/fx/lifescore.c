...
/* .code */
s32 func_802FFDE0(s32 arg0) { return D_8036A260[arg0 / 4]; }
...
void fxlifescore_draw(enum item_e item_id, struct8s *arg1, Gfx **gfx, Mtx **mtx,
                      Vtx **vtx) {
  s32 sp10C;
  Vtx *sp108;
  s32 sp104;
  ...
  print_bold_spaced(0x4E, (s32)(func_802FB0E4(arg1) + -16.0f + 4.0f),
                    (char *)&code_78E50_ItemValueString);
  if (1)
    ; // fake
  if (D_80381EB0[D_80381EC4] != NULL) {
    __gSPDisplayList((*gfx)++, D_8036A278);
    viewport_setRenderViewportAndOrthoMatrix(gfx, mtx);
    if (gfx)
      ;
    gDPPipeSync((*gfx)++);
    gDPSetCombineLERP((*gfx)++, 0, 0, 0, TEXEL0, TEXEL0, 0, PRIMITIVE, 0, 0, 0,
                      0, TEXEL0, TEXEL0, 0, PRIMITIVE, 0);
    gDPSetPrimColor((*gfx)++, 0, 0, 0x00, 0x00, 0x00, 0xFF);
    do {
      func_80348044(gfx, D_80381EB0[D_80381EC4], (s32)D_80381EBC % 4, 0, 0, 0,
                    0, 2, 2, &spF0, &spEC, &spE8, &spE4, &spE0, &spDC, &sp10C);

      if (((*vtx - sp108) & 0xF) == 0) {
        __gSPVertex((*gfx)++, *vtx, MIN(0x10, (1 + sp10C) << 2), 0);
        sp104 = 0;
      } else {
        sp104 = sp104 + 4;
      }
      ...
      var_s4 =
          (((((f32)gFramebufferHeight / 2) - func_802FB0E4(arg1)) - -16.0f) -
           spDC);
      for (var_v1 = 0; var_v1 < 2; var_v1++) {
        for (var_v0 = 0; var_v0 < 2; var_v0++) {
          (*vtx)->v.ob[0] =
              (s16)(s32)(((((f32)spF0 * D_80381EB8 * (f32)var_v0) -
                           (((f32)spE8 * D_80381EB8) / 2)) +
                          var_s5) *
                         4.0f);
          (*vtx)->v.ob[1] = (s16)(s32)((((((f32)spE4 * D_80381EB8) / 2) -
                                         ((f32)spEC * D_80381EB8 * var_v1)) +
                                        var_s4) *
                                       4.0f);
          (*vtx)->v.ob[2] = -0x14;
