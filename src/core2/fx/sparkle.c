...
extern ParticleEmitter *createfxSparkleParticleEmitter(f32 pos[3], enum asset_e sprite_id);

ParticleEmitter *__fxSparkle_create(s16 position[3], f32 height,
  ...
  return createfxSparkleParticleEmitter(position_f, sprite_id);
}
...
void fxSparkle_emptyHoneycomb(s16 position[3]) {
  ...
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 10.0f, ASSET_713_SPRITE_SPARKLE_YELLOW);
...
void fxSparkle_musicNote(s16 position[3]) {
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 7.0f, ASSET_713_SPRITE_SPARKLE_YELLOW);
  particleEmitter_setParticleVelocityRange(p_emitter, -70.0f, 100.0f, -70.0f,
                                           70.0f, 250.0f, 70.0f);
...
void fxSparkle_blueEgg(s16 position[3]) {
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 7.0f, ASSET_716_SPRITE_SPARKLE_WHITE);
  particleEmitter_setParticleVelocityRange(p_emitter, -70.0f, 100.0f, -70.0f,
                                           70.0f, 250.0f, 70.0f);
  particleEmitter_emitN(p_emitter, 5);
}
...
void fxSparkle_giantBlueEgg(s16 position[3]) {
  ...
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 25.0f, ASSET_716_SPRITE_SPARKLE_WHITE);
...
void fxSparkle_redFeather(s16 position[3]) {
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 12.0f, ASSET_715_SPRITE_SPARKLE_RED);
  particleEmitter_setParticleVelocityRange(p_emitter, -75.0f, 100.0f, -75.0f,
                                           75.0f, 250.0f, 75.0f);
...
void fxSparkle_giantRedFeather(s16 position[3]) {
  ...
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 40.0f, ASSET_715_SPRITE_SPARKLE_RED);
...
void fxSparkle_giantGoldFeather(s16 position[3]) {
  ...
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 40.0f, ASSET_713_SPRITE_SPARKLE_YELLOW);
...
void fxSparkle_mumboToken(s16 position[3]) {
  ...
  ParticleEmitter *p_emitter =
      __fxSparkle_create(position, 10.0f, ASSET_718_SPRITE_SPARKLE_WHITE_2);
...
void fxSparkle_free(void) { resetfxSparkleParticleEmitter(); }

void fxSparkle_init(void) { initializefxSparkleParticleEmitter(); }
