// BanjoDecomp: core2/code_D2180.c
#include <ultra64.h>
#include "functions.h"
#include "variables.h"
...
bool weatherParticle_isAlwaysActive(Actor *);
bool weatherParticle_shouldStartCCWHubLeafFalling(Actor *);
bool weatherParticle_isAlwaysActive(Actor *);
bool weatherParticle_shouldStartCCWHubRainFalling(Actor *);
bool weatherParticle_isAlwaysActive(Actor *);
bool weatherParticle_shouldStartCCWHubSnowFalling(Actor *);
