...
/* .code */
s32 can_beak_barge(void) { return ability_hasLearned(ABILITY_0_BARGE); }

s32 can_beak_bomb(void) { return ability_hasLearned(ABILITY_1_BEAK_BOMB); }

s32 can_beak_bust(void) { return ability_hasLearned(ABILITY_2_BEAK_BUSTER); }

s32 can_control_camera(void) {
  return ability_hasLearned(ABILITY_3_CAMERA_CONTROL);
}

s32 can_claw(void) { return ability_hasLearned(ABILITY_4_CLAW_SWIPE); }

s32 can_climb(void) { return ability_hasLearned(ABILITY_5_CLIMB); }

int can_dive(void) {
  return ability_hasLearned(ABILITY_F_DIVE) && !func_8029D66C() &&
         100.0f < func_80294500() - func_80294438();
}

s32 can_egg(void) { return ability_hasLearned(ABILITY_6_EGGS); }
...
s32 can_flap_flip(void) { return ability_hasLearned(ABILITY_8_FLAP_FLIP); }

s32 can_fly(void) { return ability_hasLearned(ABILITY_9_FLIGHT); }
...
int can_use_ability(void) {
  if (baflag_isTrue(BA_FLAG_14_LOSE_BOGGY_RACE) ||
      baflag_isTrue(BA_FLAG_19_SHOULD_TRANSFORM))
    return 0;
...
s32 can_roll(void) { return ability_hasLearned(ABILITY_C_ROLL); }

s32 can_shock_jump(void) { return ability_hasLearned(ABILITY_D_SHOCK_JUMP); }

s32 can_use_wading_boots(void) {
  return ability_hasLearned(ABILITY_E_WADING_BOOTS);
}

s32 can_trot(void) { return ability_hasLearned(ABILITY_10_TALON_TROT); }

s32 can_trot_unused(void) { return ability_hasLearned(ABILITY_10_TALON_TROT); }

s32 can_wonderwing(void) { return ability_hasLearned(ABILITY_12_WONDERWING); }
...
int dummy_player_is_ant(void) { return bsant_inSet(bs_getState()); }

int dummy_player_is_pumpkin(void) { return bspumpkin_inSet(bs_getState()); }

int is_cheat_code_active(void) {
  return isGamePaused() && map_get() != MAP_1_SM_SPIRAL_MOUNTAIN;
}
...
bool is_within_yaw_range(f32 arg0[3], f32 arg1) {
  f32 position[3];
  f32 sp28;
  u16 sp26;
  u16 sp24;
  ...
  _player_getPosition(position);
  ml_vec3f_yaw_between(arg0, position, &sp28);
...
int player_isInHorizontalRadius(f32 arg0[3], f32 arg1) {
  ...
  return ml_vec3f_point_within_horizontal_distance(sp1C, arg0[0], arg0[2],
                                                   arg1);
}

s32 playerutils_noop(void) { return 0; }

int player_isOnDangerousGround(void) {
  return baflag_isTrue(BA_FLAG_13_TOUCHING_DANGEROUS_GROUND);
}

bool player_isInRBB(void) { return level_get() == LEVEL_9_RUSTY_BUCKET_BAY; }

bool player_isInVerticalRange(f32 position[3], f32 range) {
  f32 plyr_pos[3];

  _player_getPosition(plyr_pos);
  return (((position[1] - range) <= plyr_pos[1]) &&
          (plyr_pos[1] <= (position[1] + range)));
}
...
bool is_player_stable_or_falling(s32 arg0) {
  return (player_isStable() ||
          (baphysics_get_vertical_velocity() < 0.0f &&
           (player_getYPosition() - func_80294438()) < (f32)arg0));
}
...
int player_isSliding(void) {
  return stateTimer_isActive(STATE_TIMER_5_UNKNOWN) || 1.0 == get_slope_timer();
}

int is_player_in_state(void) { return func_8029CF20(4); }
...
int is_yaw_difference_large(void) {
  return 135.0f < mlAbsF(mlDiffDegF(yaw_getIdeal(), yaw_get()));
}

int player_inWater(void) { return D_8037BF61; }

int get_player_state(void) { return D_8037BF62; }
...
void update_player_state(void) {
  ...
  if (player_inWater()) {
    ...
    if (player_isStable() || player_movement_group == BSGROUP_A_FLYING ||
...
void check_player_in_water(void) {
  s32 sp24;

  sp24 = D_8037BF61;
  if (D_8037BF61) {
    D_8037BF61 = (func_80294554() &&
                  player_getYPosition() < ((func_80294500() - 50.0f) + 2.0f));
  } else {
    D_8037BF61 = (func_80294554() &&
                  player_getYPosition() < ((func_80294500() - 50.0f) - 2.0f));
  }
...
void update_player_conditions(void) {
