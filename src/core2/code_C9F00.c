...
extern BKCollisionTri *findCollisionTriWithTransform(BKCollisionList *arg0, BKVertexList *vtxList, f32 arg2[3], f32 arg3[3], f32 arg4, f32 arg5[3], f32 arg6[3], f32 arg7[3], s32 arg8);
extern BKCollisionTri *findCollisionTriWithTransformAndRadius(BKCollisionList *arg0, BKVertexList *vtxList, f32 arg2[3], f32 arg3[3], f32 arg4, f32 arg5[3], f32 arg6[3], f32 arg7, f32 arg8[3], s32 arg9, s32 arg10);
extern BKCollisionTri *findCollisionTriWithTransformAndScale(BKCollisionList *arg0, BKVertexList *vtxList, f32 arg2[3], f32 arg3[3], f32 arg4, f32 arg5[3], f32 arg6, f32 arg7[3], s32 arg8);
...
BKCollisionTri * func_80350F7C(ActorMarker *marker, f32 arg1[3], f32 arg2[3], f32 arg3[3], s32 arg4) {
    ...
    sp4C = findCollisionTriWithTransform(colision_list, vtx_list, temp_s0->position, temp_s0->unk20, temp_s0->unk2C, arg1, arg2, arg3, arg4);
    if (sp4C != 0) {
        if (func_8029453C()) {
...
BKCollisionTri *func_803510B4(ActorMarker *marker, f32 arg1[3], f32 arg2[3], f32 arg3, f32 arg4[3], s32 arg5, u32 flagFliter) {
    ...
    return findCollisionTriWithTransformAndRadius(collision_list, vertex_list, sp40->position, sp40->unk20, sp40->unk2C, arg1, arg2, arg3, arg4, arg5, flagFliter);
}
...
BKCollisionTri *func_80351198(ActorMarker *marker, f32 arg1[3], f32 arg2, f32 arg3[3], s32 arg4) {
    ...
    return findCollisionTriWithTransformAndScale(collision_list, vtx_list, sp38->position, sp38->unk20, sp38->unk2C, arg1, arg2, arg3, arg4);
}
    ...
    if (arg0->bit6 != 6) {
        ...
        for(phi_s0 = D_803725C0; phi_s0->unk0 != 0; phi_s0++){
            if( (arg0->unk8 == phi_s0->unk0) 
                ...
                sp48[1] = (s32) arg0->y;
                sp48[2] = (s32) arg0->z;
                if(updateCubeProps(&sp48, &sp44, &sp40, 2, 0x1F4)){
...
void func_80351998(void) {
    ...
    D_803861B0.unk4 = (Struct68s*)heap_malloc(2*sizeof(Struct68s));
...
void func_80351A1C(s32 arg0, s32 arg1) {
    ...
    if (arg0 == 2) {
        iterateOverCubes(NULL, func_80351724);
        func_803518E8();
        func_80351998();
    }
    if (arg1 == 2) {
        func_803518E8();
        func_80351998();
        iterateOverCubes(&func_803515EC, &func_80351700);
        for(phi_s0 = D_803861B0.unk4; phi_s0 < D_803861B0.unk8; phi_s0++){
    ...
    if(arg0->unkC != NULL){
        ...
        if(sp34 != NULL){
            if(func_802EA760(sp34, 0, arg0->position, arg0->unk20, arg0->unk2C, 0, sp48, &sp38)){
                ...
                if(findCollisionTriInSphereWithFlags(sp48, sp3C, sp38, sp54, 3, 0)){
                    return;
                }
            }
        }
...
void func_80351C48(void) {
    ...
    if (D_80386180.unk2C != NULL) {
        ...
        if ((sp38[0] == D_80386180.unk20[0]) && (sp38[1] == D_80386180.unk20[1]) && (sp38[2] == D_80386180.unk20[2])) {
            ...
            mlMtxIdent();
            mlMtx_inverse_transform_with_scale(D_80386180.unk2C->position, D_80386180.unk2C->unk20, D_80386180.unk2C->unk2C, 0);
    ...
    if (D_80386180.unk2C != NULL) {
        mlMtxIdent();
        mlMtx_transform_with_scale(D_80386180.unk2C->position, D_80386180.unk2C->unk20, D_80386180.unk2C->unk2C, NULL);
