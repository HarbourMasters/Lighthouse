...
/* .code */
f32 babuzz_calculateVolume(f32 arg0) {
  f64 temp_f2;
  temp_f2 = ml_fractional_part(arg0, 0.7f);
...
f32 babuzz_interpolateValue(f32 arg0, f32 arg1, f32 arg2) {
...
void babuzz_update(void) {
  ...
  D_8037C048.volume =
      babuzz_interpolateValue(D_8037C048.volume, D_8037C050.volume, 0.3f);
  D_8037C048.sample_rate = babuzz_interpolateValue((f32)D_8037C048.sample_rate,
                                           (f32)D_8037C050.sample_rate, 100.0f);
  sfxsource_playSfxAtVolume(baBuzzSfxSource,
                            babuzz_calculateVolume(D_8037C058) + D_8037C048.volume);
  sfxsource_setSampleRate(baBuzzSfxSource, D_8037C048.sample_rate);
  func_8030E2C4(baBuzzSfxSource);
}

void babuzz_setVolume(f32 arg0) { D_8037C050.volume = arg0; }

void babuzz_setSampleRate(s32 arg0) { D_8037C050.sample_rate = arg0; }
