...
void func_80290298(void) {
    ...
    sp30 = (get_player_state() && !is_pumpkin) ? 6 : 1;
    sp24 = get_player_state() && !is_pumpkin;
    ...
    else if (findStructInArrayC8WithFlagsAndHeight(D_8037C020, &D_8037C010, &D_8037C014, 0x12C, sp30)) {
        D_8037C018 = getStructArrayC8Index(D_8037C010);
    }
    else{
        D_8037C018 = -1;
    }
