...
static void roll_update(f32 limit, f32 step_percent) {
  f32 diff;
  f32 val;
...
//clang-format off
void roll_update2(void){
    roll_update(D_8037C688, D_8037C68C);
}
//clang-format on

void roll_setIdeal(f32 arg0) { D_8037C684 = mlNormalizeAngle(arg0); }

void roll_set(f32 arg0) { D_8037C680 = mlNormalizeAngle(arg0); }

void roll_applyIdeal(void) { D_8037C680 = D_8037C684; }

f32 roll_get(void) { return D_8037C680; }

f32 roll_getIdeal(void) { return D_8037C684; }
