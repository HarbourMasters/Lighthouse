...
ActorAnimationInfo D_80390C70[3] = {
    {0, 0.0f}, {0x103, 8000000.0f}, {0x103, 0.75f}};

ActorInfo D_80390C88 = {MARKER_6D_TANKTUP_LEG,
...
ActorAnimationInfo BGS_D_80390CB0[3] = {
    {0, 0.0f}, {0x104, 8000000.0f}, {0x104, 0.75f}};

ActorInfo D_80390CC8 = {MARKER_6D_TANKTUP_LEG,
...
ActorAnimationInfo BGS_D_80390CF0[3] = {
    {0, 0.0f}, {0x105, 8000000.0f}, {0x105, 0.75f}};

ActorInfo D_80390D08 = {MARKER_6D_TANKTUP_LEG,
...
ActorAnimationInfo D_80390C30[3] = {
    {0, 0.0f}, {0x106, 8000000.0f}, {0x106, 0.75f}};

ActorInfo D_80390D48 = {MARKER_6D_TANKTUP_LEG,
...
/* .code */
void chTanktupLeg_setState(ActorMarker *this, s32 arg1) {
  Actor *thisActor;
...
void BGS_func_8038FB84(ActorMarker *this, ActorMarker *other_marker) {
  ...
  thisActor = marker_getActor(this);
  FUNC_8030E8B4(SFX_87_TANKTUP_OOOHW, 1.0f, 32750, thisActor->position, 1000,
                3000);
  timedFunc_set_2(0.65f, (GenFunction_2)chTanktupLeg_setState, (s32)this,
                  (s32)other_marker);
  handle_tanktup_leg_collision(thisActor);
