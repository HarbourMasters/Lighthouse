...
u32 pinkEgg_spawnDelay = 0x5B;
enum actor_e pinkEgg_actorTypes[5] = {ACTOR_ED_PINK_EGG_LARGE, ACTOR_EE_PINK_EGG_MEDIUM,
                              ACTOR_EF_PINK_EGG_SMALL,
                              ACTOR_F0_PINK_EGG_SMALLEST, 0x00};

ActorAnimationInfo chPinkEggAnimations[4] = {
    {0, 0.0f}, {0, 0.0f}, {0, 0.0f}, {0x10B, 2.0f}};

ActorInfo chPinkEggLargest = {MARKER_6E_PINK_EGG_LARGEST,
                              ACTOR_5B_PINK_EGG_LARGEST,
                              ASSET_380_MODEL_PINK_EGG_LARGEST,
                              0x01,
                              chPinkEggAnimations,
                              chPinkEgg_update,
...
ActorInfo chPinkEggLarge = {MARKER_D6_PINK_EGG_LARGE,
...
ActorInfo chPinkEggMedium = {MARKER_D7_PINK_EGG_MEDIUM,
...
ActorInfo chPinkEggSmall = {MARKER_D8_PINK_EGG_SMALL,
                            ACTOR_EF_PINK_EGG_SMALL,
...
ActorInfo chPinkEggSmallest = {MARKER_D9_PINK_EGG_SMALLEST,
...
void chPinkEgg_spawnNext(ActorMarker *arg0, u32 arg1) {
  ...
  unkActor = spawn_child_actor(pinkEgg_actorTypes[arg1], &actorPtr);
...
void chPinkEgg_collision(ActorMarker *this, ActorMarker *other_marker) {
  ...
  if (pinkEgg_actorTypes[(tmp = (ActorLocal_PinkEgg *)&thisActor->local)->unk0] != 0) {
    spawnQueue_add_2(chPinkEgg_spawnNext, thisActor->marker, tmp->unk0);
  } else {
