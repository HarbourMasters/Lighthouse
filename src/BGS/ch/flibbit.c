...
/* .data */
ActorInfo flibbit_actorInfo = {MARKER_C1_FLIBBIT_RED,
...
f32 flibbit_defaultPosition[3] = {0.0f, 0.0f, 0.0f};

//clang-format off
/* .code */
bool chFlibbit_setPosition(Actor *this, f32 arg1[3], s32 arg2){
    ...
    playSoundEffectWithPositionAtTime(0.2f, 0x3f2, randf2(0.7f, 1.3f), randi2(0x61A8, 0x6978), this->position, 500.0f, 2500.0f);
    return TRUE;
}
//clang-format on

bool chFlibbit_trySetPositionToPlayer(Actor *this) {
  f32 plyrPos[3]; // sp54
  f32 sp48;
  f32 sp44;
  f32 sp40;
  ...
  ml_vec3f_rotate_and_project(this->position, this->yaw - 90.0f, plyrPos, &sp48,
                              &sp44, &sp40);
  if (func_80329210(this, plyrPos)) {
    if ((-0.7 <= sp40) && (sp40 <= 0.7)) {
      ...
      if (func_80329210(this, sp30))
        return chFlibbit_setPosition(this, sp30, 1);
    }
  }
  return 0;
}

s32 chFlibbit_trySetPositionToTarget(Actor *this) {
  f32 sp64[3];
  f32 sp60;
  f32 sp5C;
  f32 sp58;
  ...
  if ((-0.9 <= sp58) && (sp58 <= 0.9)) {
    ...
    if (func_80329210(this, sp3C) != 0) {
      return chFlibbit_setPosition(this, sp3C, 0);
    }
  }
  return 0;
}

bool chFlibbit_trySetRandomPosition(Actor *this) {
  f32 sp84[3];
  f32 sp80;
  f32 sp7C;
  f32 sp78;
  ...
  ml_vec3f_rotate_and_project(this->position, this->yaw - 90.0f, sp84, &sp80,
                              &sp7C, &sp78);
  for (i = 0; i < 0xA; i++) {
    if (i < 5) {
      if (sp78 > 0.0f) {
    ...
    ml_vec3f_rotate_direction(sp68, 0.0f, phi_f2, 0.0f, 0.0f, 180.0f);
    sp68[0] += this->position[0];
    sp68[1] += this->position[1];
    sp68[2] += this->position[2];
    if (func_80329210(this, sp68)) {
      return chFlibbit_setPosition(this, sp68, 0);
    }
  }
  return FALSE;
}

bool chFlibbit_updatePosition(Actor *this) {
  f32 plyrPos[3];
  bool out;
  ...
  player_getPosition(plyrPos);
  if (func_80329210(this, plyrPos)) {
    if (!(out = chFlibbit_trySetPositionToPlayer(this)) && (0.5 < randf())) {
      return 0;
    }
  } else {
    out = chFlibbit_trySetPositionToTarget(this);
  }

  if (!out)
    out = chFlibbit_trySetRandomPosition(this);
...
void chFlibbit_setState(Actor *this, s32 next_state) {
  ...
  if (next_state == 2) {
    if (!chFlibbit_updatePosition(this)) {
      if (this->state != 3) {
        next_state = 3;
...
void chFlibbit_onCollisionEnter(ActorMarker *this, ActorMarker *other) {
...
void chFlibbit_onHit(ActorMarker *this, ActorMarker *other) {
  Actor *thisActor = marker_getActor(this);
  if (thisActor->state < 6) {
...
void chFlibbit_onDeath(ActorMarker *this, ActorMarker *other) {
  Actor *thisActor = marker_getActor(this);
  if (thisActor->state < 6) {
...
void chflibbit_update(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    marker_setCollisionScripts(this->marker, chFlibbit_onCollisionEnter,
                               chFlibbit_onHit, chFlibbit_onDeath);
  ...
  local->unk1C[0] += spA4;
  local->unk1C[0] =
      (0.2 < local->unk1C[0]) ? randf2(-3.0f, -1.0f) : local->unk1C[0];

  local->unk1C[1] += spA4;
  local->unk1C[1] =
      (0.2 < local->unk1C[1]) ? randf2(-3.0f, -1.0f) : local->unk1C[1];
  ...
  if (this->state == 1) {
    ...
    if (player_distance < 2000.0f) {
      ml_vec3f_rotate_and_project(this->position, this->yaw - 90.0f,
                                  player_position, &spA0, &sp9C, &sp98);
      this->yaw += (sp98 * 90.0f) * spA4;
    }
  } // L803873D0

  if (this->state == 2) {
    skeletalAnim_getProgressRange(this->unk148, &skel_anim_prev_prog,
                                  &skel_anim_progress);
    if (skel_anim_prev_prog < 0.8 && 0.8 <= skel_anim_progress) {
      func_8030E878(SFX_8_BANJO_LANDING_04, randf2(0.8f, 0.9f),
                    randi2(25000, 27000), this->position, 100.0f, 1500.0f);
    } // L8038747C
    if (skeletalAnim_getLoopCount(this->unk148) > 0) {
      ...
      if (0.2 <= skel_anim_progress && skel_anim_progress <= 0.8) {
        ...
        this->position_x =
            local->unk2[0] + (local->unk8[0] - local->unk2[0]) * temp_f12;
        this->position_y =
            local->unk2[1] + (local->unk8[1] - local->unk2[1]) * temp_f12;
        this->position_z =
            local->unk2[2] + (local->unk8[2] - local->unk2[2]) * temp_f12;
        if (local->unk1) {
          if (skel_anim_progress <= 0.5) {
            phi_f2 = ((skel_anim_progress - 0.2) / 0.3) * 70.0;
          } else {
            phi_f2 =
                (1.0 - (skel_anim_progress - 0.5) / 0.30000000000000004) * 70.0;
          }
        ...
        ml_vec3f_rotate_and_project(flibbit_defaultPosition, this->yaw - 90.0f, sp68, &sp7C,
                                    &sp78, &sp74);
  ...
  if (this->state == 3) {
    ml_vec3f_rotate_and_project(this->position, this->yaw - 90.0f,
                                player_position, &sp60, &sp5C, &sp58);
