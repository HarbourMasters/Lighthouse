...
void func_8038D1E0(Actor *this) {
    ...
    SFX_PlayFade(SFX_30_MAGIC_POOF, 1.0f, 25000, this->position, 500, 2500);
}
...
void func_8038D9D0(Actor *this, s32 next_state) {
    ...
    if (next_state == 8) {
        SFX_PlayFade(SFX_8E_GRUNTLING_DAMAGE, 1.5f, 32200, this->position, 500, 2500);
    ...
    if (next_state == 9) {
        ...
        SFX_PlayFade(SFX_115_BUZZBOMB_DEATH, 1.0f, 32200, this->position, 500, 2500);
    ...
    if (next_state == 0xA) {
        ...
        skeletalAnim_setBehavior(this->unk148, SKELETAL_ANIM_2_ONCE);
        SFX_PlayFade(SFX_2F_ORANGE_SPLAT, 0.8f, 32200, this->position, 500, 2500);
    }
    if (next_state == 0xB) {
        func_80326310(this);
    }
