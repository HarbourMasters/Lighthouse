    ...
    case 1:
        ...
        if( (phi_f2 < 300.0) 
            ...
            if (func_8028EFC8() && (sp78[FACE_BUTTON(BUTTON_B)] == 1)) {
                this->unk10_12++;
                this->unk10_12 %= 3;
                gcdialog_showDialogConditional(local->unk0 + this->unk10_12, 0xB, this->position, this->marker, func_8038BADC, NULL, (s32(*)(ActorMarker*,s32,s32))func_8038BA30); // [port] polymorphic callback
                subaddie_set_state(this, 2);
                return;
            }
        } else {
