...
void func_80391810(Actor *this, s32 next_state) {
    ...
    case 1:
        ...
        break;
    case 2:
        SFX_PlayFade(SFX_148_GRUNTY_SPELL_LANDING, 1.0f, 20000, this->position, 1500, 3000);
        ...
        break;
    case 3:
        SFX_PlayFade(SFX_96_HOTSAND_EEL_HISS, 0.8f, 25000, this->position, 1500, 3000);
        sp38[0] = this->position[0];
        sp38[1] = this->position[1];
        sp38[2] = this->position[2];
        sp38[1] += 100.0f;
...
void func_80391B04(Actor *this) {
    ...
    case 1:
        ...
        if ((local->unk8 < this->position[1]) && !this->has_met_before) {
            SFX_PlayFade(SFX_14E_SOFT_EXPLOSION, 1.0f, 20000, this->position, 1500, 3000);
