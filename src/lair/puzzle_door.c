...
extern void updateStruct6DsOpacity(Struct70s *, s32, s32, f32); // [port] was s32, takes Struct70s *
...
/* .data */
ActorInfo JIGSAW_PICTURE_ACTOR = { 0x1EB, 0x3B7, 0x48B, 0x1, NULL, lair_func_8038F924, actor_update_func_80326224, actor_draw, 0, 0, 0.0f, 0};
ActorInfo JIGSAW_PICTURE_ACTOR_2 = { 0x1EB, 0x3BC, 0x538, 0x1, NULL, lair_func_8038F924, actor_update_func_80326224, actor_draw, 0, 0, 0.0f, 0};
...
bool jigsawPicture_isJigsawPictureComplete(s32 arg0) {
    ...
    return fileProgressFlag_getN(PICTURE_INFO[arg0 -1].progress_flag, PICTURE_INFO[arg0 -1].size_bits) == cost;
}
    ...
    switch (next_state) {
        ...
        case 3: //L8038F3F4
            ...
            if (item_getCount(ITEM_26_JIGGY_TOTAL) > 0) {
                gcdialog_showText(fileProgressFlag_get(FILEPROG_16_STOOD_ON_JIGSAW_PODIUM) ? 0xF5A : 0xF59, 6, sp50, this->marker, bottlesInstructionsCallback, NULL);
                fileProgressFlag_set(FILEPROG_17_HAS_HAD_ENOUGH_JIGSAW_PIECES, 1);
            } else {
                gcdialog_showText(0xF58, 6, sp50, this->marker, bottlesInstructionsCallback, NULL);
            }
        ...
        case 8: //L8038F4AC
            if (local->unk4 > 0) {
                ...
                fileProgressFlag_setN(PICTURE_INFO[this->unkF4_8 - 1].progress_flag, local->unk4, PICTURE_INFO[this->unkF4_8 - 1].size_bits);
...
void lair_func_8038F924(Actor *this) {
    ...
    if (!this->volatile_initialized) {
        // temp_v0 = &PICTURE_INFO[this->unkF4_8 - 1];
        sp64 = fileProgressFlag_getN(PICTURE_INFO[this->unkF4_8 - 1].progress_flag, PICTURE_INFO[this->unkF4_8 - 1].size_bits);
        local->unk0 = 0;
        local->unk4 = 0;
        ...
        case 1://L8038FCD0
            ...
            if (subaddie_playerIsWithinSphereAndActive(this, 300)) {
                if ((this->unkF4_8 == 0xA) && !fileProgressFlag_get(FILEPROG_F6_SEEN_DOOR_OF_GRUNTY_PUZZLE_PODIUM)) {
                    phi_a0 = (item_getCount(ITEM_26_JIGGY_TOTAL) < PICTURE_INFO[this->unkF4_8 - 1].cost) ? 0xFAB : 0xFC0;
