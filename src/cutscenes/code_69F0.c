...
/* .data */
ActorInfo D_8038E7A0 = {0x211,         0x341,      0x45D, 1,      NULL, NULL,
                        func_8038CF50, actor_draw, 0,     0xA000, 0.0f, 0};

s32 D_8038E7C4[3] = {0xFF, 0xFF, 0xFF};

ParticleScaleAndLifetimeRanges D_8038E7D0 = {
    {0.7f, 0.9f}, {0.4f, 0.5f}, {0.0f, 0.01f}, {0.4f, 0.7f}, 0.15f, 0.3f};
...
ParticleScaleAndLifetimeRanges D_8038E834 = {
    {0.05f, 0.1f}, {0.1f, 0.2f}, {0.0f, 0.01f}, {1.4f, 1.5f}, 0.01f, 0.3f};
