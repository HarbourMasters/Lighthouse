...
/* .data */
ActorInfo D_8038F270 = {0x1B9, 0x2A6,      0x502, 0x0, NULL, func_8038B19C,
                        NULL,  actor_draw, 0,     0,   0.0f, 0};

Struct_CCW_4D00_0 D_8038F294[] = {{0.12f, 1.6f, SFX_A7_WOODEN_SWOSH, 8000},
  ...
  if (this->state == 2) {
    ...
    for (iPtr = &D_8038F294[0]; iPtr->unk0 > 0.0f; iPtr++) {
      if ((sp50 < iPtr->unk0) && (iPtr->unk0 <= sp4C)) {
        func_8030E878(iPtr->unk8, randf2(iPtr->unk4 - 0.05, iPtr->unk4 + 0.05),
                      randi2(iPtr->unkA - 0x1F4, iPtr->unkA + 0x1F4),
    ...
    if ((sp50 < 0.97) && (0.97 <= sp4C)) {
      if (randf() >= 0.5) {
        func_8030E878(SFX_AE_YUMYUM_TALKING, randf2(1.8f, 1.85f),
                      randi2(19000, 21000), this->position, 500.0f, 2500.0f);
      } else {
        func_8030E878(SFX_4B_GULPING, randf2(1.4f, 1.45f), randi2(24000, 26000),
                      this->position, 500.0f, 2500.0f);
      }
    }
