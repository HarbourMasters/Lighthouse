...
ActorInfo D_8038F230 = {
    0x1C4,         0x30E,         0x487, 0x0, NULL, func_8038AEBC,
    func_8038AEBC, func_8038AE64, 0,     0,   0.0f, 0};

Struct_CCW_4960_0 D_8038F254[] = {{0.5f, 0.8f, SFX_2_CLAW_SWIPE, 20000}, 0};
  ...
  if (this->state == 2) {
    ...
    for (iPtr = &D_8038F254[0]; iPtr->unk0 > 0.0f; iPtr++) {
      if ((sp38 < iPtr->unk0) && (iPtr->unk0 <= sp34)) {
        func_8030E878((s32)iPtr->unk8, iPtr->unk4, iPtr->unkA, this->position,
                      1500.0f, 4500.0f);
      }
    }
