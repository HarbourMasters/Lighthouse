...
ActorInfo D_8038F4D0 = {
    0x1BE,         0x2AB,      0x48F, 0x0, NULL, func_8038CFB4,
    func_8038CFB4, actor_draw, 0,     0,   2.2f, 0};

Struct_CCW_6AC0_0 D_8038F4F4[] = {{0.11f, 1.0f, SFX_10_BANJO_LANDING_07, 9000},
...
Struct_CCW_6AC0_0 D_8038F53C[] = {{0.07f, 1.6f, SFX_56_BANJO_HUI, 32000},
...
Struct_CCW_6AC0_0 D_8038F5D8[] = {{0.01f, 1.0f, SFX_10_BANJO_LANDING_07, 9000},
  ...
  if (phi_s0 != NULL) {
    ...
    while (phi_s0->unk0 > 0.0f) {
      if (((sp70 < phi_s0->unk0) || (sp6C < sp70)) && (phi_s0->unk0 <= sp6C)) {
        func_8030E878(phi_s0->unk8,
                      randf2(phi_s0->unk4 - 0.05, phi_s0->unk4 + 0.05),
                      randi2(phi_s0->unkA - 200, phi_s0->unkA + 100),
