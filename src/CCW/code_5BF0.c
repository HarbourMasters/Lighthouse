...
/* .data */
ActorInfo D_8038F380 = {0x1C6, 0x310,      0x501, 0x0, NULL, func_8038C41C,
                        NULL,  actor_draw, 0,     0,   0.0f, 0};
ActorInfo D_8038F3A4 = {0x1C7, 0x311,         0x462, 0x0, NULL, func_8038C41C,
                        NULL,  func_8038C380, 0,     0,   0.0f, 0};
ActorInfo D_8038F3C8 = {0x1C8, 0x312,      0x463, 0x0, NULL, func_8038C41C,
                        NULL,  actor_draw, 0,     0,   0.0f, 0};
ActorInfo D_8038F3EC = {0x1C9, 0x313,      0x464, 0x0, NULL, func_8038C41C,
                        NULL,  actor_draw, 0,     0,   0.0f, 0};
ActorInfo D_8038F410 = {0x1CA, 0x314,      0x502, 0x0, NULL, func_8038C41C,
                        NULL,  actor_draw, 0,     0,   2.0f, 0};
ActorInfo D_8038F434 = {0x1CB, 0x315,         0x48D, 0x0, NULL, func_8038C41C,
                        NULL,  func_8038C380, 0,     0,   0.0f, 0};

/* .code */
void func_8038BFE0(ActorMarker *marker) {
  Actor *sp2C = marker_getActor(marker);
  func_8030E878(SFX_5D_BANJO_RAAOWW, randf2(1.0f, 1.1f),
                (s32)randf2(21000.0f, 22000.0f), sp2C->position, 500.0f,
                2500.0f);
}

void func_8038C064(ActorMarker *marker) {
  Actor *sp2C = marker_getActor(marker);
  func_8030E878(SFX_5E_BANJO_PHEWWW, randf2(1.0f, 1.1f),
                (s32)randf2(21000.0f, 22000.0f), sp2C->position, 500.0f,
                2500.0f);
}
...
void func_8038C0E8(ActorMarker *marker) {
  ...
  func_8030E878(SFX_81_UUU, sp20, (s32)randf2(10000.0f, 31000.0f),
                sp24->position, 500.0f, 2500.0f);
}
...
void CCW_func_8038C16C(Actor *this, s32 next_state) {
  ...
  if (next_state == 2) {
    if (this->marker->id == 0x1CA) {
      ...
      skeletalAnim_setCallback_1(
          this->unk148, 0.1f, (GenFunction_1)func_8038C0E8, (s32)this->marker);
    }
    ...
    if (this->marker->id == 0x1CB) {
      ...
      skeletalAnim_setCallback_1(
          this->unk148, 0.3f, (GenFunction_1)func_8038BFE0, (s32)this->marker);
      skeletalAnim_setCallback_1(
          this->unk148, 0.65f, (GenFunction_1)func_8038C064, (s32)this->marker);
    }
    if (this->marker->id == 0x1C8) {
      skeletalAnim_set(this->unk148, 0x231, 0.2f, 4.0f);
    }
    if ((this->marker->id == 0x1C7) || (this->marker->id == 0x1CB) ||
        (this->marker->id == 0x1C8)) {
...
void func_8038C41C(Actor *this) {
  ...
  if ((this->marker->id == 0x1CB) && (this->state == 2)) {
    ...
    if (!this->has_met_before &&
        (ml_vec3f_distance(this->position, sp2C) < 400.0f)) {
