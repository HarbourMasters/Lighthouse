...
/* .data */
ActorInfo D_8038F300 = {0x1BA, 0x2A7,      0x503, 0x0, NULL, func_8038B87C,
                        NULL,  actor_draw, 0,     0,   2.0f, 0};

s32 D_8038F324[] = {SFX_97_BLUBBER_BURPS,
                    SFX_3E_POOP_NOISE,
...
void func_8038B4C0(ActorMarker *marker) {
  ...
  func_8030E878(D_8038F324[D_8038F340], randf2(1.1f, 1.2f),
                (s32)randf2(31000.0f, 32000.0f), this->position, 500.0f,
                2500.0f);
  D_8038F340++;
...
void func_8038B58C(ActorMarker *marker) {
  ...
  func_8030E878(0x81, randf2(1.0f, 1.1f), (s32)randf2(31000.0f, 32000.0f),
                actor->position, 500.0f, 2500.0f);
}
...
void func_8038B6DC(ActorMarker *marker) {
  ...
  for (i = 0; i < 3; i++) {
    skeletalAnim_setCallback_1(this->unk148, phi_f20,
                               (GenFunction_1)func_8038B610, (s32)this->marker);
    phi_f20 += randf2(0.15f, 0.3f);
    if (0.85 < phi_f20)
      break;
  }
  skeletalAnim_setCallback_1(this->unk148, 0.35f, (GenFunction_1)func_8038B4C0,
                             (s32)this->marker);
  skeletalAnim_setCallback_1(this->unk148, 0.63f, (GenFunction_1)func_8038B58C,
                             (s32)this->marker);
  skeletalAnim_setCallback_1(this->unk148, 0.9f, (GenFunction_1)func_8038B6DC,
                             (s32)this->marker);
}
