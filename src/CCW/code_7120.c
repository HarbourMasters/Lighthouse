...
/* .data */
ActorInfo D_8038F640 = {0x1BF, 0x2AC,      0x490, 0x0, NULL, func_8038D85C,
                        NULL,  actor_draw, 0,     0,   2.2f, 0};
...
void func_8038D6D8(Actor *this, s32 next_state) {
  ...
  if (next_state == 2) {
    ...
    timedFunc_set_2(0.5f, levelSpecificFlags_set, LEVEL_FLAG_25_CCW_UNKNOWN,
                    TRUE);
