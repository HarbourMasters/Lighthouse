...
/* .data */
Struct_CCW_3310_1 D_8038EEA0[] = {{0.11f, SFX_4A_CLUCKER_AHH, 1.1f, 25000},
...
Struct_CCW_3310_1 D_8038EF20[] = {{0.1f, SFX_80_YUMYUM_CLACK, 0.9f, 15000},
...
Struct_CCW_3310_1 D_8038F030[] = {{0.2f, SFX_5D_BANJO_RAAOWW, 1.0f, 25000},
                                  {0.72f, SFX_5E_BANJO_PHEWWW, 1.0f, 25000},
                                  0};

Struct_CCW_3310_1 D_8038F060[] = {{0.95f, SFX_106_EYRIE_LIPSMACK, 1.0f, 25000},
                                  0};

Struct_CCW_3310_0 D_8038F080[] = {
    {MAP_43_CCW_SPRING, 0, FILEPROG_E6_SPRING_EYRIE_HATCHED, 0, NULL, 3, 0,
     NULL, 0x18F, D_8038EFC0, 0x190, D_8038F030, 0, 0, 0, 0},
    {MAP_44_CCW_SUMMER, FILEPROG_E6_SPRING_EYRIE_HATCHED,
     FILEPROG_E7_SUMMER_EYRIE_FED, 0x191, D_8038EEA0, 2, 0x192, D_8038EF20,
     0x193, D_8038EFC0, 0x194, D_8038F030, 2, 5, 0x21A, 0xCD7},
    {MAP_45_CCW_AUTUMN, FILEPROG_E7_SUMMER_EYRIE_FED,
     FILEPROG_E8_AUTMN_EYRIE_FED, 0x195, D_8038EEA0, 2, 0x196, D_8038EF20,
     0x197, D_8038EFC0, 0x198, D_8038F030, 4, 0xA, 0x21B, 0xCDA},
    0};

ActorInfo D_8038F130 = {MARKER_1B4_EEYRIE_BABY,
...
void func_80389700(ActorMarker *marker, enum asset_e text_id, s32 arg2) {
  ...
  setCameraModeAtTime(0.5f, 0);
}

void func_80389740(ActorMarker *marker) {
  Actor *this = marker_getActor(marker);
  if (this->marker->unk14_21) {
    spawnQueue_add_4((GenFunction_4)spawnQueue_actor_f32, 0x30C,
                       reinterpret_cast(s32, D_8038FDE0[0]),
                       reinterpret_cast(s32, D_8038FDE0[1]),
                       reinterpret_cast(s32, D_8038FDE0[2]));
  }
}

void func_80389798() { func_8030E6D4(SFX_18C_EYRIE_MAMA); }
...
void func_803897B8(Actor *this, s32 next_state) {
  ...
  if (next_state == 4) {
    ...
    skeletalAnim_setBehavior(this->unk148, SKELETAL_ANIM_1_LOOP);
    skeletalAnim_setCallback_1(this->unk148, 0.2f, (GenFunction_1)func_80389740,
                               (s32)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.3f, (GenFunction_1)func_80389740,
                               (s32)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.4f, (GenFunction_1)func_80389740,
                               (s32)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.72f,
                               (GenFunction_1)func_80389740, (s32)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.82f,
                               (GenFunction_1)func_80389740, (s32)this->marker);
    skeletalAnim_setCallback_1(this->unk148, 0.92f,
                               (GenFunction_1)func_80389740, (s32)this->marker);
...
Actor *func_80389B24(ActorMarker *marker, Gfx **gfx, Mtx **mtx, Vtx **vtx) {
  ...
  local = (ActorLocal_CCW_3310 *)&this->local;
  if ((this->state == 0) || ((this->state == 1) && (local->unk0->unk6 == 0))) {
    return this;
  }
...
void CCW_func_80389BFC(Actor *this) {
  ...
  if (local->unk8) {
    ...
    for (iPtr = local->unk8; iPtr->unk0 > 0.0f; iPtr++) {
      if ((sp5C < iPtr->unk0) && (iPtr->unk0 <= sp58)) {
        func_8030E878((s32)iPtr->unk4,
                      randf2(iPtr->unk8 - 0.05, iPtr->unk8 + 0.05), iPtr->unkC,
  ...
  if (this->state == 1) {
    ...
    if (!this->has_met_before && (local->unkC[2] >= 6500) &&
        (sp4C[2] < 6500.0f) && (local->unk0->unk28 != 0)) {
      this->has_met_before = TRUE;
      setCameraModeAtTime(0.0f, 3);
      timed_setStaticCameraToNode(0.0f, local->unk0->unk24);
      showDelayedTextAtTime(0.0f, local->unk0->unk28, 6, NULL, this->marker,
                    func_80389700, NULL);
    }
    ...
    if ((local->unk0->map_id != MAP_43_CCW_SPRING) &&
        ((this->position[0] + 500.0f) < sp4C[0])) {
      player_setCarryObjectPoseInCylinder(this->position, 1110.0f, 200.0f,
                                          ACTOR_2A2_CATERPILLAR, &this);
      if ((local->unk0->unkE != 0) &&
          (carriedObj_getActorId() == ACTOR_2A2_CATERPILLAR) &&
          (ml_vec3f_distance(this->position, sp4C) < 1010.0f) &&
