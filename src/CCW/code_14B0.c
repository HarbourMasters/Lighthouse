...
ActorInfo D_8038EC14 = {0x1AF, 0x29C,      0x446, 0x0, NULL, CCW_func_80387A40,
                        NULL,  actor_draw, 0,     0,   1.0f, 0};
...
void CCW_func_80387A40(Actor *this) {
  ...
  if (this->state == 1) {
    ...
    ml_vec3f_rotate_and_project(this->position, this->yaw - 90.0f, local->unkC,
                                &sp58, &sp54, &sp50);
  ...
  sfxsource_setSampleRate(
      local->sfxsourceIdx,
      2000.0f + 8000.0f * (LENGTH_VEC3F(local->unk18) / local->unk8));
