...
Struct_CCW_2B00_0 D_8038ED10[] = {
    {0, 0x40, 0, 5}, {0, 0x43, 1, 5}, {0, 0x44, 2, 5}, {0, 0x45, 3, 15}};

ActorAnimationInfo D_8038ED20[] = {{0, 0.0f},
                                   {0, 0.0f},
                                   {0, 0.0f},
                                   {0, 0.0f},
...
void func_80388FD4(Actor *this) {
  ...
  if ((this->state == 4) && this->unk38_0 &&
      actor_animationIsAt(this, 0.999f)) {
    setMapTransitionWithDelay(1.1f, 0x40, this->unk10_12 + 0x3C, 0x2B,
                  D_8038ED10[this->unk10_12].unk3, this->unk10_12 + 0x8B);
    setCameraModeAtTime(0.5f, 3);
    timedFunc_set_2(1.1f, levelSpecificFlags_set, this->unk10_12 + 7, TRUE);
    setCameraModeAtTime(5.6f, 0);
  }
}
