...
Struct_CCW_6620_0 D_8038F490[] = {
    {0x43, 0, 0xCCE}, {0x45, 1, 0xCD1}, {0x46, 1, 0xCD3}, 0};

ActorInfo D_8038F4A8 = {
    0x1BD, 0x2AA, 0x48F, 0x0, NULL, func_8038CC4C, NULL, CCW_func_8038CBF0,
    0,     0,     2.2f,  0};
...
void func_8038CA10(ActorMarker *marker) {
  ...
  if (this->marker->unk14_21) {
    if (0.65 < (f64)randf()) {
      ...
      particleEmitter_setSpawnPositionRange(pCtrl, -10.0f, 0.0f, -10.0f, 10.0f,
                                            20.0f, 10.0f);
      particleEmitter_setParticleVelocityRange(pCtrl, 0.0f, 31.0f, 0.0f, 0.0f,
                                               37.0f, 0.0f);
...
void func_8038CB40(Actor *this, s32 next_state) {
  ...
  if (next_state == 1) {
    ...
    for (i = 0; i < 10; i++) {
      skeletalAnim_setCallback_1(this->unk148, randf(),
                                 (GenFunction_1)func_8038CA10,
                                 (s32)this->marker);
    }
  }
