...
/* .data */
Struct_CCW_1B20_0 D_8038EC40[4] = {{0x173, 4, 0, 0x173, 0x181, 0xE3, 0},
                                   {0x181, 1, 1, 0x174, 0x182, 0xE4, 0},
                                   {0x182, 1, 1, 0x175, 0x183, 0xE5, 1},
                                   {0x183, 1, 1, 0x000, 0x000, 0x00, 0}};

ActorInfo D_8038EC70 = {
    0x1B0, 0x29D, 0x447, 0x0, NULL, func_80388478, NULL, CCW_func_803882F4,
    0,     0,     1.0f,  0};
f32 D_8038EC94[3] = {200.0f, 2120.0f, -5570.0f};

/* .code */
void func_80387F10() { jiggy_spawn(JIGGY_4D_CCW_FLOWER, D_8038EC94); }
...
void func_80387F64(Actor *this, s32 next_state) {
  ...
  if (next_state == 2) {
    ...
    for (phi_f22 = 0.0f; phi_f22 <= 1.0f; phi_f22 += 0.1) {
      timed_playSfx(phi_f22 * 5.7, 0x2C, phi_f22 * 0.3 + 0.7,
                    (s32)(32000.0f - phi_f22 * 5000.0f));
    }
...
void func_80388478(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    marker_setCollisionScripts(this->marker, NULL, CCW_func_80388278,
                               func_803882A4);
    ...
    for (local->unk0 = &D_8038EC40[0]; local->unk0 < D_8038EC40 + 3;
         local->unk0++) {
