...
/* .data */
ActorAnimationInfo D_8038F8F0[] = {{0x000, 0.0f}, {0x16C, 2.0f}, {0x16B, 1.2f}};

ActorInfo D_8038F908 = {MARKER_1F9_SNARE_BEAR,
                        ACTOR_1E9_SNARE_BEAR,
                        ASSET_440_MODEL_SNAREBEAR,
                        0x1,
                        D_8038F8F0,
                        func_8038E0C8,
...
void func_8038E0C8(Actor *this) {
  ...
  if (!this->volatile_initialized) {
    ...
    anctrl_setCallback(this->anctrl, (GenFunction_2)func_8038E060);
    anctrl_setCallbackArg(this->anctrl, (s32)this->marker);
  ...
  if (player_getTransformation() == TRANSFORM_6_BEE) {
    ...
    ml_vec3f_rotate_and_project(this->position, this->yaw - 90.0f, sp44, &sp40,
                                &sp3C, &sp38);
    if ((sp40 < 1050.0f) && (sp38 > -1.0f) && (sp38 < 1.0f)) {
      ml_vec3f_rotate_and_project(this->position,
                                  this->unk1C[0] + (this->yaw - 90.0f), sp44,
                                  &sp40, &sp3C, &sp38);
  ...
  case 1:
    ...
    if (func_80329530(this, 0x2A8) && (this->unk38_31 == 0) &&
  ...
  case 2:
    ...
    if (actor_animationIsAt(this, 0.18f) || actor_animationIsAt(this, 0.47f) ||
        actor_animationIsAt(this, 0.78f)) {
      FUNC_8030E8B4(SFX_80_YUMYUM_CLACK, 1.0f, 32000, this->position, 1500,
                    3000);
    }
    break;
  }
